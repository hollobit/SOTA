...
var App = {
    ...
    renderResources: function() {
        ...
        var sites = [
            ...
            { name: 'AAII Methodology page', url: 'https://artificialanalysis.ai/methodology/intelligence-benchmarking', desc: 'Detailed AAII v4.0.4 methodology — exact category weights (per-benchmark e.g. GDPval-AA 16.7%, SciCode 8.3%), Pass@1 vs Elo-based scoring per benchmark, AA-Omniscience composite formula (50% Accuracy + 50% (1 - Hallucination Rate)). Score normalization: clamp((Elo-500)/2000) for pairwise comparison benchmarks.' },
