...
var App = {
    ...
    renderResources: function() {
        ...
        var pdfDocs = [
            ...
            { name: 'Claude Opus 5.5 System Card', file: 'anthropic_claude-opus-5.5_system-card_2026-09.pdf', vendor: 'Anthropic', date: 'Sep 2026', url: 'https://www-cdn.anthropic.com/fc1b44717c85dc068bc6ba5024219938094694bd/Claude%20Opus%205.5%20System%20Card.pdf' },
            { name: 'GPT-6 Astra System Card (rev. 2026-09-22, + Appendix A: GPT-6 Sol / Luna)', file: 'openai_gpt-6-astra_system-card_2026-09-22_rev_sol_luna_appendix.pdf', vendor: 'OpenAI', date: 'Sep 2026', url: 'https://deploymentsafety.openai.com/gpt-6-astra/gpt-6-astra.pdf' },
            { name: 'MiMo-V2.6 Technical Report', file: 'xiaomi_mimo-v2.6_tech_report_2026-09.pdf', vendor: 'Xiaomi', date: 'Sep 2026', url: 'https://huggingface.co/XiaomiMiMo/MiMo-V2.6-Pro-RL/blob/main/MiMo_V2_6_technical_report.pdf' },
            { name: 'GPT-6 Astra System Card (original 2026-09-04)', file: 'openai_gpt-6-astra_system-card_2026-09.pdf', vendor: 'OpenAI', date: 'Sep 2026', url: 'https://deploymentsafety.openai.com/gpt-6-astra/gpt-6-astra.pdf' },
            { name: 'GPT-5.6 GA System Card', file: 'GPT-5-6-System-Card.pdf', vendor: 'OpenAI', date: 'Jul 2026', url: 'https://deploymentsafety.openai.com/gpt-5-6/gpt-5-6.pdf' },
            ...
            { name: 'AgentGym2 (De-Idealized Agent Bench)', file: 'agentgym2_arxiv_2607.05174.pdf', vendor: 'Fudan NLP', date: 'Jul 2026', url: 'https://arxiv.org/abs/2607.05174' },
            { name: 'DeepSeek V4 Technical Report (arXiv 2606.19348)', file: 'DeepSeek-V4-Pro-Technical-Report.pdf', vendor: 'DeepSeek', date: 'Apr 2026', url: 'https://arxiv.org/abs/2606.19348', desc: 'DeepSeek-V4: Highly Efficient Million-Token Context Intelligence — V4-Pro 1.6T-A49B / V4-Flash 284B-A13B MoE, Manifold-Constrained attention, Muon optimizer, 1M ctx, MIT. Tables 6/7: MMLU-Pro/GPQA/HLE/LiveCodeBench/Codeforces/Apex/SWE/Terminal-Bench 2.0/MCPAtlas/GDPval-AA/Toolathlon + Putnam-2025 120/120.' },
            { name: 'Solar Open 2 Technical Report (arXiv 2607.20062)', file: 'Solar-Open-2-Technical-Report_arxiv_2607.20062.pdf', vendor: 'Upstage', date: 'Jul 2026', url: 'https://arxiv.org/abs/2607.20062', desc: 'Solar Open 2 — Korean sovereign 250B-A15B MoE, hybrid attention (25% softmax GQA + 75% linear KDA/NoPE), 320 experts, 1M ctx, selective weight transfer + MOPD distillation. Table 3 English (MMLU-Pro 86.2, LiveCodeBench 92.4, SWE-Verified 70.4) + Table 4 Korean (Avg 85.4: CLIcK 90.7, Ko-GDPval 86.8). Introduces Ko-GDPval / Ko-AIME / KBank-MMLU in-house benches.' },
            { name: 'DeepSeek-V4-Flash-0731 (official release)', file: '', vendor: 'DeepSeek', date: 'Jul 2026', url: 'https://huggingface.co/deepseek-ai/DeepSeek-V4-Flash-0731', desc: 'Official 0731 release of V4-Flash (supersedes preview), +DSpark speculative decoding, enhanced agentic. AA Intelligence Index 50 (+10 vs preview 40). Terminal-Bench 2.1 82.7, Cybergym 76.7, DeepSWE 54.4, NL2Repo 54.2, Toolathlon-Verified 70.3. reasoning_effort low/high/max, 384K rec.' },
            { name: 'AA — DeepSeek-V4-Flash-0731 scores 50 on AA Intelligence Index', file: '', vendor: 'Artificial Analysis', date: 'Jul 2026', url: 'https://artificialanalysis.ai/articles/deepseek-v4-flash-0731-scores-50-on-the-artificial-analysis-intelligence-index-10-points-above-previous-deepseek-v4-flash', desc: 'AA independent eval of DeepSeek-V4-Flash-0731: Intelligence Index 50 vs previous 40. GDPval-AA v2 Elo 1559, GPQA 91, HLE 37, SciCode 50, AA-LCR 66, Tau3-Banking 31, CritPt 17, AA-Omniscience -16. Same price/params as preview. Ingested S220.' },
            { name: 'AgentS4D (arXiv 2607.27294)', file: 'AgentS4D_arxiv_2607.27294.pdf', vendor: 'ZJUT', date: 'Jul 2026', url: 'https://arxiv.org/abs/2607.27294', desc: 'Lifecycle-wide runtime safety benchmark for LLM workspace agents. 328 risk-injected cases × 20 harness-LLM configs (4 harnesses × 5 LLMs) = 6,560 runs. Metrics ASR/cASR (lower=safer)/SHR/TCR. Overall ASR 68%. Best cASR OpenClaw-Qwen3.7-Plus 58.0; worst Codex-DeepSeek-V4-Pro 93.7. Scores harness-conditioned (registered as dataset, no per-model ingest).' },
            { name: 'GraphRareBench (arXiv 2607.24878)', file: 'GraphRareBench_arxiv_2607.24878.pdf', vendor: 'Xiamen Univ', date: 'Jul 2026', url: 'https://arxiv.org/abs/2607.24878', desc: 'Auditable graph-evidence benchmark for phenotype-driven rare-disease diagnosis. 2,365 cases, MRR metric. DeepSeek-V4-Flash only frontier LLM evaluated (prompt MRR 0.313, agent 0.718); supervised PPP ranker 0.740. github.com/GUI0609/GraphRareBench.' },
            { name: 'EvoClawBench (arXiv 2607.09711)', file: 'EvoClawBench_arxiv_2607.09711.pdf', vendor: 'SJTU / Hithink', date: 'Jun 2026', url: 'https://arxiv.org/abs/2607.09711', desc: 'Closed-loop skill-learning benchmark — can agents turn their own run evidence into reusable SKILL.md skills? 100 tasks / 502 sub-problems, BASELINE/PRESKILL/POSTSKILL modes on OpenClaw + nanobot runtimes. Authors state it is NOT a model-capability leaderboard (runtime-dominated); registered as dataset. github.com/pzy2000/EvoClawBench.' },
            ...
            { name: 'ZEO-Med-2 (ZeroOne AI × Samsung Medical Center)', file: '', vendor: 'ZeroOne AI', date: '2026', url: 'https://huggingface.co/ZeroOneAI/ZEO-Med-2', desc: 'Korean+English medical model — 31B LoRA on Gemma-4-31B, Apache-2.0. KorMedMCQA 4-exam avg 93.95 (Doctor 97.70 / Nurse 96.36 / Pharmacist 94.69 / Dentist 87.05), MedQA-USMLE 94.82. Beats Gemma-4-31B base + Qwen3.6-27B on Korean licensing exams; 0-shot, 5-sample majority vote.' },
            { name: 'Dreamina Seedance 2.5 (ByteDance)', file: '', vendor: 'ByteDance', date: '2026', url: 'https://dreamina.capcut.com/ko-kr/seedance/seedance-2-5', desc: 'New text-to-video model — up to 30s (180s beta long-video), 50 reference inputs (R2V green-screen guidance), local video editing, 11-language. No public benchmark/Elo published yet (not on AA leaderboard).' },
            { name: 'DINOv3 (arXiv 2508.10104)', file: '', vendor: 'Meta', date: 'Aug 2025', url: 'https://arxiv.org/abs/2508.10104', desc: 'Self-supervised ViT-7B vision FM (LVD-1689M). ImageNet1k-linear 88.2, ADE20k mIoU 63.0, COCO det mAP 66.1. S223.' },
            { name: 'Olmo 3 (arXiv 2512.13961)', file: 'Olmo-3_arxiv_2512.13961.pdf', vendor: 'Ai2', date: 'Nov 2025', url: 'https://arxiv.org/abs/2512.13961', desc: 'Fully-open. Olmo 3.1 Think 32B: MATH 96.2, AIME2025 78.1, LiveCodeBench-v3 83.3, IFEval 93.8, MMLU 86.4. S223 net-new.' },
            { name: 'QuarkMed (arXiv 2508.11894)', file: 'QuarkMed_arxiv_2508.11894.pdf', vendor: 'Alibaba', date: 'Aug 2025', url: 'https://arxiv.org/abs/2508.11894', desc: 'Alibaba medical 32B. MedQA 86.02, MedMCQA 75.50, PubMedQA 79.00, CMExam 88.60, MMLU-Med 88.37. S223 net-new (medical).' },
            { name: 'Nemotron Audex (arXiv 2607.05196)', file: 'Nemotron-Audex_arxiv_2607.05196.pdf', vendor: 'NVIDIA', date: 'Jul 2026', url: 'https://arxiv.org/abs/2607.05196', desc: 'Unified audio+text 30B-A3B. AIME-2025 91.2, LiveCodeBench-v6 85.3, MMLU-Pro 78.9, GPQA-D 74.9, MMAU 75.6. S223 net-new.' },
            { name: 'KAT-Coder-V2.5 (arXiv 2607.05471)', file: 'KAT-Coder-V2.5_arxiv_2607.05471.pdf', vendor: 'Kuaishou', date: 'Jul 2026', url: 'https://arxiv.org/abs/2607.05471', desc: 'Coding agent. SWE-Bench-Pro 65.2, Terminal-Bench 2.1 60.7, SciCode 50.3. Introduces KAT-Code-Bench / KAT-Claw-Bench. S223 net-new.' },
            { name: 'Foundation-Sec-8B-Reasoning (arXiv 2601.21051)', file: 'Foundation-Sec-8B-Reasoning_arxiv_2601.21051.pdf', vendor: 'Cisco', date: 'Jan 2026', url: 'https://arxiv.org/abs/2601.21051', desc: 'Cisco cyber SLM. CTIBench-MCQA 69.1, MMLU-Security 78.2, CyberMetric-2000 84.3, SecEval 84.8. S223 net-new (cyber).' },
            { name: 'CyberPal 2.0 (arXiv 2510.14113)', file: 'CyberPal-2.0_arxiv_2510.14113.pdf', vendor: 'IBM', date: 'Jul 2026', url: 'https://arxiv.org/abs/2510.14113', desc: 'IBM cyber SLM (gpt-oss-20b base). CTIBench-MCQ 75.71, CyberMetric-2000 89.05, CISSP 86.87. S223 net-new (cyber).' },
            { name: 'IQuest-Coder-V1 40B (arXiv 2603.16733)', file: 'IQuest-Coder-V1_arxiv_2603.16733.pdf', vendor: 'IQuest', date: 'Mar 2026', url: 'https://arxiv.org/abs/2603.16733', desc: '40B code LLM. SWE-Verified 76.2, LiveCodeBench-v6 81.1, HumanEval 97.6, Terminal-Bench 52.5. S223 net-new (coding).' },
            { name: 'Mellum 2 (arXiv 2605.31268)', file: 'Mellum-2_arxiv_2605.31268.pdf', vendor: 'JetBrains', date: 'May 2026', url: 'https://arxiv.org/abs/2605.31268', desc: 'JetBrains 12B-A2.5B code MoE. HumanEval 41.5, MBPP 62.4, MMLU 70.9, MMLU-Pro 59.3. S223 net-new (coding).' },
            { name: 'Phoenix-VL 1.5 Medium (arXiv 2605.10391)', file: 'Phoenix-VL-1.5-Medium_arxiv_2605.10391.pdf', vendor: 'HTX×Mistral', date: 'May 2026', url: 'https://arxiv.org/abs/2605.10391', desc: 'Singapore sovereign VLM 123B. MMMU 60.78, MMLU 83.48, GPQA-D 59.09, DocVQA 93.05. Intro SG-Knowledge-Eval. S223 net-new.' },
            { name: 'Mach-Mind-4-Flash (arXiv 2607.09375)', file: 'Mach-Mind-4-Flash_arxiv_2607.09375.pdf', vendor: 'Li Auto', date: 'Jul 2026', url: 'https://arxiv.org/abs/2607.09375', desc: 'Li Auto 35B-A3B agentic MoE. AIME-2026 92.70, IFBench 82.82, BFCL-v4 75.80, BrowseComp-zh 72.31. S223 net-new.' },
            { name: 'Jupiter-N 120B (arXiv 2604.17429)', file: 'Jupiter-N_arxiv_2604.17429.pdf', vendor: 'Locai', date: 'Apr 2026', url: 'https://arxiv.org/abs/2604.17429', desc: 'Locai post-trained Nemotron 3 Super 120B-A12B. IFEval 90.20, IFBench 73.8, GSM8K 94.01, TerminalBench2 52.7. S223 net-new.' },
            { name: 'Covenant-72B (arXiv 2603.08163)', file: 'Covenant-72B_arxiv_2603.08163.pdf', vendor: 'Covenant AI', date: 'Mar 2026', url: 'https://arxiv.org/abs/2603.08163', desc: 'Trustless-internet-trained 72B LLM. MMLU 67.4, GSM8K 63.9, MATH 26.3, MMLU-Pro 40.9. S223 net-new.' },
            { name: 'Kwai Keye-VL 2.0 (arXiv 2606.10651)', file: '', vendor: 'Kuaishou', date: 'Jun 2026', url: 'https://arxiv.org/abs/2606.10651', desc: 'Kuaishou video VLM 30B-A3B. Video-MME 78.3, Video-MMMU 80.0, LongVideoBench 74.1. S223 net-new (VLM).' },
            { name: 'Llamion 14B (arXiv 2605.25676)', file: 'Llamion_arxiv_2605.25676.pdf', vendor: 'VAIV', date: 'May 2026', url: 'https://arxiv.org/abs/2605.25676', desc: 'Korean 14B (Orion-14B→Llama-arch via KEPT). MMLU 69.40, KoMMLU 66.87, GSM8K 44.70. S223 net-new (Korean).' },
            { name: 'Hebatron (arXiv 2605.11255)', file: 'Hebatron_arxiv_2605.11255.pdf', vendor: 'PwC', date: 'Apr 2026', url: 'https://arxiv.org/abs/2605.11255', desc: 'Hebrew MoE 30B-A3B (from Nemotron-3-Nano). Hebrew-avg 73.8, English GSM8K 83.8. Intro Hebrew IFEval. S223 net-new.' },
            ...
            { name: 'Gemini 3.5 Flash Model Card', file: 'Gemini-3-5-Flash-Model-Card.pdf', vendor: 'Google', date: 'May 2026', url: 'https://deepmind.google/models/model-cards/gemini-3-5-flash/' },
            { name: 'Gemini Omni Flash Model Card', file: 'Gemini-Omni-Flash-Model-Card.pdf', vendor: 'Google', date: 'May 2026', url: 'https://deepmind.google/models/model-cards/gemini-omni-flash/' },
        ...
        var sites = [
            ...
            { name: 'llm-stats LongBench v2', url: 'https://llm-stats.com/benchmarks/longbench-v2', desc: 'LongBench v2 long-context QA model rankings.' },
            { name: 'llm-stats MMLongBench-Doc', url: 'https://llm-stats.com/benchmarks/mmlongbench-doc', desc: 'Multimodal long-context document QA leaderboard.' },
            { name: 'llm-stats MRCR v2 (128K-256K)', url: 'https://llm-stats.com/benchmarks/mrcr-v2', desc: 'Multi-Round Coref Resolution v2 8-needle leaderboard (Anthropic / OpenAI / Google shared standard).' },
            { name: 'llm-stats IMO-AnswerBench', url: 'https://llm-stats.com/benchmarks/imo-answerbench', desc: 'IMO-AnswerBench: Nemotron-3-Ultra 92.3 / GLM-5.2 91.0 / Qwen3.7-Max 90.0 / DeepSeek-V4-Pro 89.8.' },
            { name: 'llm-stats USAMO 2026', url: 'https://llm-stats.com/benchmarks/usamo-2026', desc: 'USAMO 2026 model leaderboard (cross-source with matharena.ai/usamo).' },
            { name: 'llm-stats CyberSecEval 4', url: 'https://llm-stats.com/benchmarks/cyberseceval-4', desc: 'Meta Purple Llama CyberSecEval 4 (CyberSOCEval + AutoPatchBench) cross-model ranking.' },
            // ---- AA canonical leaderboards (T2I / T2V / I2V / TTS / Transcribe / S2S) ----
            { name: 'AA Text-to-Image Arena', url: 'https://artificialanalysis.ai/text-to-image', desc: 'Top Jun 2026: GPT Image 2 (1340), GPT Image 1.5 (1266), HiDream-O1-Image-1.5 (1265), Nano Banana 2 (1255).' },
            { name: 'AA Text-to-Video Arena', url: 'https://artificialanalysis.ai/video/leaderboard/text-to-video', desc: 'With-audio arena (2026-08-01, 27 models): Gemini Omni Flash 1245 #1, MiniMax H3 1242, Dreamina Seedance 2.0 720p 1225, Wan2.7-260612 1163, HappyHorse-1.1 1151, Kling 3.0 1080p Pro 1113, SkyReels V4 1109, Veo 3.1 1098. → aa_t2v_arena_elo_with_audio (Video Gen tab).' },
            { name: 'AA Image-to-Video Arena', url: 'https://artificialanalysis.ai/video/leaderboard/image-to-video', desc: 'Top: Seedance 2.0 720p (1194), Grok Imagine Video 1.5 (1113), Wan 2.7 (1091), Veo 3.1 (1089).' },
            { name: 'AA TTS Arena (selected-voice)', url: 'https://artificialanalysis.ai/text-to-speech/leaderboard/selected-voice', desc: 'Top: Fun-Realtime-TTS 1224, Gemini 3.1 Flash TTS 1222, Inworld Realtime TTS-2 1212, Cartesia Sonic 3.5 1203.' },
            { name: 'AA Speech-to-Speech', url: 'https://artificialanalysis.ai/speech-to-speech', desc: 'S2S leaderboard — GPT-Realtime-2, StepAudio 2.5 Realtime, Fun-Realtime-Audiochat.' },
            { name: 'AA MiniCPM5-1B 1B SOTA article', url: 'https://artificialanalysis.ai/articles/minicpm5-1b-the-leading-1b-open-weights-model', desc: 'MiniCPM5-1B at AAII v4.1 = 17.9 leads 1B open-weights tier (+7.4 vs next).' },
            // ---- S136-S140 model card / vendor blog pages ----
            { name: 'Apple Foundation Models 3 (Jun 8 2026)', url: 'https://machinelearning.apple.com/research/introducing-third-generation-of-apple-foundation-models', desc: 'Official Apple ML Research blog — AFM 3 Core 3B + AFM 3 Core Advanced 20B-sparse + AFM 3 PCC server. "AFM 3" naming replaces anticipated "Foundation 4".' },
            { name: 'Microsoft Phi-4-reasoning-vision-15B (Mar 4 2026)', url: 'https://www.microsoft.com/en-us/research/blog/phi-4-reasoning-vision-and-the-lessons-of-training-a-multimodal-reasoning-model/', desc: '15B MIT reasoning + vision multimodal. AI2D 84.8, ScreenSpot-v2, ChartQAPro.' },
            { name: 'Google FunctionGemma 270M', url: 'https://blog.google/innovation-and-ai/technology/developers-tools/functiongemma/', desc: '270M function-calling specialist. 85% Mobile Actions post fine-tune.' },
            { name: 'Voyage Multimodal 3.5 (Jan 15 2026)', url: 'https://blog.voyageai.com/2026/01/15/voyage-multimodal-3-5/', desc: 'Voyage AI multimodal embedding model — joint text+image semantic search.' },
            { name: 'Qwen3-Embedding family', url: 'https://qwenlm.github.io/blog/qwen3-embedding/', desc: 'Qwen3-Embedding 0.6B / 4B / 8B + Reranker. 8B leads MTEB v2 English at 75.22 (vendor self-report).' },
            { name: 'OpenAI GPT-Realtime-2 (May 8 2026)', url: 'https://openai.com/index/introducing-gpt-realtime/', desc: 'Speech-to-speech realtime API. Also covers GPT-Realtime-Whisper STT variant.' },
            { name: 'Marktechpost — Qwen RobotSuite', url: 'https://www.marktechpost.com/2026/06/16/meet-qwen-robotsuite-three-embodied-ai-models-for-vla-manipulation-video-world-modeling-and-navigation/', desc: 'Qwen RobotSuite trio (RobotManip / RobotWorld / RobotNav) coverage — used as recovery source when qwen.ai blog returned JS-only empty page.' },
            { name: 'UK AISI — Autonomous cyber capability pace', url: 'https://www.aisi.gov.uk/blog/how-fast-is-autonomous-ai-cyber-capability-advancing', desc: 'AISI Cyber Time Horizon @80% reliability metric. Doubling-rate analysis of frontier cyber autonomy.' },
            ...
            { name: 'FactoryBench (arxiv 2605.07675)', url: 'https://arxiv.org/abs/2605.07675', desc: 'ETH+UC3M+KTH industrial robot causal reasoning benchmark (May 2026). 4 levels (State/Intervention/Counterfactual/Decision), ~71k Q&A over UR3 + KUKA KR10 telemetry. Sonnet 4.6 leads L1-L3 (46.8/47.1/45.9%); GPT-5.1 alone clears L4 at 17.7%' },
            { name: 'Palisade Research — GPT-5 at CTFs (arxiv 2511.04860)', url: 'https://arxiv.org/abs/2511.04860', desc: 'First peer-reportable evaluation of a frontier LLM in elite live 2025 CTF competitions. GPT-5 Pro placed 25/368 at ASIS CTF Quals (93rd percentile, between #3 and #7 world-ranked teams), 49/474 at CorCTF (90th), 43/518 at snakeCTF Quals (92nd). Newly-created challenges = no training-data memorization' },
            { name: 'Palisade Research project page (gpt5-ctfs)', url: 'https://palisaderesearch.github.io/gpt5-ctfs', desc: 'Companion project hosting full GPT-5 Pro CTF transcripts and per-challenge solutions (Empties polynomial-ring cryptanalysis, Triple Flavor cascade cipher, Control WASM industrial-systems exploitation)' },
            { name: 'Qwen3.7-Max launch blog', url: 'https://qwen.ai/blog?id=qwen3.7', desc: 'Alibaba Qwen Team May 20 2026 launch — "the Agent Frontier". 41-benchmark × 6-model comparison panel (Opus-4.6 Max, K2.6 Thinking, GLM-5.1 Thinking, DS-V4-Pro Max, Qwen3.6-Plus, Qwen3.7-Max). AAII 57 (ties GPT-5.4 Pro / Opus 4.7 / Gemini 3.1 Pro, behind only GPT-5.5 family). Introduces 7 new Qwen-internal benches: QwenWebDev, QwenSVG, Qwenclaw, CoWorkBench, Vitabench, SpreadSheetBench-v1, QwenWorldBench' },
            { name: 'Qwen3.7-Plus GA blog', url: 'https://qwen.ai/blog?id=qwen3.7-plus', desc: 'Alibaba Qwen Team Jun 1 2026 — Multimodal Agent Intelligence. 1M ctx. 69 benchmarks (37 text + 32 multimodal) vs Opus-4.6 Max/K2.6 Thinking/GLM-5.1 Thinking/DeepSeek-V4-Pro Max/Qwen3.6-Plus (text) + GPT-5.4 xhigh/Opus-4.6 Max/Gemini-3.1 Pro/Qwen3.6-Plus (multimodal). Headline: Terminal-Bench 2.0 70.3 / Deep-Planning 62.3 / ScreenSpot Pro 79.0 / AndroidWorld 81.0 / BabyVision 70.4 / LingoQA 83.4 / VideoMMMU 85.4 / Ego3D-Bench 5.9 (lower) / OmniDocBench 1.5 91.4. Available via Alibaba Cloud Model Studio (model=qwen3.7-plus)' },
            { name: 'Qwen3.8-Max blog (GA)', url: 'https://qwen.ai/blog?id=qwen3.8', desc: 'Alibaba Qwen Team Aug 3 2026 — official GA release of flagship Qwen3.8-Max ("A New Bar for Coding and Cowork"). Text/agent + multimodal benches vs Opus-4.8/Fable-5/GPT-5.6-Sol/Gemini-3.1-Pro. Headline (own column): Terminal-Bench 2.1 86.6 / SWE-Bench Pro 67.7 / DeepSWE 1.1 56.6 / PaperBench 93.0 / GPQA-D 92.6 / IFBench 82.8 / HealthBench 60.2 / MMMU-Pro 82.3 / MathVision 95.2 / OSWorld-Verified 86.1 / AndroidWorld 85.3 / VideoMME 90.4 / MMStar 85.9. S231 → alibaba/qwen3.8-max GA (distinct from qwen3.8-max-preview). 30 scores. JS-rendered (Playwright).' },
            { name: 'NVIDIA Cosmos 3 Tech Report', url: 'https://research.nvidia.com/labs/cosmos-lab/cosmos3/', desc: 'Cosmos 3 omnimodal world models for Physical AI (Jun 1 2026, 130+ pages). 5 model variants: Cosmos3-Super/Nano/Edge + post-trained Super-T2I/Super-I2V/Nano-Policy-DROID. Dual-tower MoT (Mixture-of-Transformers) initialized from Qwen3-VL 32B/8B. Open-source under OpenMDW-1.1. Introduces Cosmos-HUE (HF Cosmos-HumanEval-v1) human evaluation benchmark for Physical AI video gen. SOTAs: UniGenBench 91.36 (AA T2I #1 open-weight) / PAIBench-G T2V 80.0 + I2V 82.8 / Physics-IQ I2V 48.9 BoN + V2V 63.4 BoN / HWB 71.9 / SoundBench SAV 8.35 (Cosmos3-Nano) / RoboLab Specific 39.7 (RoboArena #1) / LIBERO-10 MT-init 97.4'},
            { name: 'Qwen3.7 Max — Artificial Analysis profile', url: 'https://artificialanalysis.ai/models/qwen3-7-max', desc: 'AA model detail page — AAII 57 (rank #1 of 218 at score 57). Disclaimer: results are AI-Lab-claimed, AA not yet independently verified. 1M context, $0 pricing reported, May 19 2026 availability' },
            { name: 'OpenAI Deployment Safety — GPT-5.4 Thinking', url: 'https://deploymentsafety.openai.com/gpt-5-4-thinking', desc: 'Living-doc safety hub for GPT-5.4 Thinking (released Mar 5 2026). Full Preparedness Framework eval: Biology (Virology MCQ 50.4 / ProtocolQA-OE 42.5 / Tacit 65.0 / TroubleshootingBench 35.8), Cyber (CTF pass@12 88.2 / CVE-Bench 86.3 / Cyber Range 73.3 / Irregular Network 88), Apollo deception (sabotage 0.56, eval-awareness 21.3)' },
            { name: 'OpenAI Deployment Safety — GPT-6 Astra', url: 'https://deploymentsafety.openai.com/gpt-6-astra', desc: 'GPT-6 Astra (released Sep 3 2026) — FIRST model to reach Preparedness Framework CRITICAL cybersecurity level (High on Bio/Chem). ExploitBench V8 Cap% 100 (even at lowest effort; OpenAI flags possible contamination), Sandbox Bench 45.5 (Sol 4.5), SRE-Bench pass@4 99.2 (Sol 68.7), Irregular FrontierCyber 86/226 (Sol 34/226), CyScenarioBench avg 59, Atomic 20/22. Expert-led: unsandboxed browser exploit chain in 29h, hardened-kernel LPE in 12h. HealthBench-Pro 64.7 / HB 58.3 / Hard 36.6 / Consensus 95.5 (corrected in the 2026-09-22 card revision; was 63.4 / 58.1 / 36.3 / 95.8). Internal Research Debugging 78.05. Indirect prompt-injection ASR 8.5% (Sol 27.0)' },
            { name: 'World Labs Atlas', url: 'https://www.worldlabs.ai/blog/atlas', desc: 'Omni spatial-intelligence world model (text/image/video/3D, early access Sep 1 2026; distinct from Marble). Camera-controlled generation human-preference win-rate vs MiniMax H3 75% / Gemini Omni Flash 81% / Happy Horse 1.1 86% / FLUX 3 93% / Seedance 2.5 94%; 3D pointmap reconstruction AbsRel avg 25.3‰ (lowest vs Pi3X, π³, VGGT-Ω 1B, Depth Anything 3, MapAnything)' },
            { name: 'ARC Prize — GPT-6 Astra on ARC-AGI-3', url: 'https://arcprize.org/blog/astra', desc: 'Full 6-effort × 2-harness grid. Standard harness: 17.5 (low) → 62.7 (max, $26,098). Provider-adapter harness: 96.7–99.9 flat/saturated (3.66× faster, 49% fewer tokens). Astra used fewer actions than the human baseline on 96.0% of levels (51.7% fewer on average)' },
            { name: 'OpenAI Deployment Safety — GPT-5.5 Instant', url: 'https://deploymentsafety.openai.com/gpt-5-5-instant', desc: 'GPT-5.5 Instant (released May 5 2026) — first Instant-family model classified High Capability in cyber+bio. Cyber Range 76.9% (vs Thinking 92.3%). HealthBench length-adjusted 51.4 / Hard 22.9 / Consensus 94.7 / Professional 38.4. Stat-significant safety regressions: Gore 70.3, Sexual 80.6, Hate 82.7' },
            { name: 'OpenAI Deployment Safety — ChatGPT Images 2.0', url: 'https://deploymentsafety.openai.com/chatgpt-images-2-0', desc: 'ChatGPT Images 2.0 image generation (released Apr 21 2026) + Thinking variant. Image-safety pipeline: combined detection 96.1% (base) / 87.5% (thinking); safe output rate 99.1% / 99.2%. Thinking variant reduces violative outputs 3.3x (22.0% → 6.7%) but caught harder (12.5% remaining undetected)' },
            { name: 'Qwen3.7 blog — YC-Bench startup simulator (deep section)', url: 'https://qwen.ai/blog?id=qwen3.7', desc: 'Long-horizon planning benchmark introduced in Qwen3.7-Max launch. 1-year startup lifecycle, hundreds of decision rounds (personnel/contracts/malicious clients). Qwen3.7-Max: $2.08M revenue / 237 tasks. Qwen3.6-Plus: $1.05M. Qwen3.5-Plus: $352K (5.9x lower than 3.7). Also: Qwen-RobotClaw + Qwen-RobotNav robotics models, Self-Evolving kernel optimization (10x speedup on T-Head ZW-M890), Reward Hacking Monitoring (1,618 cases flagged)' },
            { name: 'arena.ai 12-leaderboard live snapshot', url: 'https://arena.ai/leaderboard', desc: '12 arena boards: Text / WebDev / Vision / Document / Text-to-Image / Image-Edit / Image-to-WebDev / Search / Text-to-Video / Image-to-Video / Video-Edit / Text-Arena-Overview. Post-May-12 2026 methodology adds Battles-in-Direct to Bradley-Terry. Recent additions (May 14-21): qwen3.7-max-preview, granite-4.1-8b, trinity-large-thinking, gpt-5.5-xhigh-codex-harness, gemini-3.5-flash, hidream-o1-image, grok-imagine-image-quality' },
            { name: 'Microsoft Fara 1.5 (computer-use agent family)', url: 'https://www.microsoft.com/en-us/research/articles/fara1-5-computer-use-agent/', desc: 'Microsoft Research May 21 2026: Fara1.5-4B / 9B / 27B browser computer-use agent family based on Qwen3.5. Online-Mind2Web 57.3/63.4/72.0 (#1), WebVoyager 80.8/86.6/88.6 (#1, beats OpenAI Operator 87.0). WebTailBench v1.5 Outcome 32.3, Process 64.5 (9B variant)' },
            { name: 'NexgeneAI Asa-W1 (medical reasoning)', url: 'https://reports.nexgene.ai/NexgeneAI_AsaW1_HealthBench-Professional_2026.pdf', desc: 'Asa-W1 medical reasoning foundational model — HealthBench Professional overall 80.2 (+21.2 vs prior best ChatGPT-for-Clinicians 59.0; +36.5 vs physician baseline 43.7). Care consult 80.9 / Writing 71.0 / Research 87.8. Red-teaming difficult slice 67.4 (+11.6 vs CGPT-C 55.8). Largest reported gap vs physician baseline on this benchmark to date' },
            { name: 'Open Agent Leaderboard (HF Space)', url: 'https://huggingface.co/spaces/open-agent-leaderboard/leaderboard', desc: '5×5 agent-framework × backbone-model matrix (25 entries). 6 benchmarks: App / Browse / SWE / Tau-Air / Tau-Ret / Tau-Tel. Top: OpenAI Solo + Claude Opus 4.5 = 72.7% Avg Success ($5.97). Best price/perf: React + Shortlist + Gemini Pro 3 = 62.2% at $0.51 (~12x cheaper than top)' },
            { name: 'General Agent Evaluation (arxiv 2602.22953)', url: 'https://arxiv.org/abs/2602.22953', desc: 'IBM Research Feb 26 2026 — systematic comparison of tool-call vs MCP vs code-gen vs CLI agent architectures across 6 benchmarks × 5 backbone LLMs. Up to 12pp variance within single model. On 4 of 6 benchmarks top general agents indistinguishable from heavily-customized domain-specific agents' },
            { name: 'Anthropic Project Glasswing initial update (May 22 2026)', url: 'https://www.anthropic.com/research/glasswing-initial-update', desc: 'First public Glasswing program update. Mythos Preview: 6,202 high/crit OSS vulns found (90.6% true-positive), 65 CVE/GHSA advisories, Mozilla Firefox 271 vulns (10x Opus 4.6), Cloudflare 2,000 bugs / 400 high-crit. Mythos solved BOTH UK AISI Cyber Ranges end-to-end (first model). Claude Opus 4.7 patched 2,100+ enterprise vulns in 3 weeks. wolfSSL CVE-2026-5194 certificate-forging exploit constructed' },
            { name: 'Anthropic Coordinated Vulnerability Disclosure dashboard', url: 'https://red.anthropic.com/2026/cvd/', desc: 'Anthropic Red Team CVD dashboard (May 22 2026) — Mythos Preview pipeline: 23,019 candidate findings → 1,900 triaged → 1,726 valid (90.8% TPR) → 1,596 disclosed across 281 OSS projects → 97 patched upstream / 88 CVE+GHSA advisories. Notable: nginx CVE-2026-27654, Temporal CVE-2026-5199, jq CVE-2026-32316, Ghost SQL injection GHSA-w52v-v783-gw97' },
            { name: 'Anthropic Cybersecurity Skills (community library)', url: 'https://github.com/mukul975/Anthropic-Cybersecurity-Skills', desc: 'Community-maintained (NOT Anthropic official) — 754 cybersecurity skills mapped to MITRE ATT&CK, NIST CSF 2.0, MITRE ATLAS, D3FEND, NIST AI RMF. 26 domains (cloud / threat hunting / threat intel / WAF / malware analysis / forensics / SOC / IAM / OT-ICS / container / API / vuln-mgmt / IR / red-team / pentest / endpoint / DevSecOps / phishing / crypto / zero-trust / mobile / ransomware / compliance / deception). 10.1k stars. Compatible with Claude Code / Copilot / Cursor. No model evaluations' },
            { name: 'SensorFM — Wearable Health FM (arxiv 2605.22759)', url: 'https://arxiv.org/abs/2605.22759', desc: 'Google Research + DeepMind May 21 2026. First trillion-minute wearable-health foundation model. 4 sizes (XXS 100K / XS 1M / S 10M / B 100M params) pretrained on 1T+ minutes from 5M participants. SensorFM-B wins 33/35 downstream health tasks. Generative imputation lifts: 74.8% random, 83.7% signal, 38.8% interp, 39.6% extrap. 99.7%/99.9%/99.2% accuracy on step/deep-sleep/light-exercise under 60-min ablation. Gemini classroom (5 student LLMs, 30k experiments). 1,860 clinician ratings on 31 real patient profiles' },
            { name: 'Microsoft MDASH — Defense at AI Speed (May 12 2026)', url: 'https://www.microsoft.com/en-us/security/blog/2026/05/12/defense-at-ai-speed-microsofts-new-multi-model-agentic-security-system-tops-leading-industry-benchmark/', desc: 'Microsoft multi-model agentic security system orchestrating 100+ specialized AI agents. CyberGym 88.45% (#1, +5pts ahead of #2 at 83.1%). Internal Windows kernel: StorageDrive 21/21 (0 FPs), clfs.sys 96% recall on 28 MSRC cases (5yr), tcpip.sys 100% recall on 7 cases. 16 NEW Windows networking vulns including 4 Critical RCE' },
            { name: 'AutoSOTA — Automated SOTA Discovery (arxiv 2604.05550v1)', url: 'https://arxiv.org/abs/2604.05550', desc: 'Tsinghua FIB Lab + Peking + USTC Apr 7 2026 (32pp). End-to-end automated research system, 8 specialized agents. Filters 105 papers from 8 conferences (NeurIPS/ICLR/ICML/CVPR/ICCV/ACL/NAACL/AAAI) via 4-stage filter, replicates + improves SOTA. Avg 5h per paper. Max improvement 63.64% (ID 70 Certified Unlearning ICML 2025). 6 case-study domains (LLM/NLP/Biology/CV/TimeSeries/Optimization)' },
            { name: 'Google Co-Scientist (Nature 10644-y, May 19 2026)', url: 'https://www.nature.com/articles/s41586-026-10644-y', desc: 'Gemini-based multi-agent scientific discovery system. Self-play debate + tournament evolution + asynchronous task execution. 15 expert-curated scientific goals evaluation. Validated in 3 biomedicine domains: drug repurposing for AML (in vitro), novel epigenetic targets for liver fibrosis (organoids), antimicrobial resistance (cf-PICIs phage-tail mechanism matched unpublished findings)' },
            { name: 'Google DeepMind ERA — Empirical Research Assistance (Nature 10658-6, May 13 2026)', url: 'https://www.nature.com/articles/s41586-026-10658-6', desc: 'Aygün, Belyaeva, Comanici et al. LLM + Tree Search system for expert-level scientific software generation. Caltech + MIT + Harvard + McGill + Google DeepMind + Google Research' },
            { name: 'FutureHouse Multi-Agent Discovery (Nature 10652-y, May 12 2026)', url: 'https://www.nature.com/articles/s41586-026-10652-y', desc: 'Ghareeb, Chang, Mitchener et al (FutureHouse + Oxford + Fordham). Multi-agent system for automating scientific discovery — meta-orchestration above FutureHouse Falcon/Owl/PaperQA2/Phoenix agents' },
            { name: 'FactoryWave Dataset (HF)', url: 'https://huggingface.co/datasets/FactoryBench/FactoryBench', desc: 'Companion dataset — 8,983 dense industrial-robot episodes at 125/83 Hz (pick-and-place, peg-in-hole, screwdriving), 27 fault types injected. First multi-arm industrial telemetry corpus' },
            ...
            { name: "Agents' Last Exam (ALE-V1)", url: 'https://agents-last-exam.org/leaderboard', desc: 'Berkeley RDI + RDI Foundation — largest-scale long-horizon agent benchmark: 55 sub-industries, 1,500+ economically-valuable tasks (5,000 goal), 300+ industry experts, verifiable outcomes. Harness×model×effort leaderboard with Pass Rate (perfect-score share) + Score (partial credit). S176 refresh: Opus 4.8 27.0 #1, GPT-5.5 26.3, Fable 5 22.0; ByteDance Seed 2.1 Pro debut 19.5.' },
            { name: 'VulcanBench', url: 'https://www.vulcanbench.com/benchmarks.html', desc: 'Independent agentic-engineering eval with hidden tests, focused on reliability + cost once correctness saturates. Small-sample (10-15 evals, 30-135 runs). Metrics: pass@1, pass^k dependability, cost-per-solved-task. Report 06: Haiku 4.5 pass^k 0.667 (zero variance) beats Opus 4.8. Report 03: Fable 5 $0.28/solved-task vs Sonnet 5 $1.05 vs GLM-5.2 $1.98 (77x tokens). Ingested S176.' },
            ...
            { name: 'Paper PDF (local) — NOHARM medical safety', url: 'resource/NOHARM_medical-safety_arxiv_2512.01241.pdf', desc: 'Local PDF — First-do-NOHARM (arxiv 2512.01241; Stanford/Harvard/ARISE). Medical consultation safety: severity-weighted F1 + severe case-harm rate, 1,100 cases / 10 specialties, 20 LLMs + 4 RAG tools + physician-AI teaming RCT. Per-model scores from HealthRex/harmdash data/metrics.csv. Ingested S249.' },
            { name: 'Paper PDF (local) — HalluHard (arXiv 2602.01031)', url: 'https://arxiv.org/abs/2602.01031', desc: 'HalluHard multi-turn hallucination benchmark (EPFL). 950 seed Qs across legal/research/medical/coding, hallucination-rate percent lower-better. Live leaderboard halluhard.com. Ingested S249: populated existing empty halluhard bench plus 4 domain sub-scores, ~30 current models from authoritative leaderboard-data.js.' },
            { name: 'Paper PDF (local) — OS-Harm computer-use agent safety', url: 'resource/OS-Harm_computer-use-agent-safety_arxiv_2506.14866.pdf', desc: 'Local PDF — OS-Harm (arxiv 2506.14866; EPFL). Safety of computer-use agents on OSWorld: misuse / prompt-injection / misbehavior, unsafe-rate percent lower-better, 150 tasks. Ingested S249 osharm_avg_unsafe, 5 agents.' },
            { name: 'Paper PDF (local) — ChineseHarm-Bench', url: 'resource/ChineseHarm-Bench_arxiv_2506.10960.pdf', desc: 'Local PDF — ChineseHarm-Bench (arxiv 2506.10960; ZJU/Tencent/NUS). Chinese harmful-content detection, macro-F1 over 6 categories, 6,000 samples. Ingested S249 chineseharm_macro_f1, zero-shot current models. github.com/zjunlp/ChineseHarm-bench.' },
            { name: 'Paper PDF (local) — MPIB medical prompt injection', url: 'resource/MPIB_Medical-Prompt-Injection_arxiv_2602.06268.pdf', desc: 'Local PDF — MPIB (arxiv 2602.06268; SNU). Medical prompt-injection and clinical safety: clinical-harm-event-rate plus attack-success-rate under injection, defense hierarchy D0-D4, 9,697 instances. Ingested S249 mpib_v1_cher / mpib_v1_asr D0 baseline lower-better. Deferred: arise-ai.org/mast MAST composite (preview, needs Playwright); Giskard AgentHarm glossary (no results table); Nature s41591-026-04431-5 (separate RCQ study, paywalled).' },

            // 2026-08-24 — S250 batch (local PDFs in resource/)
            { name: 'Paper PDF (local) — SWE-bench Science', url: 'resource/SWE-bench-Science_arxiv_2608.19799.pdf', desc: 'Local PDF — SWE-bench Science (arxiv 2608.19799; Shanghai Innovation Inst / Fudan). Repository-level scientific software engineering, 119 tasks / 98 repos / 20 domains, Pass@1. Ingested S250 swe_bench_science (7 frontier agents; all below 50% Pass@1). github.com/OpenMOSS/SWE-bench-Science.' },
            { name: 'Paper PDF (local) — CliniCARE-Bench', url: 'resource/CliniCARE-Bench_arxiv_2608.07796.pdf', desc: 'Local PDF — CliniCARE-Bench (arxiv 2608.07796; Scale AI). Clinical-agent EHR audit on MIMIC-IV, 4-class verdict accuracy + Macro-F1 + ECE, 750 cases / 14 specialties. Ingested S250 (16 harness-conditioned systems). Best GPT-5.5 76.1%.' },
            { name: 'Paper PDF (local) — PHIZERO world model', url: 'resource/PHIZERO-world-model_arxiv_2607.28624.pdf', desc: 'Local PDF — PHIZERO (arxiv 2607.28624; CASIA). Physical world model (reason-then-render). NEW model ingested S250 with 6 physics benchmarks (Physics-IQ, PhyGround, WorldModelBench, IntPhys2, LikePhys, YoCausal) vs video-model baselines. Phi-Zero.github.io.' },
            { name: 'Paper PDF (local) — TrialPanorama (npj Digital Medicine)', url: 'resource/TrialPanorama_npj_s41746-026-02933-7.pdf', desc: 'Local PDF — TrialPanorama (npj Dig Med s41746-026-02933-7; Wang et al.). Clinical-trial DB+benchmark, 1.6M trials / 8 tasks. NEW models ingested S250: Qwen3-8B-TP & Llama3-8B-TP (trial-trained 8B, beat 70B + GPT-4o). keiji.ai/research/trialpanorama.' },
            { name: 'Paper PDF (local) — AMIE Video (real-time medical consult)', url: 'resource/AMIE-Video-medical_arxiv_2608.09861.pdf', desc: 'Local PDF — AMIE (Video) (arxiv 2608.09861; Google). Gemini-based multi-agent real-time video consultation. OSCE study vs PCPs (top-1 dx 91% vs 77%). Research system, not released — no model row created; recorded as reference.' },
            { name: 'Paper PDF (local) — Qwen3.8-Next Architecture (tech report)', url: 'resource/Qwen3.8-Next-Architecture_tech_report_2026-08-26.pdf', desc: 'Local PDF — On the Design of Qwen3.8-Next Architecture (2026-08-26; Qwen Team). NEW model Qwen3.8-Flash-Next (125B/6B sparse MoE + 51B n-gram + 4B MTP, hybrid Gated-DeltaNet + Qwen Sparse Attention, 262K->1M ctx). Ingested S251: instruct scores (GPQA-D 91.7, LiveCodeBench-v6 91.9, SWE-bench Pro 62.5). Introduces SWEBench-Pretrain, QSA, Gated Residual, FlashQLA kernel.' },
            { name: 'Paper PDF (local) — PAI-Bench (SHI Labs)', url: 'resource/PAI-Bench_arxiv_2512.01989.pdf', desc: 'Local PDF — PAI-Bench: A Comprehensive Benchmark For Physical AI (arxiv 2512.01989; SHI Labs, Georgia Tech/CMU). 2,808 cases, 3 tracks (Generation/Conditional/Understanding). NOTE: already represented in the dashboard via the newer live shi-labs HF leaderboard (pai_bench_g/u/c); this PDF is an older snapshot with config differences, so per-model rows were NOT re-ingested to avoid mis-attribution.' },
            { name: 'Methodology (local) — Muse Spark 1.3 Multimodal Eval', url: 'resource/Muse-Spark-1.3-Multimodal-Eval-Methodology.pdf', desc: 'Local PDF — Meta Muse Spark 1.3 multimodal evaluation methodology (2026-09-02). Defines the benchmark suite (GDPVal-AA v2, JobBench, OSWorld 2.0, DeepSearchQA, AutomationBench, DeepSWE v1.1, SWE-Atlas, Terminal-Bench 2.1, MRCR v2) — metrics/harnesses only, no scores. Actual Muse Spark 1.3 (max) scores read from the developer-page benchmark figure via Playwright (S258): GDPVal-AA 1754, Terminal-Bench 2.1 88.8, DeepSWE 75.4, AAII 61.' },
            { name: 'System Card (local) — Claude Fable 5.1 & Mythos 5.1', url: 'resource/Claude-Fable-5.1-Mythos-5.1-System-Card.pdf', desc: 'Local PDF — Claude Fable 5.1 & Claude Mythos 5.1 System Card (Anthropic, 2026-09-01). Same underlying model, differ only by safeguards (Fable restrictive / Mythos permissive for security + life-sciences). Ingested S256: SWE-bench Pro 81.2, GDPval-AA Elo 1853, AAII 66, HLE 60.9, Terminal-Bench-Science 52.6; Mythos AECI 161.98, Firefox-147 98%, BioMysteryBench/ProteinGym life-sciences. Introduces Terminal-Bench 4.0/-Science, AA-Briefcase, ExploitBench (CyberGym retired).' },
            { name: 'Announcement — OpenAI "Path to Astra" (reference)', url: 'https://openai.com/index/path-to-astra/', desc: 'OpenAI Path to Astra (2026-09-01) — announces Astra (successor to GPT-5.6 Sol), first OpenAI model to cross the "Critical" cybersecurity threshold (Preparedness Framework); restricted cyber access via Daybreak Blue (Cisco/Cloudflare/Palo Alto). Announced-but-unreleased, no specs; only ExploitBench=100 (saturated, secondary-sourced). NOT added as a scored model — reference only until release with standard-suite scores.' },
            { name: 'Paper PDF (local) — GlucoFM (Google, CGM foundation model)', url: 'resource/GlucoFM_arxiv_2605.30865.pdf', desc: 'Local PDF — GlucoFM: A Dual-Stream Foundation Model for Continuous Glucose Monitoring (arxiv 2605.30865; Google Research + UNSW). Lightweight 0.72M-param self-supervised CGM time-series model (state/event dual-stream, JEPA-style). Avg PR-AUC 58.8 (+4.1 vs best baseline) on 14 phenotype tasks; PPGR MAE 21.88 mg/dL. NOT added as a scored model — specialized health time-series FM with no LLM-comparable axis; reference only.' },
            { name: 'Paper PDF (local) — Faraday / Replica (Inherent Labs)', url: 'resource/Faraday-Training-to-Replicate_arxiv_2608.13331.pdf', desc: 'Local PDF — Training AI Scientists to Replicate Research (arxiv 2608.13331; Inherent Labs). NEW model Faraday (27B, post-trained from Qwen3.6-27B via GRPO on the Replica task space, uses Codex GPT-5.5 as tool). Replica = 310 figure-replication tasks / 100 papers. Ingested S250c: Faraday 0.791 held-out AI-for-science (beats Claude Opus 4.8 0.748, GPT-5.5 0.729). Recovered on re-review — the blog essay had no numbers; the paper does.' },
            { name: 'Paper PDF (local) — Agent Skills Can Be Harmful', url: 'resource/Agent-Skills-Can-Be-Harmful_arxiv_2608.11888.pdf', desc: 'Local PDF — Agent Skills Can Be Harmful (arxiv 2608.11888; HUST/Microsoft/UIUC). Empirical study: 307 skill-induced failures (functional + efficiency), SkillTriage attribution tool. Single-config study (Opus 4.6 + OpenCode) — no per-model leaderboard, so no scores ingested (reference only). DeepSeek-V4-Flash-Vision-Exp, AA Analyst Agent (pass^5), MLCR-AA and ApexBench ingested S250 from web sources.' },
            ...
            // ── 2026-05-20 — TextArena + arena.ai vision/text leaderboards + Qwen 3.7 Max/Plus preview ──
            { name: 'TextArena live leaderboard', url: 'https://www.textarena.ai/leaderboard', desc: 'Leon Guertler et al (CFAR @ A*STAR Singapore) — open-source competitive text-game benchmark suite, ~100 game environments in v0.6.9 (paper claimed 57+) across single-player + two-player + multi-player. Online play vs humans + other models with real-time TrueSkill scoring. Balanced Subset top (May 2026): Claude 3.5 Sonnet 30.61 / Qwen2.5-VL-72B 28.44 / Llama-4-Maverick 28.46 / Nova Pro 27.84 / Gemini 2.0 Flash Lite 27.72. Tests dynamic social skills: negotiation, theory of mind, deception. Live at textarena.ai with Supabase RPC backend.' },
            { name: 'TextArena paper (arxiv 2504.11442)', url: 'https://arxiv.org/abs/2504.11442', desc: 'TextArena 5pp work-in-progress (Apr 15 2025, revised May 24 2025) — Leon Guertler, Bobby Cheng, Simon Yu, Bo Liu, Leshem Choshen, Cheston Tan. Introduces the framework + 57+ environments + TrueSkill methodology for benchmarking agentic behavior. GitHub: github.com/LeonGuertler/TextArena.' },
            { name: 'Qwen 3.7 Max/Plus preview deep-dive', url: 'https://atalupadhyay.wordpress.com/2026/05/19/qwen-3-7-deep-dive-honest-review-hands-on-testing-and-when-to-use-max-vs-plus/', desc: 'Hands-on review of Qwen 3.7 Max Preview (flagship, top-tier reasoning, agent workflows) vs Plus Preview (balanced, mid-tier, production workloads). Preview-only on arena.ai — no public weights/API yet. Article qualitative-only (no verbatim benchmark scores) per strict-attribution.' },
            { name: 'arena.ai Vision Leaderboard', url: 'https://arena.ai/leaderboard/vision', desc: 'Sierra-style head-to-head Elo voting arena for multimodal AI models (distinct from lmarena.ai/LMSYS). 870,706 votes / 126 models as of May 17 2026. Top: Claude Opus 4.7 Thinking 1306 / Opus 4.7 1304 / Opus 4.6 Thinking 1300 / Muse Spark 1296 / Opus 4.6 1293 / Gemini 3 Pro 1289 / GPT-5.5 1288. Notable: Qwen 3.7 Plus Preview 1260 (Alibaba debut on Vision Arena), Dola Seed 2.0 Pro 1259 (Bytedance Dola line, distinct from Doubao). Categories: Overall + EN/ZH + Captioning/Creative Writing/Diagram/Entity Recognition/Homework/Humor/OCR.' },
            { name: 'arena.ai Text Leaderboard', url: 'https://arena.ai/leaderboard/text', desc: 'arena.ai Text head-to-head Elo (Sierra/Bret Taylor product). Qwen 3.7 Max Preview entered May 14 2026 at 1475 Elo.' },
            { name: 'TextArena GitHub', url: 'https://github.com/LeonGuertler/TextArena', desc: 'Open-source TextArena Python package — env catalog (~100 environments in v0.6.9: chess, diplomacy, secret mafia, iterated prisoner\'s dilemma, negotiation, codenames, truth-and-deception, etc), Python API for training & evaluation, online play registry.' },

            // ── 2026-05-20 — Google DeepMind Gemini 3.5 Flash + Omni Flash launch ──
            { name: 'Gemini 3.5 Flash model card', url: 'https://deepmind.google/models/model-cards/gemini-3-5-flash/', desc: 'Google DeepMind Gemini 3.5 Flash (May 19 2026) — default model in Gemini app + Google Search AI Mode + Google Antigravity. 1M context, 64K output, $1.50/$9.00/$0.15 cached pricing. Outperforms Gemini 3.1 Pro on 10/14 published benches: Terminal-Bench 2.1 76.2% / MCP Atlas 83.6% / Toolathlon 56.5% / OSWorld-Verified 78.4% / Finance Agent v2 57.9% / GDPval-AA 1656 Elo / CharXiv 84.2% / MMMU-Pro 83.6% / Blueprint-Bench 2 33.6% / SWE-Bench Pro Public 55.1%. Regressions: MRCR v2 128k 77.3% (-7.6 vs 3.1 Pro), HLE 40.2% (-4.2), ARC-AGI-2 72.1% (-5.0).' },
            { name: 'Google blog — Introducing Gemini 3.5', url: 'https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-3-5/', desc: 'Google official Gemini 3.5 announcement (May 19 2026). 3.5 Flash released immediately; 3.5 Pro "rolling out next month" (internal use only at announcement). Claim: "frontier intelligence at exceptional speed" + "4× faster than other frontier models" + "less than half the cost". Top-right quadrant of Artificial Analysis index. Gemini Spark personal agent beta rolling out to Google AI Ultra subscribers (US) next week.' },
            { name: 'Gemini Omni Flash model card', url: 'https://deepmind.google/models/model-cards/gemini-omni-flash/', desc: 'Google DeepMind Gemini Omni Flash (May 19 2026) — multimodal video+audio generation FM. Inputs: text/images/audio/video. Outputs: high-resolution video with audio. Capability scope: T2VA/I2VA/R2VA/video editing/image generation. Distributed via Gemini App, YouTube, Google Flow, Google Flow Music. Benchmark scores explicitly deferred ("will share evaluations when we roll out to developers via APIs"). Speech-conversion capability intentionally restricted.' },
            { name: 'llm-stats.com — Gemini 3.5 Flash launch analysis', url: 'https://llm-stats.com/blog/research/gemini-3.5-flash-launch', desc: 'Third-party launch analysis with full benchmark table cross-confirmed against the deepmind.google model card. Adds Gemini 3.1 Pro comparison column for all 14 benchmarks. Confirms pricing $1.50 / $9.00 / $0.15. Notes Terminal-Bench 2.1 (76.2%) is a different split from Terminal-Bench 2.0 (where Gemini 3.1 Pro scored 68.5 in DB).' },

            // 2026-05-18 — 10-paper cyber batch (5 ingested + 5 deferred/rejected)
            { name: 'PACEbench (arxiv 2602.14457, Shanghai AI Lab v1.5)', url: 'https://arxiv.org/abs/2602.14457', desc: 'Shanghai AI Lab Frontier Risk Framework v1.5 — PACEbench cyber-offense bench. 5 splits: A-CVE single (17 web vulns) / B-CVE blended / C-CVE chained / D-CVE WAF-defended / Overall (weighted). Winner: Claude Sonnet 4.5 thinking 0.335 overall (best every sub-scenario except A-CVE). GPT-5.2 #2 at 0.280. Surprises: MiniMax M2.1 ties top WAF bypass (D-CVE 0.333); Grok 4 near-zero (0.012 overall, A-CVE only 6%).' },
            { name: 'CTI-REALM (arxiv 2603.13517)', url: 'https://arxiv.org/abs/2603.13517', desc: 'Detection-rule generation benchmark (Sigma + KQL on Azure-native telemetry, 50 incidents). 16-model Anthropic+OpenAI head-to-head. Claude Opus 4.6 High 0.6373 best; Claude Opus 4.5 0.624; Claude Sonnet 4.5 0.587; GPT-5 Med 0.572 top OpenAI; o4-Mini worst 0.360.' },
            { name: 'Autonomous Adversary (arxiv 2605.06486, NRC Canada)', url: 'https://arxiv.org/abs/2605.06486', desc: 'Windows AD lateral movement under 3 modes (autonomous/self-scaffolded/expert plan). All 3 frontier models (Sonnet 4.5, Opus 4.5, GPT-5.1) hit 100% with expert plan but drop sharply under fully-autonomous: Sonnet 4.5 80%, Opus 4.5 25%, GPT-5.1 20%. Scaffolding dominates raw capability.' },
            { name: "UK AISI cyber attack ranges (arxiv 2603.11214)", url: 'https://arxiv.org/abs/2603.11214', desc: "UK AISI multi-step cyber attack scenarios. 'The Last Ones' 32-step corporate exfiltration: Claude Opus 4.6 15.6/32 avg (+42% over 4.5's 11.0). 'Cooling Tower' 7-step ICS attack: Opus 4.6 only 1.4/7 (=20%). Frontier ICS capability still floored." },
            { name: 'CyberTeam blue-team threat hunting (arxiv 2509.23571)', url: 'https://arxiv.org/abs/2509.23571', desc: 'Blue-team eval — 452,293 instances × 30 tasks × 4 phases (Attribution/Behavior/Prioritization/Response). 11 models incl. 3 cyber-tuned 7B agents + 8 frontier. R&M Standardized avg: GPT-o4-mini 91.5/100 best; Gemini 2.5 Pro 88.6; Llama 3.1 405B 86.9.' },
            { name: 'Kimi K2.5 Independent Safety Eval (arxiv 2604.03121, DEFERRED)', url: 'https://arxiv.org/abs/2604.03121', desc: '86-page independent safety evaluation of Kimi K2.5 covering ~45 benchmarks × 4 models (Kimi K2.5, Claude Opus 4.5, GPT-5.2, DeepSeek V3.2). Goldmine of 250+ triples spanning ABC-Bench, VCT-multiselect, EVMBench, DFIR-Metric, Petri 2.0, ControlArena, WMDP-sandbagging, BBQ, AgentHarm. Deferred to separate dedicated ingest pass.' },
            { name: 'CyberPal-2.0 IBM SLM (arxiv 2510.14113, DEFERRED)', url: 'https://arxiv.org/abs/2510.14113', desc: 'IBM Research cyber-specialist SLM family: cyberpal-2.0-4b/8b/14b/20b (Qwen3 + gpt-oss-20B finetune). 9 CTI benches. Deferred — small SLM-vs-SLM tier without strong frontier signal.' },
            { name: 'CAIBench meta-benchmark (arxiv 2510.24317, DEFERRED)', url: 'https://arxiv.org/abs/2510.24317', desc: 'CAIBench composite over 4 existing benches + 2 new (rctf2 robotics CTFs / cyberpii_bench). Most scores aggregate existing benches; new sub-benches only have 1-3 frontier entries. Deferred.' },

            // 2026-05-18 — User refs (4 arxiv): Cyber Defense + NYU CTF + HarmfulSkillBench
            { name: 'Simbian Cyber Defense Benchmark (arxiv 2604.19533)', url: 'https://arxiv.org/abs/2604.19533', desc: 'Simbian AI agentic threat-hunting eval for LLMs in SecOps. Agent given raw Windows event logs (75-135k rows) + 50-query budget, no guided questions. 106 OTRF procedures × 93 ATT&CK sub-techniques × 13 tactics × 26 campaign instances. NO model passes ≥50% recall per-tactic bar. Best: Claude Opus 4.6 Coverage 0.55 (clears 7/13 tactics); Opus 4.7 0.44; Sonnet 4.6 0.38; Gemini 3.1 Pro 0.31; GPT-5 0.27. DeepSeek V3.2 0.10 bottom.' },
            { name: 'NYU CTF Bench systematic benchmarking (arxiv 2604.17159)', url: 'https://arxiv.org/abs/2604.17159', desc: 'SUNY Albany (Apr 18 2026) — 10 frontier LLMs × 200 CSAW 2016-2024 challenges (6 categories) via extended D-CIPHER + Kali Linux. Claude Opus 4.5 leads at 59.0% (118/200, $2.12/solve). Gemini 3 Pro 52.0% (6× cheaper at $0.43/solve). Gemini 3 Flash 27.0% (cost-efficiency winner at $0.05/solve). GPT-5.2 13.5%, DeepSeek R1 4.0%, Llama 3.3 70B 2.5%. Claude wins every category, widest gaps in pwn (41% vs 33%) and web (52.6% vs 47.4%).' },
            { name: 'HarmfulSkillBench (arxiv 2604.15415)', url: 'https://arxiv.org/abs/2604.15415', desc: 'CISPA (Apr 16 2026) — first large-scale safety eval of harmful skills in LLM agent skill registries (98,440 skills surveyed; 4.93% harmful). 200 verified harmful skills × 20 categories × 4 conditions (Passive/Active/Safeguard/No-Skill). SAFEST: GPT-5.4-mini (Score_B 0.23, 100% Tier-1 refusal no-skill baseline). LEAST SAFE: GPT-4o (Score_A 0.85, 0% Tier-1 refusal under passive exposure) and DeepSeek V3.2 (Score_A 0.88). Key finding: skill-reading exploit raises harm score from 0.27 (no skill) to 0.76 (passive exposure).' },
            { name: 'World Action Models survey (arxiv 2605.12090, SKIPPED)', url: 'https://arxiv.org/abs/2605.12090', desc: 'Fudan/OpenMOSS/SII (May 12 2026) — first taxonomy of ~150 WAM (World Action Model) methods. Survey paper with 0 extractable triples; useful as INDEX pointing to 10 primary papers (Ctrl-World, π0.5/0.7, V-JEPA 2/2.1, LIBERO-Plus, etc.) for individual mining. Not ingested per strict-attribution.' },

            // 2026-05-18 — xAI Grok Build CLI
            { name: 'xAI Grok Build CLI (May 14 2026)', url: 'https://x.ai/news/grok-build-cli', desc: 'xAI agentic coding CLI launch (May 14 2026) — rivals Claude Code / Codex CLI / Gemini CLI. Powered by grok-code-fast-1: SWE-Bench Verified 70.8% (just below Sonnet 4.6 72.7%, well behind Opus 4.7 87.6%). 256k context, ~92 tok/sec, pricing $0.20/$1.50 per M tokens (orders of magnitude cheaper than top frontier). Up to 8 parallel sub-agents, plan-mode approval gating. Beta via SuperGrok Heavy ($299/mo) or SuperHeavy ($99/mo intro). Strategy: speed + price over top-of-leaderboard accuracy.' },

            // 2026-05-18 — NVIDIA SANA-WM
            { name: 'NVIDIA SANA-WM — Efficient minute-scale world model', url: 'https://nvlabs.github.io/Sana/WM/', desc: 'NVIDIA Labs SANA-WM (May 14 2026) — 2.6B open-source minute-scale world model. Hybrid Gated DeltaNet + softmax attention; dual-branch UCPE+Plucker camera control; native 60s 720p. New 1-minute world-model benchmark (Simple + Hard splits). SANA-WM+refiner ties LingBot-World on Hard split VBench-Overall (81.89) but with 8.34deg RotErr vs 18.99deg (2.3x better) AND ~36x faster (22 vid/hr vs 0.6). Distilled variant runs 60s/720p on single RTX 5090 in 34s with NVFP4. arxiv 2605.15178.' },
            ...
            // 2026-05-28/29 Sessions 31-33 — benchmark leaderboards surfaced by recent ingests
            { name: 'DeepSWE (Datacurve)', url: 'https://deepswe.datacurve.ai/data', desc: 'Contamination-free SWE leaderboard — 113 hand-crafted tasks x 91 repos x 5 languages x 7,232 trials. Pass@1 ± CI. gpt-5.5 70% leads, then gpt-5.4 56 / opus-4.7 54 / sonnet-4.6 32. Hand-crafted tasks expose coding gaps standard benches miss (DS-V4-Pro 8%).' },
            { name: 'FrontierSWE (Proximal)', url: 'https://frontierswe.com/blog', desc: 'Ultra-long-horizon SWE leaderboard — 17 open-ended engineering problems (production compilers, training optimizers, PostgreSQL-compatible servers), 20h/task, continuous scoring by speedup/coverage, mean@5 + best@5. Claude Opus 4.8 ranks #1 on both (avg rank 2.74 / 2.26).' },
            { name: 'Harvey AI — Legal Agent Benchmark', url: 'https://www.harvey.ai/blog/legal-agent-benchmark-initial-results', desc: 'Open-source legal-agent leaderboard — 1,200+ tasks x 24 practice areas, closed-universe documents (.xlsx/.docx/.eml/.pptx), LLM-as-judge all-pass scoring. Claude Opus 4.8 first model to break 10% overall (9.62% all-pass / 89.01% mean criterion).' },
            { name: 'Andon Labs — Vending-Bench 2', url: 'https://andonlabs.com/evals/vending-bench-2', desc: 'Long-horizon autonomous-business benchmark — manage a simulated vending machine for a year from $500, scored on final balance. Tests sustained coherence + supplier negotiation + pricing over thousands of decisions. Opus 4.7 leads Opus 4.8 here ($10,937 vs $2,992 Max effort).' },
            { name: 'AutoScientists (Harvard)', url: 'https://autoscientists.openscientist.ai', desc: 'Self-organizing agent teams for long-running science (Gao/Fang/Zitnik). BioML-Bench 74.40 percentile (vs Autoresearch 66.07), ProteinGym 217-assay Spearman 0.657→0.700, ACE2-Spike +12.5%, GPT nanochat 0.9730 bpb (7 vs 0 improvements). Code: github.com/mims-harvard/AutoScientists.' },
            { name: 'DeepRare (Nature s41586-025-10097-9)', url: 'https://www.nature.com/articles/s41586-025-10097-9', desc: 'SJTU+Xinhua+Harvard agentic rare-disease diagnosis. Aggregate HPO Recall@1 57.18% across 7 public datasets (vs second-best Reasoning LLM 33.39); multimodal HPO+gene 69.1 vs Exomiser 55.9; head-to-head vs 5 senior physicians R@1 64.4 vs 54.6 with 95.4% reasoning-chain agreement. 2,919 diseases x 14 specialties.' },

            // 2026-05-05 Subquadratic SubQ — first sub-quadratic frontier LLM
            { name: 'SubQ (Subquadratic) — 12M-token sub-quadratic LLM', url: 'https://thenewstack.io/subquadratic-12-million-context-window/', desc: 'Miami startup out of stealth May 5 2026 ($29M seed). First frontier-scale LLM on a fully sub-quadratic sparse attention (SSA) architecture — native 12M-token context, near-linear scaling, ~52x faster attention at scale. VENDOR-REPORTED: RULER@128K 95.0% at $8 vs Opus 4.6 94.8% at ~$2,600 (~325x cheaper), MRCR v2@1M 65.9%, SWE-Verified 81.8%. No peer-reviewed paper yet (pending) — scores not independently reproduced.' },

            // 2026-05-29 Session 35 — Video-MME + MMAU frontier backfill (resolved stale monitoring TODOs)
            { name: 'Qwen3.5-Omni Technical Report (arxiv 2604.15804)', url: 'https://arxiv.org/abs/2604.15804', desc: 'Qwen Team (Apr 17 2026). Omni audio-visual FM family (Plus/Flash). Primary source for first 2026-frontier Video-MME + MMAU scores in this dashboard: MMAU — Omni-Plus 82.2 / Omni-Flash 80.4 / Gemini-3.1 Pro 81.1 (Table 5); Video-MME w/o-sub — Plus 81.9 / Flash 77.0 (Table 6); Video-MME w/audio (use_audio_in_video=True) — Gemini-3.1 Pro 89.0 / Plus 83.7 / Flash 79.3 (Table 7). Local PDF: resource/qwen3.5_omni_tech_report_2604.15804.pdf.' },
            { name: 'Step-Audio-R1.5 Technical Report (arxiv 2604.25719)', url: 'https://arxiv.org/abs/2604.25719', desc: 'StepFun / Yuxin Zhang et al (Apr 28 2026). Audio-reasoning model. Table 1 MMAU comparison source: Step-Audio-R1.5 77.9 (self) / Step-Audio-R1 77.0 / Gemini 3 Pro 79.8 / Gemini 3 Flash 75.9 (reported via official APIs). Local PDF: resource/step_audio_r1.5_tech_report_2604.25719.pdf.' },

            // 2026-05-29 Session 36 — 10-link multi-source analysis (4 new models / 18 new benchmarks)
            { name: 'AgentDoG 1.5 (arxiv 2605.29801)', url: 'https://arxiv.org/abs/2605.29801', desc: 'Shanghai AI Lab (May 28 2026). Lightweight agentic-trajectory safety/security judge (0.8B-8B). Introduces ATBench-Claw + ATBench-Codex (figure-only scores). Table 2 R-Judge/ATBench Accuracy: Gemini-3.1-Pro leads R-Judge 97.3; AgentDoG 1.5-4B-U leads ATBench 78.4. Code github.com/AI45Lab/AgentDoG. Local PDF resource/agentdog_1.5_2605.29801.pdf.' },
            { name: 'Gemini Embedding 2 (arxiv 2605.27295)', url: 'https://arxiv.org/abs/2605.27295', desc: 'Google (May 26 2026). Native multimodal (V/A/I/T) embedding model, 3072-dim. SOTA multimodal-retrieval mean 77.2, MTEB(Code) 84.0, CoIR 82.3, MTEB(Multilingual) 69.9, MSEB native-audio 73.99. Local PDF resource/gemini_embedding_2_2605.27295.pdf.' },
            { name: 'LocateAnything-3B (arxiv 2605.27365 / NVIDIA LPR)', url: 'https://research.nvidia.com/labs/lpr/locate-anything/', desc: 'NVIDIA (May 26 2026). 3B vision-language grounding/detection with Parallel Box Decoding (~2.5x throughput). SOTA ScreenSpot-Pro GUI grounding 60.3 at 3B; LVIS 50.7 / COCO 54.7 mean-F1 / RefCOCOg test 77.6. HF nvidia/LocateAnything-3B. Local PDF resource/locateanything_2605.27365.pdf.' },
            { name: 'Liquid AI LFM2.5-8B-A1B', url: 'https://www.liquid.ai/blog/lfm2-5-8b-a1b', desc: 'Liquid AI (May 28 2026). On-device MoE: 8B total / ~1B active, 128K context. Matches Gemma-4-26B-class at ~1B active params; IFEval 91.84 / MATH500 88.76 / Tau2 Telecom 88.07 / AA-Omniscience Index -24.70. 253 tok/s on M5 Max. Distinct from LFM2-8B-A1B.' },
            { name: 'Lyptus Research — Offensive Cyber Time Horizons', url: 'https://lyptusresearch.org/research/gpt-5-5-saturates-offensive-cyber-time-horizons', desc: 'Lyptus Research (Jack Payne, Sean Peters; May 27 2026). METR-style time-horizon extended to offensive cyber (316 tasks × 7 benches: CyBench/InterCode-CTF/NL2Bash/CyBashBench/NYUCTF/CVEBench/CyberGym). GPT-5.5 P50 5.1h @2M, 92.4% success @50M — saturates the suite (P50 off-scale >12h). Opus 4.6 3.2h, GPT-5.3 Codex 3.1h. Doubling time now ~5.1 months.' },

            // 2026-05-30 Session 37 — 17-link multi-source ingest (3 CAD + FACTS + SCADBench + CompassRank + T-Bench)
            { name: 'CADBench (MIT, arxiv 2605.10873)', url: 'https://arxiv.org/abs/2605.10873', desc: 'MIT (Doris/Sony/Nehme/Syla/Nobari/Ahmed, May 12 2026). Multimodal CAD program generation — mesh/single-view/multi-view/render → CAD code. 18,000 samples × 6 families. Aggregate IoU (Table 2): CADFit specialist 0.895 SOTA; frontier LLMs: Opus 4.7 0.306 / Gemini 3.1 Pro 0.295 / Kimi K2.6 0.142 / GPT-5.4 0.124. ~3x gap specialist vs frontier. HF: DeCoDELab/CADBench. Local PDF resource/cadbench_2605.10873.pdf.' },
            { name: 'BenchCAD (UVA/Rice, arxiv 2605.10865)', url: 'https://arxiv.org/abs/2605.10865', desc: 'UVA + Rice (Zhang/Liu/Chen/Li/Yang/Peng/Chen, May 11-12 2026). Programmatic CAD (CadQuery). 17,900 execution-verified programs + 2,400 QA + 748 edit pairs + Vision2Code. BenchCAD-QA Vision Total: Gemini 3.1 Pro 0.587 / Opus 4.7 0.526 / o3 0.327. BenchCAD-Edit Accuracy SOTA: GPT-5.3-thinking 0.865. 106 industrial part families × 47 ISO/DIN standards. Local PDF resource/benchcad_2605.10865.pdf.' },
            { name: 'Text2CAD-Bench (arxiv 2605.18430)', url: 'https://arxiv.org/abs/2605.18430', desc: 'Wang et al (May 18 2026). Text-to-parametric CAD. 600 examples × L1-L4 levels (1,200 prompts geo+seq). VLM-judged 0-10 + IoU/CD/IR metrics. L4 Overall SOTA: DeepSeek-V3.2 8.26 / Sonnet 4.5 8.23 / Gemini-3-Flash 8.20 / GPT-5.2 8.17. L4 lowest Invalidity: Gemini-3-Flash 17%. Local PDF resource/text2cad_bench_2605.18430.pdf.' },
            { name: 'SCADBench — OpenSCAD Arena', url: 'https://scadbench.com/', desc: 'Community OpenSCAD code-generation ELO arena (Chatbot Arena style). 19 models × 5,325 blind votes (pairwise STL render comparison). SOTA: gemini-3.1-pro-preview ELO 1721 / 92.9% win rate; best value gemini-3-flash-preview 1459 ELO at $0.002 (68x cheaper). Tier-2 cluster: gpt-5.2, Opus 4.6, Sonnet 4.6 (1372-1416). Live API: scadbench.com/api/leaderboard.' },
            { name: 'Modelrift OpenSCAD LLM Benchmark — Pantheon', url: 'https://modelrift.com/blog/openscad-llm-benchmark/', desc: 'Modelrift single-task OpenSCAD evaluation (May 21 2026) — 1 reference task (Pantheon temple from images), 2 axes (Speed 1-5 + Quality 0-5). Tests tool+model combos (Cursor 3.5/Composer, Codex 5.5 High, Claude Code 2.1/Opus 4.7, Antigravity 2.0/Gemini 3.5 Flash). Not pure model scores — reference only.' },
            { name: 'FACTS Leaderboard (arxiv 2512.10791, Google+Anthropic)', url: 'https://arxiv.org/abs/2512.10791', desc: 'Google + Anthropic (Cheng et al, Dec 11 2025). Factuality benchmark suite of 4 sub-benches (Grounding v2 + Multimodal + Parametric + Search). Aggregate FACTS Score SOTA: Gemini 3 Pro 68.8 (top every sub-bench) / Gemini 2.5 Pro 62.1 / GPT-5 61.8 / Grok 4 53.6 / Claude 4.5 Opus 51.3. Gemini 3 Pro Search 83.8 SOTA. Local PDF resource/facts_leaderboard_2512.10791.pdf.' },
            { name: 'OpenCompass CompassRank Multimodal', url: 'https://rank.opencompass.org.cn/leaderboard-multimodal', desc: 'Shanghai AI Lab multimodal leaderboard — 8-bench composite mean (MMBench V1.1/MMStar/MMMU/MathVista/HallusionBench/AI2D/OCRBench/MMVet). REALTIME 2026-05-26: JT3.5 82.7 (China Mobile, #1) / SenseNova-V6.5-Pro 82.2 / TeleMM-2.0-Thinking 81.1 / Gemini-2.5-Pro 80.1 / GPT-5 79.9. Sovereign-CN VLMs dominate Western frontier.' },
            { name: 'OpenVLM Leaderboard (HF Spaces, OpenCompass)', url: 'https://huggingface.co/spaces/opencompass/open_vlm_leaderboard', desc: 'OpenCompass / Shanghai AI Lab — 285 models × 25 VLM benches via VLMEvalKit (arxiv 2407.11691). Raw per-benchmark matrix (vs CompassRank curated 8-bench composite). Data file dated Sep 2025 (stale) — use CompassRank REALTIME for current frontier coverage.' },
            { name: 'Kilo AI Model Leaderboard', url: 'https://kilo.ai/leaderboard', desc: 'Kilo Code (kilo.ai) — IDE/CLI platform for 3M+ developers. Terminal-Bench 2.0 re-run + Cost/Attempt + per-mode usage telemetry. SOTA Terminal-Bench 2.0 Kilo-harness: GPT-5.5 74.2% ($72.63) / Opus 4.7 70.1% ($100.51) / Sonnet 4.6 55.1% ($53.37). Best value: DeepSeek V4 Pro 44% / $15.91. Free Laguna M.1 (Kilo house) #1 real-usage despite #9 score. Note: re-run scores differ from official tbench.ai (harness mismatch) — reference only.' },
            { name: 'world-models.io editorial leaderboard', url: 'https://world-models.io/en/leaderboard/', desc: 'Editorial composite-index ranking of world models (DreamerV3 #1, NVIDIA Cosmos #2, MuZero #3, Genie 2 #4, etc.). Qualitative-only — NO numeric scores, mostly 2019-2024 entries. Reference for taxonomy; not a measured benchmark.' },
            { name: 'GigaBrain Challenge 2026 (CVPR World Model Track)', url: 'https://huggingface.co/spaces/open-gigaai/CVPR-2026-WorldModel-Track-LeaderBoard', desc: 'GigaAI Research CVPR 2026 World Model competition (concluded mid-April 2026). 18 team submissions for conditional video generation in embodied VLA tasks. SOTA Wan-3D v0.3 best_score 57.11 (Tsinghua xuwu) / ABot-PhysWorld 55.94 (AMAP CV Lab) / RiceAD 54.35 (Xiaomi EV). Competition entries (not foundation models) — reference only.' },
            { name: 'Terminal-Bench v2.1 official leaderboard', url: 'https://www.tbench.ai/leaderboard/terminal-bench/2.1', desc: 'Official tbench.ai T-Bench 2.1 board (last updated 2026-05-29). 11 agent+model combos. SOTA: GPT-5.5 (Codex CLI) 83.4% / Opus 4.8 (Claude Code) 78.9% / GPT-5.5 (Terminus 2) 78.2% / Opus 4.8 (Terminus 2) 74.6%. Multiple harnesses surface model capability variance.' },
            { name: 'Terminal-Bench 3.0 launch post + leaderboard', url: 'https://www.tbench.ai/blog/terminal-bench-3-0', desc: 'Official TB3.0 launch (2026-07-30): 74 community tasks / 7 domains; 8-model pass-rate chart (GPT-5.6 Sol 34.4 / Fable 5 33.8 / Opus 4.8 21.1 / Terra 20.8 / Grok 4.5 17.8 / Sonnet 5 14.6 / Luna 14.3 / GLM 5.2 5.1) + TB2.1-vs-3.0 slope + cost Pareto. GitHub repo was previously named frontier-bench (S272 merged the frontier_bench id).' },
            { name: 'OpenRouter — 2026-09-18~22 listings (S283)', url: 'https://openrouter.ai/models', desc: "New: Qwen3.8 Omni Flash (Alibaba, $0.15/$0.47, 1M ctx, omni), Ternary Bonsai 2 27B (PrismML, Qwen3.8-27B ternary, Apache-2.0), GLM-5.3-FlashX (Z.ai, 320B/18B, $0.37/$1.25), AssemblyAI Universal-3.5 Pro STT ($0.21/hr official). Command A+ priced ($0.30/$1.50). Grok 4.7's xAI endpoint on OpenRouter shows $1.60/$4.80 vs xAI docs $2/$6 (official kept). :batch variants = 50% billing mode, not separate models. No benchmark data on OpenRouter pages." },
            { name: 'Artificial Analysis — Claude Opus 5.5 / GPT-6 Sol-Luna / Grok 4.7 articles (S284)', url: 'https://artificialanalysis.ai/articles/claude-opus-5-5', desc: 'Opus 5.5 max tops the Intelligence Index v4.3 at 58 (HLE 61.4, SciCode 66.9, TB 4.0 59.6, Briefcase 1822, GDPval 1846); all five effort tiers ingested from the model pages. GPT-6 Sol/Luna: cost per task $1.06/$0.07, Coding Agent Index 57/41. Grok 4.7 + Grok Build: Coding Agent Index 56 (Grok 4.6 xhigh 47).' },
            { name: 'Claude Opus 5.5 launch page', url: 'https://www.anthropic.com/claude-opus-5-5', desc: '2026-09-22. $4/$20 per Mtok (cache read $0.20, write $5), 1M ctx, knowledge cutoff June 2026. 230-page system card archived in resource/: GDPval-AA v2.1 1846, AA-Briefcase v1.1 1822, CursorBench 4.0 57.8, HLE 64.4 / 67.7 w/ tools, OSWorld 2.0 81.8/48.7, Terminal-Bench 4.0 66.4 (xhigh), HealthBench Pro 65.6 (length-adjusted). Effort-tier curves for HLE/WANDR/DRACO read from figures (S282).' },
            { name: 'Introducing GPT-6 Sol and GPT-6 Luna (OpenAI)', url: 'https://openai.com/index/introducing-gpt-6-sol-and-luna/', desc: "2026-09-22. Seven cost-vs-score charts with 5 effort tiers each (AutomationBench 1.0.6, Agents' Last Exam, factuality, FrontierCode 1.1, DeepSWE, OSWorld 2.0 offline, unauthorized interaction) read from aria-labels. Pricing Sol $2/$0.20/$2.50/$10, Luna $0.10/$0.01/$0.125/$0.50 (~half GPT-5.6). Safety data in the Astra card Appendix A (S282)." },
            { name: 'Artificial Analysis — GPT-6 Sol / Luna model pages', url: 'https://artificialanalysis.ai/models/gpt-6-sol', desc: 'AA Intelligence Index v4.3 (Sol 47.5, Luna 37.3, Astra 52.7) with all effort tiers. v4.3 re-based GDPval-AA to v2.1 (Astra Elo 1629 → 1542) and AA-Briefcase to v1.1 → new ids gdpval_aa_v2_1_elo / gdpval_aa_v2_1 / aa_briefcase_v1_1; older rows kept. Launch tweet: Coding Agent Index Sol 57 / Luna 41 (S282).' },
            { name: 'MiMo-V2.6 blog + HF model cards (Xiaomi)', url: 'https://mimo.xiaomi.com/mimo-v2-6', desc: '2026-09-22, MIT. Pro 1.02T/42B, Flash 309B/15B, omnimodal, 1M ctx. TB2.1 89.9/87.6, DeepSWE 71.9/67.9, CyberGym (Xiaomi-corrected env) 94.0/95.1, GDPval-AA v2.1 1673, Toolathlon-Verified 76.9. Also MiMo-V2.6-Distill-Qwen-9B and the UltraSpeed serving mode. Blog is a JS SPA — rendered with Playwright (S282).' },
            { name: 'Grok 4.7 launch (xAI)', url: 'https://x.ai/news/grok-4-7', desc: '2026-09-21. CursorBench 4.0 46.3 (+ effort-tier cost curve), EEBench 64.0, Terminal-Bench 4.0 37.6, DeepSWE 71.0 (high), Harvey LAB 19.6, HealthBench Pro 56.7, LatchBio biosafety 62.4, HackerBench v0.3 pass-through 3.3%. $2/$6, 500K ctx; AA v4.3 46.5 (S282).' },
            { name: 'RoboHarm (robocurve.org)', url: 'https://robocurve.org/roboharm/', desc: 'Embodied-safety benchmark: models drive a real robot arm through 5 harmful physical tasks. cells.csv gives pooled refusal / harmful-completion rates with Wilson CIs — Claude Fable 5.1 refused 20/100 (34 harmful completions), GPT-6 Astra 3/100 (60), MolmoAct2. Physical AI → Embodied Safety suite (S282).' },
            { name: 'OpenRouter — image generation models compared', url: 'https://openrouter.ai/blog/insights/image-generation-models-compared/', desc: 'OpenRouter-measured cost of one default 1:1 image for 20 models (gpt-image-2 $0.006 … Seedream 5.0 Pro $0.09) → openrouter_default_image_cost_usd_lower_better. Quality sweep and small-sample text-rendering results not ingested (S282).' },
            { name: 'DeepSeek-V4.1-Flash model card + tech report', url: 'https://huggingface.co/deepseek-ai/DeepSeek-V4.1-Flash', desc: '2026-09-10, MIT. 552B Causal Encoder-Decoder MoE (8B active prefill / 16B decode), 1M ctx, native vision, 890 B/token global KV cache. Own rows: TB2.1 90.6, TB3.0 30.0, TB4.0 31.2, DeepSWE 74.2, CyberGym 88.1, HLE w/ tools 63.9, Codeforces 3471, AIME 2026 100 at max effort; scaffold table (Claude Code/Codex/OpenCode/Pi/mini-SWE/DSH). 51-page tech report archived in resource/ (S278).' },
            { name: 'DeepSeek-V4.1-Flash launch post', url: 'https://www.deepseek.com/en/news/deepseek-v4-1-flash/', desc: 'Launch table image (V4.1-Flash vs V4-Pro-0813 / V4-Flash-0731 / GLM-5.3 / K3 / Sol / Opus 5). deepseek.com refuses direct fetches from CI — read via r.jina.ai. Pricing: deepseek-flash $0.30/$1.20 peak ($0.15/$0.60 off-peak), cache hit $0.006; V4 Pro retires into V4.1 Flash on 2026-09-14 (S278).' },
            { name: 'Ling-3.0-flash model card (inclusionAI)', url: 'https://huggingface.co/inclusionAI/Ling-3.0-flash', desc: '124B-A5.1B hybrid-linear (KDA+MLA) MoE, MIT. Eval table (image): SWE-Bench Pro 56.6, TB2.1 57.0, MCP-Atlas 65.5, BrowseComp 72.2 (82.0 multi-agent), AIME26 93.2, MRCR-256k 81.1; Ring-2.6-1T column = previous flagship. Sante health variant announced 2026-09-04 (S276).' },
            { name: 'Step 3.7 Flash launch blog (StepFun)', url: 'https://static.stepfun.com/blog/step-3.7-flash/', desc: '198B-A11B VLM, Apache-2.0, 2026-05-29. Own rows: SWE-Bench Pro 56.3, TB2.1 59.6, HLE w/ tool 47.2, ClawEval-1.1 67.1, DeepSearchQA F1 92.8, SimpleVQA 79.2, V* 95.3; Step-SWE-Bench by harness (Claude Code 71.5 … RooCode 64.5). Competitor columns are StepFun runs — not ingested (S276).' },
            { name: 'Spark-X2.5 model cards (XHToken)', url: 'https://huggingface.co/XHToken/Spark-X2.5-4B', desc: '4B / 1.7B hybrid SWA+full-attention models, native 1M ctx, Ascend-trained, Apache-2.0. 21-benchmark table: 4B BrowseComp 40.9, τ³-bench 30.4, MCP-Atlas 54.6, SWE-Bench Pro 44.4, AIME 2026 90.7 (S276).' },
            { name: 'AgentCPM-Explore paper (arXiv 2602.06485)', url: 'https://arxiv.org/pdf/2602.06485', desc: 'OpenBMB 4B agent model (Qwen3-4B-Thinking base, AgentRL). Table 1: GAIA 63.9, BrowseComp 24.1, BC-ZH 29.1, HLE 19.1, FRAMES 82.7, WebWalkerQA 68.1, SEAL-0 40.5, xbench-DeepSearch 70.0. PDF archived in resource/ (S276).' },
            { name: 'OSWorld 2.0 paper (arXiv 2606.29537)', url: 'https://arxiv.org/pdf/2606.29537', desc: 'XLANG Lab: 108 long-horizon computer-use workflows. Table 3 (batched vs single-action, cost/tool-calls/tokens per task), Table 21 (by expected task time), Table 23 (10 challenge phenomena × 5 models), Tables 14/15 (unsafe behaviours, behaviour-analysis outcomes) mined in S276; headline rows were already in the DB from the live leaderboard.' },
            { name: 'Browser Use open benchmarks (BU Bench)', url: 'https://github.com/browser-use/benchmark', desc: 'BU Bench V1: 100 hard live-web tasks, gemini-2.5-flash binary judge. official_results/: Opus 4.7 74, GPT-5.5 66, Gemini 3.5 Flash 65, Qwen3.6-Plus 45, DeepSeek V4 Flash 37, Luna 31; blog: Claude Fable 5 80.0 at $580.87/run. Cloud agents (bu-v4 85) not ingested. V2 (200 tasks) has no published numbers yet (S276).' },
            { name: 'Artificial Analysis — GPT-6 Astra release page', url: 'https://artificialanalysis.ai/models/releases/gpt-6-astra', desc: 'AA release view of all 6 Astra variants (max/xhigh/high/medium/low/non-reasoning). Intelligence Index v4.2 (10 evals; Astra max 54.7 vs 61.2 on v4.1.1), Finance/Strategy/Legal/Engineering/Economics capability indices, cost·time·tokens per task, TTFAT, output speed. RSC payload carries a 23-model comparison set (S273).' },
            { name: 'OpenAI API pricing (official)', url: 'https://developers.openai.com/api/docs/pricing', desc: 'Official per-1M-token prices: gpt-6-astra $10/$1/$12.50/$50 (long-context >272K: $20/$75), gpt-5.6-sol $4/$20 promo, terra $2/$12, luna $0.20/$1.20, gpt-5.6-cyber $12.50/$75; Batch/Flex 50%, Fast 2×; realtime-2.1, gpt-image-2, sora-2, transcription models (S273).' },
            { name: 'Anthropic API pricing (official)', url: 'https://docs.anthropic.com/en/docs/about-claude/pricing', desc: 'Official Claude price table: Fable/Mythos 5.1 & 5 $10/$50 (cache read $0.25 / $1), Opus 5·4.8·4.7·4.6·4.5 $5/$25, Sonnet 5 $2/$10, Sonnet 4.6/4.5 $3/$15, Haiku 4.5 $1/$5; 5m cache write 1.25×, Batch 50%, Fast mode (Opus 5/4.8) $10/$50. Source of the S274 Opus corrections.' },
            { name: 'Google Gemini API pricing (official)', url: 'https://ai.google.dev/gemini-api/docs/pricing', desc: 'Per-model Standard/Batch/Flex/Priority tables. Gemini 3.8/3.7/3.6 Flash $0.75/$3.75 promo through 2026-12-31 (list $1.50/$7.50), 3.5 Flash $1.50/$9, 3.5 Flash-Lite $0.30/$2.50, 3.1 Pro $2/$12 (>200K $4/$18), Nano Banana image-token rates (S274).' },
            { name: 'Z.ai GLM API pricing (official)', url: 'https://docs.z.ai/guides/overview/pricing', desc: 'GLM-5.3/5.2/5.1 $1.4/$4.4 (cached $0.26), GLM-5 $1/$3.2, GLM-4.7/4.6/4.5 $0.6/$2.2, 4.5-Air $0.2/$1.1, GLM-5.3-Flash promo $0.075/$0.25. Used as first-party price over OpenRouter cheapest-host rates (S274).' },
            { name: 'Mistral API pricing (official)', url: 'https://mistral.ai/pricing/api/', desc: 'Large 3 $0.5/$1.5, Medium 3.5 $1.5/$7.5, Small 4 $0.15/$0.6, Ministral 3 (3B/8B/14B) $0.1/$0.15/$0.2 flat, Codestral $0.3/$0.9, Devstral 2 $0.4/$2. Matched OpenRouter Mistral endpoints (S274).' },
            { name: 'Upstage pricing (official)', url: 'https://www.upstage.ai/pricing', desc: 'Solar Pro 4 list $0.30 / $0.06 cached / $1.20 — the $0.03/$0.12 on OpenRouter is a 90%-off launch promo through 2026-09-10, not the list price (S274).' },
            { name: 'OpenRouter — GPT-6 Astra', url: 'https://openrouter.ai/openai/gpt-6-astra', desc: 'Aggregator model page: 1,050,000 ctx / 128,000 max output, OpenAI+Azure endpoints at $10/$50 (Flex $5/$25, Fast $20/$100), per-provider latency/throughput/uptime (not ingested). Also lists openai/gpt-6-astra-pro (same weights, reasoning.mode=pro) — added as a model in S273.' },
            { name: 'Terminal-Bench-Science 0.1 announcement + leaderboard', url: 'https://www.terminal-bench-science.ai/announcement', desc: 'Stanford/Harbor/Laude scientific-workflow terminal tasks (70; life/earth/engineering/mathematical/physical). 9-model resolution-rate chart (Opus 5 30.0 / GPT-5.6 Sol 22.4 / Fable 5 21.4 …), TB2.1/TB3.0/TBS slope chart, cost+token Pareto, 3-model domain radar — all read from SVG geometry (S265/S271/S272).' },

            // 2026-05-30 Session 38 — 13-link multi-source ingest (WorldArena + PhAIL + PAI-Bench + CritPT + MMLU-Pro AA + IPhO 2025)
            { name: 'WorldArena (Tsinghua FIB Lab)', url: 'https://world-arena.ai/', desc: 'Tsinghua FIB + SJTU/HKU/Princeton/CAS/USTC/PKU/NUS. Embodied World Models benchmark — 3 tracks (Video Perception EWMScore over 16 metrics × 6 dimensions / Data Engine / Policy Evaluator). Built on RoboTwin 2.0 Clean-50 (50 manipulation tasks). CVPR 2026 challenge. Named-baseline SOTA: Ctrl-World EWMScore 0.6006 / IRASim 0.5589 / CogVideoX 0.5573 / Cosmos-Predict 2.5 (text) 0.5306. arxiv 2602.08971. GitHub: tsinghua-fib-lab/WorldArena.' },
            { name: 'PhAIL — Positronic Robotics Physical AI Leaderboard', url: 'https://phail.ai/', desc: 'Positronic Robotics (whitepaper 2026-05-28). Real-hardware bin-to-bin order picking on Franka FR3 + Robotiq 2F-85 + Stereolabs ZED cameras (DROID-style). 4 object classes × 1,083 logged rollouts. Metrics: UPH (units/hour), Completion %, MTBF/A. Rank #1 autonomous: Pi 0.5 (59.2 UPH / 44.9% completion) ~tied with NVIDIA GR00T N1.6 (56.8 / 45.0%). Human baseline 1330.8 UPH (22x best autonomous). HuggingFace SmolVLA outlier at 18.2 UPH.' },
            { name: 'PAI-Bench (arxiv 2512.01989, SHI Labs / CMU)', url: 'https://arxiv.org/abs/2512.01989', desc: 'Zhou/Huang/Li/Ramanan/Shi (Dec 1 2025). PAI-Bench Comprehensive Physical AI Benchmark — 2,808 real-world cases × 3 sub-benches: G (Generation, 6 axes) / C (Conditional Generation) / U (Understanding). Generation SOTA: Cosmos3-Super 83.9% (first to exceed Source oracle 82.6%). Understanding SOTA: Cosmos-Reason2-32B 70.8% (beats GPT-5 thinking 69.8). HF leaderboard: shi-labs/physical-ai-bench-leaderboard. Local PDF resource/paibench_2512.01989.pdf.' },
            { name: 'SHI Labs Physical AI Bench Leaderboard (HF Space)', url: 'https://huggingface.co/spaces/shi-labs/physical-ai-bench-leaderboard', desc: 'Live PAI-Bench leaderboard backed by SHI-Labs/physical-ai-bench GitHub. JSON data files: generation-leaderboard.json (19 video gen models incl Cosmos3-Super/Veo-3/Wan 2.2 family), understanding-leaderboard.json (25 VLMs incl Cosmos-Reason2/GPT-5 thinking/Qwen3-VL-235B), conditional_generation-leaderboard.json. Cosmos3-Super/Nano added ~2026-05-29.' },
            { name: 'PhysBench (arxiv 2501.16411, ICLR 2025)', url: 'https://physbench.github.io/', desc: 'USC + UC Berkeley + TRI. Benchmarking VLMs for Physical World Understanding. Test 10,002 entries × 19 subclasses (object properties / relationships / scene understanding / dynamics). DISTINCT from PAI-Bench (arxiv 2512.01989). Leaderboard JS-rendered — no data ingestable as of 2026-05-30.' },
            { name: 'AA CritPT', url: 'https://artificialanalysis.ai/evaluations/critpt', desc: 'AA-independent re-run of CritPT (71-challenge research-level physics). 33 of 404 models filtered. AA-reported: GPT-5.5 Pro xhigh 30.6 SOTA / GPT-5.4 Pro xhigh 30.0 / GPT-5.5 xhigh 27.1. Note: existing critpt scores in DB are vendor-reported and untouched.' },
            { name: 'AA MMLU-Pro (independent re-run)', url: 'https://artificialanalysis.ai/evaluations/mmlu-pro', desc: 'AA-independent re-run, distinct from vendor-reported mmlu_pro values. SOTA: Gemini 3 Pro Preview (high) 89.8 / Claude Opus 4.5 (Reasoning) 89.5. Registered as separate mmlu_pro_aa to avoid clobbering vendor self-reported values.' },
            { name: 'IPhO 2025 (llm-stats)', url: 'https://llm-stats.com/benchmarks/ipho-2025', desc: 'International Physics Olympiad 2025 — all 3 theory problems, blinded human grading. Sole frontier entry: Meta Muse Spark 82.6%. 2026-new physics olympiad bench on llm-stats.' },
            ...
            // ─── 2026-08-02 S224d — remaining arXiv benchmark-sweep links (registry completeness) ───
            { name: 'MSCoRe', url: 'https://arxiv.org/abs/2509.17628', desc: '[agent] multi-stage collaborative reasoning (old models). arXiv 2509.17628, S224 registered.' },
            { name: 'SysMoBench', url: 'https://arxiv.org/abs/2509.23130', desc: '[coding] formal system modeling. arXiv 2509.23130, S224 registered.' },
            { name: 'Toucan', url: 'https://arxiv.org/abs/2510.01179', desc: '[agent] 1.5M tool-agentic data (training set). arXiv 2510.01179, S224 registered.' },
            { name: 'SafeMT', url: 'https://arxiv.org/abs/2510.12133', desc: '[safety] multi-turn multimodal safety (old models). arXiv 2510.12133, S224 registered.' },
            { name: 'CrossMed', url: 'https://arxiv.org/abs/2511.11034', desc: '[medical] compositional generalization (old models). arXiv 2511.11034, S224 registered.' },
            { name: 'MMR-Bench', url: 'https://arxiv.org/abs/2601.17814', desc: '[multimodal] multimodal LLM routing (normalized). arXiv 2601.17814, S224 registered.' },
            { name: 'ChemPro', url: 'https://arxiv.org/abs/2602.03108', desc: '[science] progressive chemistry (o1/o3-mini top, no GPT-5). arXiv 2602.03108, S224 registered.' },
            { name: 'CASTLE', url: 'https://arxiv.org/abs/2602.05633', desc: '[safety] student-tailored personalized safety. arXiv 2602.05633, S224 registered.' },
            { name: 'LogicSkills', url: 'https://arxiv.org/abs/2602.06533', desc: '[reasoning] formal reasoning (Validity/Symbolization/Countermodel). o3 SOTA. arXiv 2602.06533, S224 registered.' },
            { name: 'SupChain-Bench', url: 'https://arxiv.org/abs/2602.07342', desc: '[agent] supply-chain mgmt tool-calling. GPT-5-mini 86.73. arXiv 2602.07342, S224 registered.' },
            { name: 'LiveNewsBench', url: 'https://arxiv.org/abs/2602.13543', desc: '[agent] LLM web-search on fresh news. DeepSeek V3.2 Thinking 84.5. arXiv 2602.13543, S224 registered.' },
            { name: 'LLMStructBench', url: 'https://arxiv.org/abs/2602.14743', desc: '[other] structured text extraction (old models only). arXiv 2602.14743, S224 registered.' },
            { name: 'BURMESE-SAN', url: 'https://arxiv.org/abs/2602.18788', desc: '[multilingual] Burmese NLP. Gemini 2.5 Pro 72.35. arXiv 2602.18788, S224 registered.' },
            { name: 'PanCanBench', url: 'https://arxiv.org/abs/2603.01343', desc: '[medical] pancreatic oncology. o3 82.3. arXiv 2603.01343, S224 registered.' },
            { name: 'LiveCultureBench', url: 'https://arxiv.org/abs/2603.01952', desc: '[agent] multi-cultural social sim. Gemini-2.5-Pro 0.76. arXiv 2603.01952, S224 registered.' },
            { name: 'ERI Benchmark', url: 'https://arxiv.org/abs/2603.02239', desc: '[reasoning] engineering reasoning+instruction. GPT-5 4.48. arXiv 2603.02239, S224 registered.' },
            { name: 'DBench-Bio', url: 'https://arxiv.org/abs/2603.03322', desc: '[science] biological knowledge discovery (figure-only). arXiv 2603.03322, S224 registered.' },
            { name: 'DeliberationBench', url: 'https://arxiv.org/abs/2603.10018', desc: '[safety] opinion-change (no leaderboard). arXiv 2603.10018, S224 registered.' },
            { name: 'GAIN', url: 'https://arxiv.org/abs/2603.18469', desc: '[safety] goal-aligned decision under imperfect norms (alignment). arXiv 2603.18469, S224 registered.' },
            { name: 'PoliticsBench', url: 'https://arxiv.org/abs/2603.23841', desc: '[safety] political-value roleplay (bias measure). arXiv 2603.23841, S224 registered.' },
            { name: 'AlpsBench', url: 'https://arxiv.org/abs/2603.26680', desc: '[agent] LLM personalization memory. DeepSeek-v3.2 0.6742. arXiv 2603.26680, S224 registered.' },
            { name: 'MonitorBench', url: 'https://arxiv.org/abs/2603.28590', desc: '[safety] chain-of-thought monitorability. GPT-OSS-120B 91.5. arXiv 2603.28590, S224 registered.' },
            { name: 'Olfactory Perception', url: 'https://arxiv.org/abs/2604.00002', desc: '[science] LLM olfactory perception. Claude-Opus-4.6 64.4. arXiv 2604.00002, S224 registered.' },
            { name: 'General365', url: 'https://arxiv.org/abs/2604.11778', desc: '[reasoning] general reasoning K-12. Gemini-3-Pro 62.8. arXiv 2604.11778, S224 registered.' },
            { name: 'LegalBench-BR', url: 'https://arxiv.org/abs/2604.18878', desc: '[multilingual] Brazilian legal (old models). arXiv 2604.18878, S224 registered.' },
            { name: 'MIRROR', url: 'https://arxiv.org/abs/2604.19809', desc: '[safety] metacognitive calibration. arXiv 2604.19809, S224 registered.' },
            { name: 'GaoYao', url: 'https://arxiv.org/abs/2604.20225', desc: '[multilingual] 26-lang multicultural (figure-only). arXiv 2604.20225, S224 registered.' },
            { name: 'Structured Output Benchmark', url: 'https://arxiv.org/abs/2604.25359', desc: '[other] structured output extraction. GPT-5.4 0.870. arXiv 2604.25359, S224 registered.' },
            { name: 'PrepBench', url: 'https://arxiv.org/abs/2605.08687', desc: '[tabular] NL-driven data preparation. GPT-5.1-Codex 54.9. arXiv 2605.08687, S224 registered.' },
            { name: 'AgentRx', url: 'https://arxiv.org/abs/2605.10286', desc: '[medical] (old models). arXiv 2605.10286, S224 registered.' },
            { name: 'WikiVQABench', url: 'https://arxiv.org/abs/2605.21479', desc: '[multimodal] Wikipedia knowledge VQA. InternVL3-78B 75.6. arXiv 2605.21479, S224 registered.' },
            { name: 'CyberMaskQA', url: 'https://arxiv.org/abs/2605.24765', desc: '[cyber] (old models). arXiv 2605.24765, S224 registered.' },
            { name: 'BeQu (Beyond Questions)', url: 'https://arxiv.org/abs/2605.26937', desc: '[other] what LLMs actually know. Claude Opus 4.6 0.473. arXiv 2605.26937, S224 registered.' },
            { name: 'AssertLLM2', url: 'https://arxiv.org/abs/2605.27472', desc: '[coding] assertion generation from specs. Claude-Sonnet-4.5 11.69. arXiv 2605.27472, S224 registered.' },
            { name: 'TravelEval', url: 'https://arxiv.org/abs/2606.01046', desc: '[agent] travel planning agents. Claude-4.5-Sonnet 0.3110. arXiv 2606.01046, S224 registered.' },
            { name: 'LongJudgeBench', url: 'https://arxiv.org/abs/2606.01629', desc: '[reasoning] long-form LLM-as-judge. Qwen3-Max 0.6721. arXiv 2606.01629, S224 registered.' },
            { name: 'DeployBench', url: 'https://arxiv.org/abs/2606.05238', desc: '[agent] research artifact deployment. GPT-5.3-Codex 51.0. arXiv 2606.05238, S224 registered.' },
            { name: 'MMBU', url: 'https://arxiv.org/abs/2606.06696', desc: '[medical] biomedical multimodal understanding. arXiv 2606.06696, S224 registered.' },
            { name: 'MedCTA', url: 'https://arxiv.org/abs/2606.11702', desc: '[medical] clinical tool agents. GPT-5.4 31.54. arXiv 2606.11702, S224 registered.' },
            { name: 'OpenMedReason-Bench', url: 'https://arxiv.org/abs/2606.12169', desc: '[medical] medical VLM reasoning trace. arXiv 2606.12169, S224 registered.' },
            { name: 'ToolMenuBench', url: 'https://arxiv.org/abs/2606.15508', desc: '[agent] tool-menu filtering. arXiv 2606.15508, S224 registered.' },
            { name: 'MedLayXplain', url: 'https://arxiv.org/abs/2606.21194', desc: '[medical] expert-lay medical language gap. arXiv 2606.21194, S224 registered.' },
            { name: 'MuPPET', url: 'https://arxiv.org/abs/2606.23217', desc: '[safety] multi-party privacy exposure. arXiv 2606.23217, S224 registered.' },
            { name: 'MKG-RAG-Bench', url: 'https://arxiv.org/abs/2606.26458', desc: '[multimodal] multimodal KG-augmented RAG (retriever families). arXiv 2606.26458, S224 registered.' },
            { name: 'CORTEX', url: 'https://arxiv.org/abs/2606.27264', desc: '[medical] 3D chest CT reasoning (figure-only). arXiv 2606.27264, S224 registered.' },
            { name: 'IMCBench', url: 'https://arxiv.org/abs/2606.28556', desc: '[medical] image-grounded multi-turn derm. Claude Opus 4.6 3.61. arXiv 2606.28556, S224 registered.' },
            { name: 'MultAttrEval', url: 'https://arxiv.org/abs/2607.01420', desc: '[multimodal] long-doc multimodal attribution (GPT-5.4 only). arXiv 2607.01420, S224 registered.' },
            { name: 'PACE-Bench', url: 'https://arxiv.org/abs/2607.02032', desc: '[agent] agentic capability proxy (framework). arXiv 2607.02032, S224 registered.' },
            { name: 'FGTR-Bench', url: 'https://arxiv.org/abs/2607.04149', desc: '[multimodal] fine-grained traffic reasoning (small VLMs). arXiv 2607.04149, S224 registered.' },
            { name: 'LanEvil++', url: 'https://arxiv.org/abs/2607.05783', desc: '[multimodal] lane-perception robustness (driving). arXiv 2607.05783, S224 registered.' },
            { name: 'Pluralis v0.1', url: 'https://arxiv.org/abs/2607.06196', desc: '[safety] multicultural AI risk (anonymized). arXiv 2607.06196, S224 registered.' },
            { name: 'MedRealMM', url: 'https://arxiv.org/abs/2607.09142', desc: '[medical] Chinese online medical consult. Claude Opus 4.7 50.66. arXiv 2607.09142, S224 registered.' },
            { name: 'AgentFootprint', url: 'https://arxiv.org/abs/2607.11149', desc: '[agent] agent storage footprint (frameworks). arXiv 2607.11149, S224 registered.' },
            { name: 'MCPEvol-Bench', url: 'https://arxiv.org/abs/2607.14642', desc: '[agent] dynamic MCP-server evolution. Opus 4.6 6.09. arXiv 2607.14642, S224 registered.' },
            { name: 'InCarEmo', url: 'https://arxiv.org/abs/2607.14683', desc: '[multimodal] in-cabin emotion recognition (specialized). arXiv 2607.14683, S224 registered.' },
            { name: 'Vector-Bench', url: 'https://arxiv.org/abs/2607.19056', desc: '[coding] surgical SVG-code editing. Claude Sonnet 5 15.0. arXiv 2607.19056, S224 registered.' },
            { name: 'SciCodePile', url: 'https://arxiv.org/abs/2607.19104', desc: '[coding] scientific code gen (128GB). GPT-5.4-mini 12.30. arXiv 2607.19104, S224 registered.' },
            { name: 'GATE-3D', url: 'https://arxiv.org/abs/2607.19111', desc: '[other] open-set 3D shape retrieval (vision). arXiv 2607.19111, S224 registered.' },
            { name: 'BioSecBench-Surveillance', url: 'https://arxiv.org/abs/2607.19262', desc: '[science] pathogen genomic surveillance. Opus-4.8 50.2. arXiv 2607.19262, S224 registered.' },
            { name: 'GuardianAgentBench', url: 'https://arxiv.org/abs/2607.20982', desc: '[agent] guardrail agents. Claude Opus 4.5 74.8. arXiv 2607.20982, S224 registered.' },
            { name: 'Open Security Benchmark', url: 'https://arxiv.org/abs/2607.27288', desc: '[cyber] enterprise cyber defense (framework). arXiv 2607.27288, S224 registered.' },
            { name: 'MPIE-Bench', url: 'https://arxiv.org/abs/2607.27616', desc: '[multimodal] multi-person interaction editing. Seedream-5-Pro 0.72. arXiv 2607.27616, S224 registered.' },
            { name: 'MMOOC', url: 'https://arxiv.org/abs/2607.27637', desc: '[multimodal] out-of-context MLLM eval. arXiv 2607.27637, S224 registered.' },
            { name: 'LoMeVQA', url: 'https://arxiv.org/abs/2607.27806', desc: '[medical] longitudinal medical VQA. arXiv 2607.27806, S224 registered.' },
            { name: 'PathView-Bench', url: 'https://arxiv.org/abs/2607.28318', desc: '[medical] multiscale pathology. arXiv 2607.28318, S224 registered.' },
            { name: 'Janus', url: 'https://arxiv.org/abs/2606.10852', desc: '[other] benchmark (recovered; not triaged in detail). arXiv 2606.10852, S224 registered.' },
            { name: 'APeB', url: 'https://arxiv.org/abs/2607.03162', desc: '[other] benchmark (recovered; not triaged in detail). arXiv 2607.03162, S224 registered.' },
            // ─── 2026-08-02 S224e — S172-S220 backlog: papers/benchmarks/leaderboards missing from Resources ───
            { name: 'SEAL Leaderboard', url: 'https://scale.com/leaderboard', desc: '[leaderboard].' },
            { name: 'LLM Stats Benchmarks', url: 'https://llm-stats.com/benchmarks', desc: '[leaderboard] 30+ benchmarks across 289 models, per-benchmark leaderboards.' },
            { name: 'LLM Stats Leaderboard', url: 'https://llm-stats.com/leaderboards/llm-leaderboard', desc: '[leaderboard] 289 models, 30+ benchmarks, sortable table with pricing and speed.' },
            { name: 'FailingFast AI Coding Benchmarks', url: 'https://failingfast.io/ai-coding-guide/benchmarks/', desc: '[leaderboard] Comprehensive coding benchmark comparison and analysis.' },
            { name: 'MedBullets Paper', url: 'https://arxiv.org/abs/2402.18060', desc: '[benchmark_paper] USMLE Step 2/3-style 5-option questions from MedBullets. Harder than 4-option MedQA. ~308 per split.' },
            { name: 'OmniMedVQA Paper', url: 'https://arxiv.org/abs/2402.09181', desc: '[benchmark_paper] 118K medical VQA questions from 73 datasets × 12 modalities × 20 anatomical areas. LVLM medical evaluation.' },
            { name: 'RetBench Paper', url: 'https://link.springer.com/chapter/10.1007/978-3-032-10351-2_8', desc: '[benchmark_paper] Ophthalmic foundation-model evaluation — disease detection (glaucoma/DR/AMD) + systemic prediction (diabetes/h.' },
            { name: 'RAD-ChestCT Paper', url: 'https://arxiv.org/abs/2002.06045', desc: '[benchmark_paper] Chest CT 3D classification — 35,747 volumes × 84 abnormalities. RadFM evaluation dataset.' },
            { name: 'Sapiens2 Paper (arxiv 2604.21681)', url: 'https://arxiv.org/abs/2604.21681', desc: '[paper_pdf] Khirodkar et al ICLR 2026 — Sapiens2: vision transformers for human-centric tasks. Tables 3-7 contain all repo.' },
            { name: 'SonarSource LLM Coding Leaderboard (interactive)', url: 'https://www.sonarsource.com/the-coding-personalities-of-leading-llms/leaderboard/', desc: '[leaderboard] JS-rendered leaderboard companion to PDF. Same data extracted from canonical PDF.' },
            { name: 'OSU Online-Mind2Web Leaderboard', url: 'https://huggingface.co/spaces/osunlp/Online_Mind2Web_Leaderboard', desc: '[leaderboard] OSU NLP Online-Mind2Web — 300 real-website tasks. Both human-eval and auto-eval (WebJudge) CSVs. Through 2026-.' },
            { name: 'EmbodiedBench', url: 'https://embodiedbench.github.io/', desc: '[leaderboard] EmbodiedBench EB-AlfWorld + EB-Habitat splits. JSON files at /website/data/eb_alfred_total_benchmark.json. Fro.' },
            { name: 'IAPP/Governance Exam Benchmark', url: 'https://arxiv.org/abs/2508.09036', desc: '[paper_pdf] Aug 2025 — privacy & governance certification exams (CIPP/US, CIPM, CIPT, AIGP). 10 frontier models incl GPT-5.' },
            { name: 'PrivacyBench (multi-turn RAG privacy)', url: 'https://arxiv.org/abs/2512.24848', desc: '[paper_pdf] Dec 2025 — Direct/Indirect leakage + over-secrecy + inappropriate-retrieval. 5 models: GPT-5-Nano, Llama-4-Mav.' },
            { name: 'AthenaBench Paper', url: 'https://arxiv.org/abs/2511.01144', desc: '[paper_pdf] Nov 2025 — 6 subtasks for cyber threat intelligence: CKT, ATE (MITRE ATT&CK extraction), RCM, TAA. GPT-5 / Gem.' },
            { name: 'DictaLM 3.0 Technical Report', url: 'https://www.dicta.org.il/publications/DictaLM_3_0___Techincal_Report.pdf', desc: '[paper_pdf] Full Hebrew sovereign LLM eval — 24B/12B/1.7B variants.' },
            { name: 'Falcon-OCR arxiv paper', url: 'http://arxiv.org/abs/2603.27365', desc: '[paper_pdf] Falcon-OCR 300M document understanding paper.' },
            { name: 'AutomationBench (Zapier)', url: 'https://arxiv.org/abs/2604.18934', desc: '[leaderboard] End-to-end business workflow across 47 apps, dozens of interdependent API calls + policy docs. Private held-ou.' },
            { name: 'PhysicianBench — agentic EHR workflow benchmark (Stanford)', url: 'https://arxiv.org/abs/2605.02240', desc: '[model_paper] 21-specialty agentic EHR benchmark, pass@1: GPT-5.5 46.3 / Opus 4.6 31.7 / GPT-5.4 27.7 / DeepSeek V4-Pro 18.7.' },
            { name: 'LifeSciBench Preprint (OpenAI + Tacit Labs, Jun 2026)', url: 'https://cdn.openai.com/pdf/b4299379-0a97-4ffa-8b9b-c3fbb299caa9/lifescibench_preprint.pdf', desc: '[benchmark_paper] 750 expert-authored life-sci tasks, 7 workflows × 7 domains, rubric-graded. NEW SOTA: GPT-Rosalind 0.576 / 36.' },
            { name: 'Qwen-RobotWorld paper (Jun 17 2026)', url: 'https://arxiv.org/abs/2606.17030', desc: '[model_paper] 20B MMDiT world model for robotics. EWMBench / DreamGen / WorldModelBench / PBench leadership.' },
            { name: 'CEO-Bench — 500-day startup simulation (Jun 2026)', url: 'https://arxiv.org/abs/2606.18543', desc: '[benchmark_paper] Only Claude Opus 4.8 and GPT-5.5 finish above $1M balance.' },
            { name: 'AI2 MolmoMotion + PointMotionBench (Jun 2026)', url: 'https://arxiv.org/abs/2606.18558', desc: '[model_paper] Language-instructed 3D point trajectories. PointMotionBench: 111 categories × 61 motion types human-verified.' },
            { name: 'AA TTS Arena (Jun 2026)', url: 'https://artificialanalysis.ai/text-to-speech', desc: '[leaderboard] Top: Fun-Realtime-TTS 1224, Gemini 3.1 Flash TTS 1222, Inworld Realtime TTS-2 1212, Cartesia Sonic 3.5 1203, x.' },
            { name: 'AA Transcribe leaderboard (Jun 2026)', url: 'https://artificialanalysis.ai/speech-to-text', desc: '[leaderboard] WER %: Fun-Realtime-ASR-preview 1.7, Scribe v2 2.2, MAI-Transcribe-1.5 2.4, MAI-Transcribe-1 2.6, Gemini 3.1 P.' },
            { name: 'AA Big Bench Audio', url: 'https://artificialanalysis.ai/benchmarks/big-bench-audio', desc: '[benchmark_dataset] 1000 audio reasoning questions adapted from BBH. Used as new AA audio composite metric.' },
            { name: 'FinTrace — 800-trajectory financial-agent eval (arxiv 2604.10015, Apr 2026)', url: 'https://arxiv.org/abs/2604.10015', desc: '[benchmark_paper] 34 financial categories, 4-axis rubric (Correctness/Tool-use/Trace/Plan).' },
            { name: 'FinMCP-Bench — financial MCP servers (arxiv 2603.24943, Mar 2026)', url: 'https://arxiv.org/abs/2603.24943', desc: '[benchmark_paper] 613 samples × 65 financial MCP servers. Multi-turn task completion collapses to 3.08% even on frontier models.' },
            { name: 'FinToolBench — 760 executable financial tools (arxiv 2603.08262, Mar 2026)', url: 'https://arxiv.org/abs/2603.08262', desc: '[benchmark_paper] Executable financial-tool calling eval.' },
            { name: 'Arc Institute Evo-2 40B genomics FM (Nature Mar 2026)', url: 'https://www.nature.com/articles/evo-2-arc-institute', desc: '[peer_reviewed] 40B parameters, genomics foundation model.' },
            { name: 'Hi3DEval (NeurIPS 2025)', url: 'https://arxiv.org/abs/2508.05609', desc: '[benchmark_paper] Object-level hierarchical 3D eval. Hunyuan3D-2.5 16.561 > Trellis 15.199.' },
            { name: 'HY3D-Bench (Tencent, Feb 2026)', url: 'https://arxiv.org/abs/2602.03907', desc: '[benchmark_paper] Uni3D-I + ULIP-I image-mesh consistency.' },
