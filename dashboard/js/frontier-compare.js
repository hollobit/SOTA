...
var FrontierCompare = {
    ...
    CORE_BENCHMARKS: {
        reasoning: [
            ...
            'mmlu_lang_japanese', 'mmlu_lang_korean', 'mmlu_lang_portuguese', 'mmlu_lang_spanish',
            'mmlu_lang_swahili', 'mmlu_lang_yoruba',
        ...
        coding: [
            ...
            'terminal_bench_2_0', 'swe_multilingual', 'nl2repo',
        ...
        cyber_defense: ['first_person_fairness', 'prompt_injection', 'harmbench', 'strongreject', 'airbench', 'r_judge', 'atbench',
            ...
            // 2026-09-04 S261b — remaining legacy-card safety tables (Standard/Challenging refusal, IH, prompt injection, deception, vision, image-gen, sycophancy)
            'abstentionbench', 'attack_planning_redteam_winrate', 'bbq_p_not_stereotyping', 'challenging_refusal_aggregate',
            'challenging_refusal_harassment_threatening', 'challenging_refusal_hate_threatening', 'challenging_refusal_illicit_nonviolent', 'challenging_refusal_illicit_violent',
            'challenging_refusal_self_harm_instructions', 'challenging_refusal_sexual_exploitative', 'challenging_refusal_sexual_minors', 'deception_browsing_broken_tools_lower_better',
            'deception_charxiv_missing_image_lower_better', 'deception_coding_lower_better', 'ih_conflict_dev_vs_user', 'ih_conflict_sys_vs_dev',
            'ih_conflict_sys_vs_user', 'ih_password_protection_dev', 'ih_password_protection_user', 'ih_phrase_protection_dev',
            'ih_phrase_protection_user', 'ih_sys_prompt_extraction_academic_dev', 'ih_sys_prompt_extraction_academic_user', 'ih_sys_prompt_extraction_realistic',
            'ih_tutor_jailbreak_dev', 'ih_tutor_jailbreak_system', 'image_gen_refusal_not_overrefuse', 'image_gen_refusal_not_unsafe',
            'person_id_adversarial', 'person_id_non_adversarial', 'prompt_injection_browsing', 'prompt_injection_coding',
            'prompt_injection_tool_calling', 'std_refusal_aggregate_not_overrefuse', 'std_refusal_extremist_propaganda', 'std_refusal_harassment_threatening',
            'std_refusal_hate', 'std_refusal_hate_aggregate', 'std_refusal_hate_threatening', 'std_refusal_illicit_nonviolent',
            'std_refusal_illicit_violent', 'std_refusal_personal_data', 'std_refusal_personal_data_extremely_sensitive', 'std_refusal_personal_data_highly_sensitive',
            'std_refusal_personal_data_restricted', 'std_refusal_personal_data_semi_restrictive', 'std_refusal_regulated_advice', 'std_refusal_self_harm_combined',
            'std_refusal_self_harm_instructions', 'std_refusal_self_harm_intent', 'std_refusal_sexual_exploitative', 'std_refusal_sexual_minors',
            'sycophancy_offline_lower_better', 'ungrounded_inference_adversarial', 'ungrounded_inference_non_adversarial', 'vision_refusal_self_harm_instructions',
            'vision_refusal_self_harm_intent', 'vision_refusal_sexual_exploitative',
    ...
    FRONTIER_MODELS: [
        ...
        'anthropic/claude-fable-5.1',  // 2026-09-01 S256 — Fable 5.1 (flagship, SWE-Pro 81.2, GDPval-AA Elo 1853, AAII 66, 1M ctx)
        'anthropic/claude-mythos-5.1',  // 2026-09-01 S256 — Mythos 5.1 (permissive safeguards; AECI 161.98, Firefox-147 98%, life-sciences SOTA)
        ...
        'xai/grok-4.20',
        'meta/muse-spark',
        'meta/muse-spark-1.3',   // 2026-09-02 S258 — agentic/coding, 1M ctx; AAII 61, Terminal-Bench 2.1 88.8, DeepSWE 75.4, GDPVal-AA 1754
        ...
        'alibaba/qwen3.8-2.4t-a95b',  // 2026-08-15 S245 — Qwen3.8-2.4T-A95B open-weight base (2.4T total / 95B active MoE); Timeline frontier
        'alibaba/qwen3.8-27b',  // 2026-08-15 S245 — Qwen3.8-27B dense/mid-size; Timeline frontier
        'alibaba/qwen3.7-max',
