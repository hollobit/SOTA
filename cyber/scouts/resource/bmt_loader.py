...
_KNOWN_MAPPINGS: Dict[str, List[str]] = {
    ...
    "livecodebench_v6": ["LiveCodeBench v6", "LiveCodeBench"],
    "healthbench": ["HealthBench"],
    "healthbench_hard": ["HealthBench Hard"],
    "healthbench_consensus": ["HealthBench Consensus"],
    "healthbench_professional": ["HealthBench Professional"],
    "toolathlon": ["Toolathlon"],
    "mcpmark": ["MCPMark", "MCP Mark"],
    "qwen_web_bench": ["QwenWebBench", "Qwen WebBench"],
    "nl2repo": ["NL2Repo"],
    "android_world": ["AndroidWorld", "Android World"],
    "vlms_are_blind": ["VLMs-Are-Blind", "VLMs Are Blind"],
    "realworldqa": ["RealWorldQA", "Real World QA"],
    "skills_bench": ["SkillsBench", "Skills Bench"],
    "aime_2026": ["AIME 2026", "AIME"],
    "hmmt_2026": ["HMMT 2026", "HMMT"],
    "cyscenariobench": ["CyScenarioBench"],
    "tlo_cyber_range": ["The Last Ones", "TLO", "UK AISI TLO"],
    "video_mme": ["Video-MME", "VideoMME"],
}
