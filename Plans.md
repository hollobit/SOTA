...
## Current Status: Session 99 — Korean + Japanese sovereign AI sweep (2026-06-11)
**2,118 models · 2,395 benchmarks · 11,303 scores · 🌍 +60 models / +45 benchmarks / +200 scores**

### 2026-06-11 Session 99 — Korean + Japanese sovereign AI sweep
- 3 agents 🌍 **+60/+45/+200**. **Korean flagships**: **SKT A.X K1** (519B/33B MoE, 2026-02) KMMLU **80.2** + LCB-Korean **73.1** (+6.9 vs DeepSeek) + HumanEval+ Korean 90.2 + AIME25-ko 89.8. **K-EXAONE 236B/23B MoE** HRM8K 90.9 + KoBALT 61.8 (huge gap, EXAONE 4.0 only 25.4). **EXAONE 4.5 33B dense** AIME-26 92.6 + LCB-v6 81.4 (Korean open-weight code SOTA). Solar Open 100B AIME24 91.7. HyperCLOVA-X SEED Think 32B AAII 44. **Japanese flagships (47 models, 11 vendors)**: **Stockmark-2-100B JMT-Bench 7.87** (highest open-weight JP). Stockmark-2-VL beats GPT-4o on BusinessSlideVQA 4.2/4.1 + JChartQA 0.88/0.77. **RakutenAI-3.0 671B/37B MoE** = **Japan's largest open MoE** (Mar 2026 GENIAC). LLM-JP-4-32B-A3B-Thinking JMT-Bench 7.82 at 3.8B active. **Cross-vendor surprise**: Chinese frontiers beat Korean sovereigns on some Korean benches — **DeepSeek-V3.2 CLIcK 86.3** + KoBALT 62.7 + Ko-LongBench 87.9; **GLM-4.6 KMO25 96.6** + KMMLU-Redux 78.2; Qwen3-235B-A22B-Thinking HRM8K 92.0

### 2026-06-11 Sessions 97-98 — Image+video gen + Medical AI (+45/+60/+104)
- S98 Medical: MedGemma 2/Med-PaLM 3/AMIE 2 NOT YET RELEASED (strict-attribution caught). **NEW SOTAs**: Fable 5 HealthBench Pro **0.660**, Opus 4.6 AutoMedBench 66.5, GPT-4.1+memory MedAgentBench v2 **98%**, AMIE Co-Clinician RxQA 95.0, Kimi K2-Thinking-0905 HealthBench 0.580, GPT-5 MedXpertQA-MM-U 74.37. Lingshu-7B SLAKE 83.1. MedSAM-3, PRISM2, OpenFold3, IsoDDE, Boltz-2 CASP16 #1
- S97 Image+Video: Reve 2.0 Arena T2I 1280 #2. MAI-Image-2.5 Edit 1401 #2. HiDream-O1-Image 8B (MIT) GenEval 0.90 beats Qwen-Image 27B + FLUX.2 56B 7x fewer. Wan 2.7 Video Pro AA Arena T2V **1762** (first open-weight Apache video frontier). Kling 3.0 4K@60fps. HunyuanVideo-1.5 VBench-2.0 83.4. Sora-2 retired

### 2026-06-11 Sessions 93-96 — Quant + Chinese + Robotics VLA (+129/+160/+517)
- S96 Robotics: π0.7 5B w/MEM, Helix 02 4-min dishwasher, GR00T N1.7 dexterity scaling 1k→20k, Gemini Robotics 1.5 70% OOD, **Spirit v1.6 RoboArena 1924 #1**, **LingBot-VA LIBERO 98.5%**, OpenVLA-OFT 109.7Hz. S95 Chinese: DeepSeek V4 1.6T HMMT 95.2/LCB 93.5/CF 3206. GLM-5.1 754B Huawei Ascend **SWE-Pro 58.4 first non-NVIDIA**. Kimi K2.6 1T DeepSearchQA F1 92.5. S93-94 Quant: Qwen 3.6 24 quant (35B-A3B-FP8 QwenWebBench ELO 1397, UD-Q6_K_XL HumanEval+ 90.24). Gemma 4 11 QAT (31B Q4_0 17.7GB MMLU-Pro 85.2+CF ELO 2150). RedHatAI FP8-block 100.1%. HW: Pixel 17/RTX 4090 43/M4 Max 62/H100 1260 tok/s
