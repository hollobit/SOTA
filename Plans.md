...
## Current Status: Session 97 — Image + video generation frontier (2026-06-11)
**2,028 models · 2,327 benchmarks · 11,064 scores · 🌍 +15 models / +37 benchmarks / +65 scores**

### 2026-06-11 Session 97 — Image + video generation frontier
- 3 agents 🌍 **+15/+37/+65**. **Image**: **Reve 2.0** (2026-06-03, 4K native) Arena T2I Elo **1280 #2**. **MAI-Image-2.5** Arena Image-Edit Elo **1401 #2** (+ Flash variant). **HiDream-O1-Image** (8B MIT) GenEval 0.90 / DPG 89.83 / HPSv3 10.37 — **beats Qwen-Image 27B + FLUX.2 56B at 7x fewer params**. HiDream-O1-Image-200B paper-only GenEval 0.92 / ImgEdit 4.51 (new image-gen SOTA). **Recraft v4.1 Utility Pro** AA Arena Elo 1243 (#9, highest non-Big-Tech). **Seedream 5.0 Lite** unified deep-thinking + online-search baked in. Wan 2.7 Image (Apache-2.0 27B/14B MoE, hosted-only Pro 4K reasoning mode). **Video**: **Wan 2.7 Video Pro** AA Arena T2V Elo **1762** (displaces HappyHorse-1.0 1446; first open-weight Apache video MoE at frontier $0.10/sec). **Kling 3.0** first native 4K@60fps. **HunyuanVideo-1.5** VBench-2.0 83.4 at 8.3B (vs Sora-2 85.4). LTX-2.3 22B 4K@50fps. Substitutes: Luma→Ray-3.14, Hailuo→2.3, no Pika 3.0

### 2026-06-11 Sessions 95-96 — Chinese flagship + Robotics VLA frontier (+45/+93/+178)
- S96 Robotics (+42/+63/+106): π0.7 (5B w/MEM). Figure Helix 02 (S0 1000Hz + 4-min dishwasher). NVIDIA GR00T N1.7 (first dexterity scaling law 1k→20k hrs doubles). Gemini Robotics 1.5 70% OOD vs 0% + ER 1.6 instrument reading 98%. **Spirit v1.6 RoboArena Elo 1924 #1 (first non-NVIDIA)**. **LingBot-VA LIBERO 98.5% NEW SOTA**. OpenVLA-OFT 26x throughput 109.7Hz
- S95 Chinese (+3/+30/+72): DeepSeek V4 (1.6T/49B Pro, 10% KV cache): HMMT-Feb 95.2/LCB-v6 93.5/CF 3206/IMO 89.8/SWE-V 80.6. GLM-5.1 (Z.ai 754B/40B Huawei Ascend): **SWE-Pro 58.4 first non-NVIDIA-silicon SOTA**, CyberGym 68.7, AAII 51. Kimi K2.6 (1T/32B MoE, MoonViT 400M): DeepSearchQA F1 92.5, BrowseComp Agent-Swarm 86.3, WideSearch 80.8, AAII 54

### 2026-06-11 Sessions 93-94 — Qwen 3.6 + Gemma 4 quantized (+84/+67/+339)
- S93-94: Qwen 3.6 24 quant variants (27B+35B-A3B; FP8/AWQ/NVFP4/GGUF/MLX/OpenVINO; 459 HF derivs); 35B-A3B-FP8 1397 QwenWebBench ELO, UD-Q6_K_XL HumanEval+ 90.24. Gemma 4 11 official QAT (E2B 3.35GB→31B 17.7GB Pareto); 31B QAT Q4_0 MMLU-Pro 85.2+CF ELO 2150+AIME-26 89.2. RedHatAI FP8-block 100.1%/NVFP4 99.5% recovery. Unsloth Dynamic E2B KLD 0.00173 vs naive 0.05109 (29x). HW: Pixel 17/Snapdragon 16/RTX 4090 43/M4 Max 62/RTX 5090 178/H100 1260 tok/s
