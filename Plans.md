...
## Current Status: Session 129 — GLM-5.2 BridgeBench Playwright retry (2026-06-16)
**3,097 models · 3,247 benchmarks · 15,245 scores · 🌍 +3 models / +13 benches / +148 scores**
...
### 2026-06-16 Session 128 — 11-URL Kimi K2.7 Code + GLM-5.2 (+1/+6/+6)
- **kimi-k2.7-code architecture**: 1T/32B-active MoE + MLA + MoonViT 400M vision encoder + 262K ctx + text+image+video. Kimi API $0.19/$0.95 in (cache hit/miss) + $4.00 out per 1M. OpenRouter $0.75/$3.50. Modified MIT. **K2.7 Code per-bench (Moonshot self-report)**: Kimi Code Bench v2 62.0 / Program Bench 53.6 / MLS Bench Lite 35.1 / Kimi Claw 24/7 46.9 / MCP Atlas 76.0 / MCP Mark Verified 81.1. K2.7 Code positions between Opus 4.8 and GPT-5.5 on all 6 benches — Moonshot pitches price/performance + open-weight leader, not capability SOTA. 8/11 URLs blocked WebFetch — GLM-5.2 deferred to S129 Playwright
