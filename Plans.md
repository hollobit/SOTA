...
## Current Status: Session 98 — Medical AI 2026 deep refresh (2026-06-11)
**2,058 models · 2,350 benchmarks · 11,103 scores · 🌍 +30 models / +23 benchmarks / +39 scores**

### 2026-06-11 Session 98 — Medical AI 2026 deep refresh
- 3 agents 🌍 **+30/+23/+39**. **MedGemma 2 / Med-PaLM 3 / AMIE 2 not yet released** (strict-attribution caught vendor-claim attempts). **MedGemma 1 baselines confirmed**: 27B-text MedQA 89.8 (beats Med-PaLM 2 86.5) + MMLU-Med 87.0; 4B MIMIC-CXR macro-F1 **88.9** SOTA. **AMIE Co-Clinician** (2026-04-30 rebranded): RxQA open-ended **95.0%** (beats GPT-5.4 90.9); HealthBench Pro launched 2026-04-22. **NEW SOTAs**: **Claude Fable 5 HealthBench Pro 0.660** (Opus 4.8 0.558, GPT-5.5 Instant 0.384). **Opus 4.6 AutoMedBench 66.5** (GLM-5 61.6, GPT-5.4 55.3). **GPT-4.1+memory MedAgentBench v2 98%** (vs no-memory 91% / Sonnet 3.5 69.67). **Kimi K2-Thinking-0905 HealthBench 0.580**. **GPT-5 MedXpertQA-MM-U 74.37**, Text-Reason 56.96. Qwen3-14B-RubricHub HealthBench 69.3 (beats o3 60). **Specialty (32 models)**: MedSAM-3 (10 mod, 1.57M pairs), PRISM2 (2.3M WSI, beats all slide-FMs), HuatuoGPT-3-32B, Lingshu-7B open <10B SOTA on 5/7 med VQA (SLAKE 83.1, OmniMedVQA 82.9), OpenFold3 open AF3 alt, IsoDDE Isomorphic AF4-scale drug engine, Boltz-2 CASP16 affinity #1/140

### 2026-06-11 Session 97 — Image + video generation frontier (+15/+37/+65)
- Image: Reve 2.0 Arena T2I 1280 #2. MAI-Image-2.5 Edit 1401 #2. HiDream-O1-Image 8B (MIT) GenEval 0.90/DPG 89.83/HPSv3 10.37 beats Qwen-Image 27B + FLUX.2 56B 7x fewer. HiDream-O1-Image-200B GenEval 0.92 (paper). Recraft v4.1 Utility Pro 1243 #9 highest non-Big-Tech. Seedream 5.0 Lite unified deep-thinking. Video: Wan 2.7 Video Pro AA Arena T2V **1762** displaces HappyHorse-1.0 (first open-weight Apache video MoE frontier). Kling 3.0 native 4K@60fps. HunyuanVideo-1.5 VBench-2.0 83.4 at 8.3B. Sora-2 retired 2026-03-24

### 2026-06-11 Sessions 93-96 — Quant + Chinese flagship + Robotics VLA (+129/+160/+517)
- S96 Robotics: π0.7 (5B w/MEM), Helix 02 (S0 1000Hz/4-min dishwasher), GR00T N1.7 (1k→20k hrs scaling law), Gemini Robotics 1.5 70% OOD, **Spirit v1.6 RoboArena 1924 #1**, **LingBot-VA LIBERO 98.5%**, OpenVLA-OFT 109.7Hz. S95 Chinese: DeepSeek V4 1.6T/49B HMMT 95.2/LCB 93.5/CF 3206. GLM-5.1 754B Huawei Ascend **SWE-Pro 58.4 first non-NVIDIA**. Kimi K2.6 1T/32B DeepSearchQA F1 92.5/BrowseComp Agent-Swarm 86.3
- S93-94 Quant: Qwen 3.6 24 quant variants (27B+35B-A3B; 459 HF derivs); 35B-A3B-FP8 1397 QwenWebBench ELO, UD-Q6_K_XL HumanEval+ 90.24. Gemma 4 11 QAT (E2B 3.35GB→31B 17.7GB); 31B Q4_0 MMLU-Pro 85.2+CF ELO 2150. RedHatAI FP8-block 100.1%/NVFP4 99.5% recovery. Unsloth Dyn E2B KLD 0.00173 vs naive 0.05109. HW: Pixel 17/RTX 4090 43/M4 Max 62/RTX 5090 178/H100 1260 tok/s
