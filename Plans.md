...
## Current Status: Session 106 — AI4S deep dive (2026-06-13)
**2,383 models · 2,630 benchmarks · 11,809 scores · 🌍 +51 models / +39 benchmarks / +88 scores**

### 2026-06-13 Session 106 — AI4S deep dive (Protein + Materials + AI4S benchmarks)
- 3 agents 🌍 **+51/+39/+88**. **Protein/Structural Bio (13)**: **IsoDDE (Isomorphic Feb 2026) 50% Runs-N-Poses hardest bin vs AF3 23.3%**, exceeds FEP+ gold std. **RFdiffusion3 (Baker/IPD Dec 2025) 41/41 enzyme design sites** vs RFdiff2 16/41, 10x faster. **Chai-2 ~20% zero-shot antibody hit rate** (100x prior <0.1%). **BioEmu (MSR Aug 2025) <1 kcal/mol free-energy error 100kx faster than MD**. Boltz-2 CASP16 affinity #1/140. LigandMPNN nucleotide 50.5/metal 77.5%. **Materials Science (27)**: **EquiformerV3+DeNS-OAM MatBench Discovery #1 F1 0.931 + MAE 0.018 eV/atom**. PET-OAM-XL F1 0.924. TACE-OAM-L 0.910. **UMA-S 1.2 (FAIR) 50% faster + 40% more accurate**. **OrbMol-v2 GSCDB138 6.05→1.62 (3.7x)**. MatterGen v1.0.3 Stability 74.4%. **AI4S Benchmarks (14 models, 16 benches)**: **GPT-5 USNCO Chem Olympiad 93.2% + MatSciBench multimodal 53.02**. DeepSeek-R1 MatSciBench text 75.22. **Biomni Lab BixBench 52.2** (vs Opus 4.6 39.5). **Gemini 3 Flash AstroBench 90.3 + ChemCensor 1.82** (NEW ICML 2026). **PhysicsMinions IPhO-2025 Pass@32 26.8/30 first open IPhO gold**. **Cosmos-Reason 2-8B PAI-Bench AV-VQA 80.18**. **Grok-4.1 Thinking VCT 61.0** (up from o3 43.8). **GPT-5.4 GPQA-D 97%**. Darwin Godel Machine self-improving raised SWE 20→50%

### 2026-06-13 Session 105 — Kimi K2.7-Code (+1/+5/+21)
- K2.7-Code = K2.6 architecture (1T/32B MoE, 256K ctx, MoonViT 400M, Modified MIT, $0.95/$4.00). Thinking forced=True -30% token usage. **Does NOT take SOTA on any of 6 reported benches** — GPT-5.5 sweeps 4/6, Opus 4.8 1, Gemini 3.5 Flash MCP-Atlas. Cost-efficient #3 ~3.2x cheaper than Opus 4.8 output. 2 NEW Moonshot benches: kimi-code-bench-v2 + kimi-claw-24/7. K2.6→K2.7 deltas all positive (+4-11pp)
