...
## Current Status: Session 116 — Medical AI frontier refresh (2026-06-14)
**2,678 models · 2,937 benchmarks · 13,451 scores · 🌍 +16 models / +12 benchmarks / +106 scores**

### 2026-06-14 Session 116 — Medical AI frontier refresh (LLM/VLM + benches + imaging foundation)
- 3 agents 🌍 **+16/+12/+106**. **Medical LLM/VLM**: **Gemini 3.1 Pro MedQA-USMLE 97.4 SOTA** (Nature Medicine 2026-06-12). **MedGemma 27B** MedQA 87.7/MedMCQA 74.2/PubMedQA 76.8/MMLU-Med 85.3 (arxiv 2507.05201). MedGemma 1.5 4B-multimodal (Jan 2026) adds 3D CT/MRI + EHRQA 89.6 (MedGemma 1 was 68). **AMIE Co-Clinician** RxQA MCQ 73.3 + open-ended 95.0 (beats GPT-5.4 72.7/90.9). **ChatGPT for Clinicians** (GPT-5.4 medical-tuned, May 2026) HealthBench Pro length-adjusted 59.0. **Hippocratic Polaris 5** (Apr 2026, skipped Polaris 4). MedReason 8B (UCSC-VLAA Apr 2025; attribution corrected from MILA). MedSigLIP-448 (Jul 2025). **Medical benches**: **Claude Fable 5 HealthBench Pro 0.660 SOTA**. Mythos 5 Preview 0.647. **Muse Spark MedXpertQA 0.784 + HealthBench Hard 0.428** (new Meta med model). Qwen3.5-122B-A10B MedXpertQA 0.673. GPT-5.5 Instant HealthBench Consensus 0.947 (only board entry). Kimi K2-Thinking-0905 HealthBench 0.580. **Imaging foundation (3 NEW models)**: **Prov-GigaPath SOTA 25/26 pathology tasks** (Nature 2024). **VISTA-3D Dice 0.91** across 127 anatomical classes (NVIDIA NIM). **MAIRA-2 RadFact Grounding Recall 90% / Logical Precision 55.6%**. **VisionFM AUROC 0.974 DR** (npj Digital Med 2025). RETFound AUROC 0.943 APTOS-2019. MedImageInsight 93.8% mAUC CXR (beats Rad-DINO 91.1, BiomedCLIP 83.0). HuatuoGPT-Vision 34B: VQA-RAD 68.1/SLAKE 76.9/PathVQA 63.5/PMC-VQA 58.2. CheXagent 8B (Stanford AIMI) + CT-CLIP. **Strict-attribution NOT EXIST**: MedGemma 2 (1.5 latest), Med-PaLM 3, AMIE-2 label (Co-Clinician 2026 is the rebrand), GPT-5-Med/5.5-Med (no SKU; HealthBench used on base), HuatuoGPT-O2/III (Apollo2 only), MMedLM-3 (MMed-Llama-3.1-70B latest), Apollo MedLM 2.0 (Apollo2), Polaris 4 (skipped), MedDr v2 (HKUST pivoted), LLaVA-Med 2.0, MedPrompt 2 (prompting framework not model), Pi-Med, Aleph/Med, MAIRA-3, CONCH v1.5, PathChat-2, UNI-2, Virchow2G, MedImageInsight v2, BiomedGPT v2, Mira/Mira-1 Mayo, PathFM Tencent, CT-CHAT, RadGPT. **NEW benches (11)**: EHRQA (MedGemma 1.5), HealthBench Pro length-adjusted (arxiv 2604.27470), RCQ Real Clinical Queries, RadFact 2-split (Grounding Recall + Logical Precision), CheXbench perception, APTOS-2019/IDRiD/MESSIDOR-2 DR, CXR tube/pathology mAUC, Abdominal CT Dice, PathoBench

### 2026-06-14 Sessions 114-115 — Image/Video Gen + Robotics/VLA/Humanoid (+56/+27/+190)
- S115 Robotics: Xiaomi-Robotics-0 4.7B (Feb 2026) LIBERO avg 98.7 SOTA (beats LingBot-VA 98.5) + SimplerEnv VM 85.5/VA 74.7/WidowX 79.2. FutureVLA-GT (Mar 2026) LIBERO Object 99.8 SOTA. xVLA-base 0.9B (ICLR 2026) LIBERO 93% with 1% trainable params. Flower-VLA 1B (CoRL 25) CALVIN ABC chain length 4.53 SOTA. SmolVLA 450M LIBERO avg 87.3. GR00T N2 GTC 2026 preview (ships end-2026, no public scores). 1xWM 14B. Humanoid hw: Atlas Electric 56 DoF SOTA/50 kg payload/90 kg mass. Unitree H1 3.3 m/s walk SOTA + 30 kg payload + 19 DoF. Unitree G1 $16K cheapest + 23 DoF. 1X NEO 25 kg + 22-DoF hands + $20K. Apollo 25 kg + 4h. Figure 02/03 5h + 20 kg. Tesla Optimus Gen 2 only 57 kg + 11 DoF/hand 1st-party (widely-cited Optimus 8 km/h rejected). NOT EXIST: π1, Gemini Robotics 2.0/2.5, Helix 03, Spirit v2, GR00T N3, Cosmos 4, Optimus Gen 3, Sanctuary Phoenix VLA, HumanPlus VLA. S114 Gen-AI: **GPT-Image-2 AA T2I 1339 SOTA**. **Dreamina Seedance 2.0 720p AA T2V+audio 1216 / I2V+audio 1194 SOTA** (ByteDance). **gemini-omni-flash arena.ai T2V 1527 + I2V 1475 debuts #1** (Google flagship). GPT-Image-1.5 AA Edit 1263. **FLUX.2-dev 32B LM Arena 1149** open-weights leader (BFL FLUX-NC Nov 2025). FLUX.2-klein-4B Apache 2.0 May 2026 (first BFL Apache 4B sub-sec). Wan 2.2 T2V-A14B first open MoE video. HiDream-I1 17B GenEval 0.83. Sana 1.5 4.8B GenEval 0.96 w/VILA judge. NEW: Kling 3.0 (4K/60fps Feb 2026), Ideogram 4.0 9.3B open, MJ V8.1, MAI-Image 2.5, Reve 2.0, Veo 3.1-Lite, Grok-Imagine 1.5, SkyReels v4, HappyHorse 1.0. NOT EXIST: GPT-Image-3, Sora 3 (Sora discontinuing 2026-09-24), Imagen 5, Veo 4 (teased), Runway Gen-5, Ray 4, MJ V9, Reve 2.5, SD 4, HiDream-O2/O3, Wan 2.5-3.0 (API-only)
