...
## Current Status: Session 119 — Edge LLM / SLM frontier refresh (2026-06-15)
**2,875 models · 3,064 benchmarks · 14,531 scores · 🌍 +40 models / +41 benchmarks / +545 scores**

### 2026-06-15 Session 119 — Edge LLM / SLM frontier refresh (sub-3B + 3-12B + leaderboards)
- 3 agents 🌍 **+40/+41/+545** (biggest score haul in batch). **Sub-3B SOTAs**: **Phi-4-mini-instruct (3.8B)** GSM8K 88.6 / MATH 64.0 / BBH 70.4 / ARC-C 83.7 / MMLU-Pro 52.8 (multi-bench leader). **Phi-4-mini-reasoning** MATH-500 94.6 / AIME-2024 57.5 (specialty SOTA). **Granite 4.0 H-Tiny (7B/1B-active MoE)** MMLU 68.65 / HumanEval 83 / IFEval 81.44. **BitNet b1.58 2B4T** MMLU 53.2 (Microsoft 1.58-bit native, no FP16 weights). **SmolLM3-3B BFCL v3 92.3 — sub-3B tool-use SOTA OUTRANKS ALL FRONTIER MODELS** (vs GLM-4.5 77.8, Sonnet 4.6 76.0). Gemma 3 270M + 1B-IT, Qwen2.5 0.5B/1.5B + Qwen3 0.6B/1.7B, MobileLLM-Pro 1.08B + R1-950M (Meta mobile R&D), OLMo 2 1B Instruct, MiniCPM3-4B, Falcon3 1B/3B. **3-12B SOTAs**: **Nemotron Nano 9B v2 (hybrid Mamba)** MATH-500 97.8 / AIME-2025 72.1 / LCB 71.1 / GPQA 64.0 — new sub-10B math/reasoning SOTA. **IBM Granite 4.1 8B Instruct** MMLU 73.84 / HumanEval 87.20 / MBPP 82.54 / GSM8K 92.49 / IFEval 87.06 (enterprise dense leader). DeepSeek-R1-Distill-Qwen-7B MATH-500 92.8 + AIME24 55.5. Light-R1-7B-DS AIME24 59.1 / AIME25 44.3. Phi-4-mini-flash-reasoning MATH-500 92.45 + AIME24 52.29. Salesforce xLAM-2-8B-fc-r BFCL v3 72.04 tool-use. **Gemma 4 family** (E2B/E4B/12B/26B-A4B/31B): AIME 2026 → 31B=89.2, 26B-A4B=88.3, 12B=77.5. **Qwen3.6-27B sub-30B coding crown** AIME 2026 94.1 + SWE-V 77.2. CodeGemma 7B, OLMo 2 7B/13B, OLMoE 1B-7B, Marin 8B (Stanford), Ministral-8B-2410, Falcon3-7B/10B. **AA Intelligence Index v4.0 sub-12B**: Gemma 4 26B-A4B AAII 31 / Gemma 4 12B 29 / Qwen3.5-4B (reasoning) 27. Tiny tier: Gemma 4 E4B 19 / E2B 15 / Llama 3.2 3B 10 / 1B 6. **Strict-attribution NOT EXIST**: Phi-5 family (Phi-4 latest), Gemma 4 270M/1B/2B (Gemma 3 latest), Llama 3.3/3.5 sub-3B + 8B, Qwen 3.5/3.6/3.7 sub-3B dense, DeepSeek-R2-Distill, Qwen3-Reasoner-4B/7B, OpenReasoner-7B, EuroLLM-9B-Edge, GLM-Edge 4B/9B, Granite 4.0 8B/11B (4.1 supersedes), Nemotron 3 Nano 8B at sub-12B (V2 is 30B-A6B), Aya-23-8B (Aya Expanse), Mistral Edge/Tiny 3, StableLM 3/4, TinyLlama 2.0, Kimi K0.5/K0.6, Samsung Gauss benchmarks, Apple AFM 3B (PDF not extractable)

### 2026-06-14 Session 118 — OCR / Document Understanding frontier
- 3 agents 🌍 **+85/+49/+321**. **OmniDocBench v1.6 SOTA**: **PaddleOCR-VL 1.6 0.9B = 96.33** (Baidu May 2026). **MinerU 2.5-Pro 95.75** (OpenDataLab). **PaddleOCR-VL 1.5 94.50** / **GLM-OCR 0.9B 94.62** (Zhipu open SOTA, +4.3pt over Gemini 3 Pro 90.33). **Qianfan-OCR 93.12** (Baidu). dots.ocr 1.7B 90.77. MonkeyOCR-pro-3B 88.57. Mistral OCR 78.83. **olmOCR-Bench SOTA**: **Unsiloed Parser 88.0** / **Chandra OCR 2 (Datalab) 85.9** (Datalab pivoted Marker→Chandra) / Surya OCR 2 83.3 / LightOnOCR-2-1B 83.2 (1B beats 9B Chandra) / olmOCR-2-7B 82.4 / dots.mocr 83.9. **General VLM doc SOTAs**: **Qwen3-VL-235B-Instruct DocVQA-test 0.971**. Qwen3-VL-32B-Instruct 0.969. **Kimi K2.5 InfoVQA-test 0.926**. **Claude 3.5 Sonnet ChartQA 0.908** / AI2D 0.947. **Qwen3.6-Plus CC-OCR 0.834 + MMLongBench-Doc 0.620** (Qwen3-VL-235B-Thinking 0.562 prior). NVIDIA Nemotron 3 Nano Omni MMLongBench 57.5. InternVL3.5 1B/2B/4B/14B/30B-A3B full DocVQA/ChartQA/InfoVQA/TextVQA/AI2D coverage. **Mistral OCR 3 (2512)** added. **DeepSeek-OCR** Fox-Bench compression. **NEW benches**: OmniDocBench v1.6/v1.7/EN/ZH/Real5 splits, olmOCR-Bench overall + 5 category (ArXiv/Tables/Math/Multi-Column/Old Scans), Fox-Bench (compression precision), XDocParse (126-lang), Datalab 90-lang, dots.ocr-bench (1493 imgs/100 langs), CC-OCR, MMLongBench-Doc, AI2D, HallusionBench, Nougat arXiv edit-distance/F1, DocStructBench. **Strict-attribution NOT EXIST (24)**: Tesseract V6 (v5 latest), LayoutLMv4 (no MS release), DiT-2 (only v1), Donut V2/V3 (no NAVER follow-up), TableTransformer v3, Nougat 2 (no Meta follow-up), **Marker 2 (Datalab shipped Chandra OCR 2 instead)**, FormFM, FormNet v4, DocBank-V3, TabPFN-Tables, TabRec, TabFusion, PaLI-X-Doc, PP-DocLayout v3, PP-StructureV4, Florence-3 DocAI variant, CogAgent-2, TextHawk2, Pix2Text v2, MathScribe, olmOCR-Mini

### 2026-06-14 Sessions 114-117 (compressed) — Gen-AI + Robotics/VLA + Medical + Audio/Speech (+144/+76/+510)
- S117 Audio: **Fun-Realtime-ASR-preview AA-WER v2 1.7 SOTA** + **Fun-Realtime-TTS AA Quality Elo 1226.47** (Alibaba sweeps both). Cohere Transcribe 03-2026 Open ASR Short-form 5.42 SOTA. ElevenLabs Scribe v2 sweeps 3 Open ASR boards (Multilingual 2.67/Long-form 7.32/AgentTalk 1.6). **Qwen3.5-Omni-Plus VoiceBench 93.1 SOTA**. NVIDIA Nemotron 3 Nano Omni 30B-A3B VoiceBench 89.39 open SOTA. Step-Audio-R1 BBA 98.7 + R1.5 32B avg 77.97 + 2.5 Realtime Paralinguistic 82.18. GPT-Realtime-2 BBA 96.6 + Audio MultiChallenge 48.5. NVIDIA PersonaPlex Jan 2026 MOS 3.90. Hibiki-Zero ASR-BLEU 34.6 @ 2.8s. Data-hygiene flag: openai/realtime-tts-2 misattributed (actual Inworld). NOT EXIST: Whisper V3.5/V4, Parakeet TDT v4, Cohere Transcribe v2, Scribe v3, Acoustica (=PersonaPlex), Gemini Live 2, Kimi K2-Voice/Audio-2, EVI 2, AudioPaLM, MAI-Voice-2, Suno V5, Seed-TTS-2. S116 Medical: **Gemini 3.1 Pro MedQA-USMLE 97.4 SOTA** (Nature Med 2026-06-12). MedGemma 27B MedQA 87.7. MedGemma 1.5 4B-multimodal EHRQA 89.6. **Claude Fable 5 HealthBench Pro 0.660 SOTA**. Muse Spark MedXpertQA 0.784 (Meta). AMIE Co-Clinician RxQA MCQ 73.3. Polaris 5 (skipped 4). Imaging: Prov-GigaPath 25/26 path tasks, VISTA-3D Dice 0.91, MAIRA-2 RadFact 90%, VisionFM AUROC 0.974 DR. NOT EXIST: MedGemma 2, Med-PaLM 3, HuatuoGPT-O2, Polaris 4, MAIRA-3, UNI-2, Virchow2G. S115 Robotics: Xiaomi-Robotics-0 4.7B LIBERO avg 98.7 SOTA. FutureVLA-GT LIBERO Object 99.8. xVLA-base 0.9B LIBERO 93% with 1% trainable. Flower-VLA CALVIN ABC 4.53. GR00T N2 preview. Humanoid hw: Atlas Electric 56 DoF SOTA/50 kg/90 kg. Unitree H1 3.3 m/s walk SOTA. Unitree G1 $16K cheapest. Optimus widely-cited rejected. NOT EXIST: π1, Gemini Robotics 2.0, Helix 03, Spirit v2, GR00T N3, Cosmos 4, Optimus Gen 3. S114 Gen-AI: **GPT-Image-2 AA T2I 1339 SOTA**. **Dreamina Seedance 2.0 720p AA T2V/I2V SOTA**. **gemini-omni-flash arena.ai T2V 1527/I2V 1475 #1**. **FLUX.2-dev 32B open-weights leader 1149**. FLUX.2-klein-4B Apache May 2026. Wan 2.2 first open MoE video. Kling 3.0/Ideogram 4.0/MJ V8.1/MAI-Image 2.5/Reve 2.0 new. NOT EXIST: GPT-Image-3, Sora 3, Imagen 5, Veo 4, SD 4, HiDream-O2/O3, Wan 2.5-3.0 (API)
- S116 Medical: **Gemini 3.1 Pro MedQA-USMLE 97.4 SOTA** (Nature Med 2026-06-12). MedGemma 27B MedQA 87.7. MedGemma 1.5 4B-multimodal (Jan 2026, 3D CT/MRI + EHRQA 89.6). **Claude Fable 5 HealthBench Pro 0.660 SOTA**. Mythos 5 Preview HB Pro 0.647. **Muse Spark MedXpertQA 0.784 + HB Hard 0.428** (Meta). GPT-5.4 ChatGPT-for-Clinicians HB Pro LA 59.0. GPT-5.5 Instant HB Consensus 0.947. Kimi K2-Thinking-0905 HB 0.580. AMIE Co-Clinician RxQA MCQ 73.3/open 95.0 (beats GPT-5.4). Polaris 5 (Apr 2026, skipped 4). Imaging: **Prov-GigaPath SOTA 25/26 path tasks**, **VISTA-3D Dice 0.91**, **MAIRA-2 RadFact 90%**, VisionFM AUROC 0.974 DR, MedImageInsight 93.8 CXR. Strict NOT EXIST: MedGemma 2, Med-PaLM 3, GPT-5-Med (no SKU), HuatuoGPT-O2/III, MMedLM-3, Polaris 4, MAIRA-3, CONCH v1.5, UNI-2, Virchow2G. S115 Robotics: Xiaomi-Robotics-0 4.7B LIBERO avg 98.7 SOTA. FutureVLA-GT LIBERO Object 99.8. xVLA-base 0.9B LIBERO 93% with 1% trainable. Flower-VLA CALVIN ABC 4.53. SmolVLA 450M LIBERO 87.3. GR00T N2 preview. Humanoid hw: Atlas Electric 56 DoF SOTA/50 kg/90 kg. Unitree H1 3.3 m/s walk SOTA. Unitree G1 $16K cheapest. Optimus widely-cited figures rejected per strict-attribution. NOT EXIST: π1, Gemini Robotics 2.0, Helix 03, Spirit v2, GR00T N3, Cosmos 4, Optimus Gen 3. S114 Gen-AI: **GPT-Image-2 AA T2I 1339 SOTA**. **Dreamina Seedance 2.0 720p AA T2V/I2V SOTA**. **gemini-omni-flash arena.ai T2V 1527/I2V 1475 #1**. **FLUX.2-dev 32B open-weights leader 1149**. FLUX.2-klein-4B Apache May 2026. Wan 2.2 first open MoE video. Kling 3.0/Ideogram 4.0/MJ V8.1/MAI-Image 2.5/Reve 2.0 new. NOT EXIST: GPT-Image-3, Sora 3, Imagen 5, Veo 4, SD 4, HiDream-O2/O3, Wan 2.5-3.0 (API)
