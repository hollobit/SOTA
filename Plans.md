...
## Current Status: Session 109 — Embedding model frontier (2026-06-14)
**2,519 models · 2,742 benchmarks · 12,175 scores · 🌍 +51 models / +53 benchmarks / +104 scores**

### 2026-06-14 Session 109 — Embedding model frontier (Commercial + Open-Source + Leaderboards)
- 3 agents 🌍 **+51/+53/+104**. **Commercial (15)**: OpenAI text-embedding-3-large/small (NO text-embedding-3.5). Cohere Embed v4 (Apr 2025, multimodal, 128K ctx). Voyage 3.5/3-large/codestral. Mistral Embed + Codestral Embed (May 2025). **Gemini Embedding 001 → 002 (Mar 2026)**: MTEB Multilingual v2 **69.9** + MTEB Code **84.0** (big jump from 74.66). Cohere embed-multilingual-v3 **MIRACL 66.3** (OpenAI v3-large 54.9). Anthropic has NO first-party embedder. **Open-source (25)**: **Qwen3-Embedding-8B sweeps**: MTEB-en v2 **75.22** + MMTEB Multilingual **70.58 #1** (displaces Gemini!) + CMTEB Chinese **73.84** + MTEB Code v1 **80.68** (vs Gemini 74.66). **EmbeddingGemma 300M** on-device SOTA. **jina-embeddings-v4 4B multimodal MMTEB 66.49** (+14% over v3). NV-Embed-v2 MTEB v1 72.31 legacy #1. **SFR-Embedding-Code-2B_R CoIR 67.4**. Strict-attribution: NV-Embed-v3, bge-en-icl-v3, snowflake-v3, SFR-3, mxbai v2/v3, Stella v6, gte-Qwen3 do NOT exist. **Leaderboards (11)**: QZhou-Embedding **MTEB-en 75.97** (3rd-party 2026 snapshot). Microsoft Harrier-OSS-v1 27B **74.30**. **MILCO MIRACL 72.30** ~14x smaller than E5-Mistral-7B (ICLR 2026). NVIDIA Llama-Embed-Nemotron-8B new 2026 top open-weight

### 2026-06-13/14 Sessions 105-108 — K2.7-Code + AI4S + Long-context + Math/Reasoning (+137/+103/+371)
- S108 Math: **GPT-5.4-xhigh USAMO 2026 95.24%** (first proof-based crack; 2025 was 0%). **Gemini Deep Think IMO 2025 35/42 GOLD**. **DeepSeek-v3.2-Speciale Putnam 2025 103/120**. **Goedel-V2-32B MiniF2F 90.4** (first >90%, 20× fewer params than DSP-V2-671B 88.9). **Goedel-V2-32B PutnamBench 86/644** (~2× prior). **AlphaProof+AlphaGeometry 2 IMO 2024 silver 28/42**. DeepSeek-V4-Pro-Max MathArena Apex 0.902. AIME 2025 5-way tie at 1.000
- S107 Long-context: **Opus 4.6 MRCR-v2 8N @ 1M 76.0** (first >75%). DeepSeek V4-Pro 82% @ 256K open. **Mythos 5 GraphWalks BFS@1M 79.4/Parents@1M 97.5**. Llama 4 Scout 10M collapses to 15.6%. **Mamba-3 ICLR 2026 complex-state half state size**. Jamba 1.6 Large RULER 95.7. DeepSeek MLA 2.7-4.7× KV cache reduction
- S106 AI4S: **IsoDDE 50% Runs-N-Poses vs AF3 23.3%**. **RFdiffusion3 41/41 enzyme**. **Chai-2 20% zero-shot antibody (100×)**. **BioEmu 100kx faster than MD**. **EquiformerV3+DeNS-OAM MatBench F1 0.931**. **GPT-5 USNCO 93.2**. **PhysicsMinions IPhO-2025 26.8/30 first open gold**. S105 K2.7-Code = K2.6 arch, NOT SOTA on 6, -30% thinking token
