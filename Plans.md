...
## Current Status: Session 124 — 5-URL targeted mining (DiffusionGemma + MiniCPM5-1B + SUSVIBES) (2026-06-15)
**3,021 models · 3,215 benchmarks · 15,046 scores · 🌍 +1 model / +9 benchmarks / +34 scores**

### 2026-06-15 Session 124 — 5-URL targeted mining (DiffusionGemma + MiniCPM5-1B + SUSVIBES arxiv 2512.03262)
- Single agent on 5 URLs 🌍 **+1/+9/+34**. **google/diffusion-gemma** (DeepMind 2026-06-10): 26B MoE / 3.8B active, text-to-text diffusion on Gemma 4, bi-directional attention, 256 tok/forward pass, **>1000 tok/s H100 / >700 tok/s RTX 5090 / 18GB VRAM quantized** — experimental, NO accuracy benches published. **openbmb/minicpm-5-1b**: 1B + 128K ctx reasoning, **AAII 17.9 sub-2B Pareto frontier** (vs Qwen3.5-2B reasoning 16.3, MiniCPM-V 4.6 1.3B 12.7). **SUSVIBES (arxiv 2512.03262, CMU/Columbia/JHU/HydroX AI Feb 2026)**: 200 repo-level feature-request + 77 CWEs + 172 lines/patch avg, dual FuncPass+SecPass metrics, 7× largest CWE coverage. **Gemini 3 Pro+OpenHands FuncPass 53.5% top**. **Claude Sonnet 4+OpenHands SecPass 12.5% top**. All agents <13% SecPass = massive headroom. NEW benches: susvibes + 6 sub-metrics (FuncPass/SecPass × SWE-Agent/OpenHands/Claude-Code), aa-omniscience (AA hallucination calibration), throughput H100/RTX5090. Hygiene: aa-intelligence-index dash variant merged with aa_intelligence_index underscore. **Caveats**: arxiv 2512.03262 is SUSVIBES NOT DiffusionGemma (URL mismatch in input). X.com Roundtable post HTTP 402 paywall. MiniCPM5-1B per-eval table image-only — Phi-4-mini/SmolLM3/Llama 3.2 1B comparison NOT extractable
...
### 2026-06-15 Session 122 — Deep re-mine post-S113 (June cards + leaderboards + arxiv 2606.x) (+35/+52/+174)
- AA Intelligence Index v4.0 snapshot 2026-06-15: **Claude Fable 5 = 64.9 #1** (vs Opus 4.8 61.0) + Arena Text 1510 + WebDev 1665 (+99 moat). GPT-5.5-xhigh+GPT-5.5 = 60.0 overtakes Opus 4.7 tier. Opus 4.8-thinking softer (#9 Arena only). **Gemini 3.5 Flash MCP-Atlas 83.6 NEW SOTA** displaces S112 DS-V4-Pro-High 74.2 (+9.4pt). Fable 5 SWE-V 95.0/SWE-Pro 80.3/Terminal-Bench 2.1 88.0/GDPval-AA 1932/OSWorld-V 85.0/LCB 89.78/IOI 72.25/Vibe Code 90.35. **Mythos 5 SWE-V 95.5 SOTA** (benchlm 2026-06-13). **Kimi K2.7 Code SWE-V 78.20** open. DS-V4-Pro-Max Codeforces 1.000+LCB 0.935. **GPT-5.5 ALE overall 26.2 SOTA** (Fable 5 22.0). vals.ai "Vals Index" NEW. **NEW June arxiv 2606.x**: ALE (UC Berkeley 1490 tasks), CL-Bench, ResearchClawBench (Claude Code 21.5 SOTA), RealMath-Eval, SocSci-Repro-Bench, CUA-HandCrafted (Sonnet 4.6+GPT-5.4 both 0/140), SentinelBench, K-BrowseComp (GPT-5.5 45.67%), MCP-Persona ICML 2026, FindIt MLLM, Embodied-R1.5 8B 16/24 SOTA. NEW models: Nemotron 3 Ultra 550B-A55B (33-bench HF card), Kimi K2.7 Code, GLM-5.2, GPT-Rosalind-5.5, GPT-5.5-xhigh. NOT EXIST: GPT-5.6/6, Gemini 3.5 Pro (May 19 announce not GA)/Gemini 4, Grok 4.5/5, Llama 5.5, DS V5/V4.5/R2 (held back per CEO), Qwen 3.8/4, Kimi K2.8/K3, GLM-6, MiMo V3, Hunyuan T2. NOT refreshed: RE-Bench/HCAST 1.2+, GAIA-3, OSWorld-V v2, τ4-bench, OmniDocBench v2.0, IPhO 2026, ARC-AGI-4, ExploitBench V9, CTI-REALM v2, LCB v7/v8, HMMT Mar 2026, FrontierMath-3, AISI Inspect Jun, UK AISI/METR/Apollo Jun pubs. Gaps: swebench/livebench/llm-stats/HF v3 need Playwright (client-rendered)
