...
## Current Status: Session 101 — Audio frontier deep dive (2026-06-11)
**2,221 models · 2,505 benchmarks · 11,522 scores · 🌍 +55 models / +23 benchmarks / +75 scores**

### 2026-06-11 Session 101 — Audio frontier (TTS/STT/Music+Understanding)
- 3 agents 🌍 **+55/+23/+75**. **STT (16 variants)**: **Cohere Transcribe sweeps**: LibriSpeech-Clean WER **1.25** + Other 2.37 + Open ASR avg **5.42** + RTFx 524.88. **MAI Transcribe 1.5** FLEURS 25-lang WER **3.7** best multilingual. **Parakeet TDT 0.6B v3** RTFx **3332x** (fastest open ASR). Voxtral Small 24B AA-WER 2.9 top open-weights. **TTS (27 variants)**: **Fun-Realtime-TTS (Alibaba) AA Elo 1226 #1** (dethrones ElevenLabs). ElevenLabs v3 70-lang. MAI-Voice-1 sub-1s/min. Qwen3-TTS 97ms Apache. Orpheus 3B 200ms streaming. Spark-TTS-0.5B near-#1 at 16x smaller. **Music+Audio Understanding (28)**: **Stable Audio 3 Large FAD 0.101 SOTA**. **Qwen3.5-Omni-Plus sweeps all 4 audio benches**: MMAU 82.2 + VoiceBench 93.1 + RUL-MuchoMusic 72.4 + MMSU 82.8 (beats Gemini 3.1 Pro across all). **Qwen3-Omni-30B-A3B-Thinking** VoiceBench 89.5 open-weights leader. **GPT-4o-Audio** MMAU-Pro Multi-Audio 26.5. Suno v5.5 voice cloning. Udio v2 UMG-licensed 10-min coherent songs

### 2026-06-11 Session 100 — European sovereign AI sweep (+48/+87/+144)
- Mistral: **Large 3 675B/41B Apache MoE largest worldwide**. Medium 3.5 SWE-V 77.6 + τ²-Telecom 91.4 European agentic coder. Voxtral Small 24B WER 1.59. Cohere/Aleph/Silo: Command A Plus 218B/25B MoE 48 langs. T-Free HAT 7B MMLU-DE 0.618. **Llama-Poro-2-8B Finnish AlpacaEval2 14x lift** over Llama 3.1 8B. EU specialty (27, 8 labs): EuroLLM-22B FLORES-COMET 88.9. ALIA-40B largest Iberian sovereign. Velvet-14B Italian, Bielik-11B Polish, SmolLM3-3B IFEval 76.7
...
- S98 Med: Fable 5 HealthBench Pro 0.660, Opus 4.6 AutoMedBench 66.5, GPT-4.1+memory MedAgentBench 98%, AMIE Co-Clinician RxQA 95.0. S97 Image+Video: Reve 2.0 T2I 1280 #2, HiDream-O1-Image 8B GenEval 0.90, Wan 2.7 Video Pro Arena T2V **1762** open-Apache. Sora-2 retired. S96 Robotics: π0.7, Helix 02 4-min dishwasher, GR00T N1.7 scaling 1k→20k, **Spirit v1.6 RoboArena 1924 #1**, **LingBot-VA LIBERO 98.5%**. S95 Chinese: DeepSeek V4 1.6T HMMT 95.2. GLM-5.1 754B Ascend **SWE-Pro 58.4 first non-NVIDIA**. Kimi K2.6 DeepSearchQA 92.5. S93-94 Quant: Qwen 3.6 35B-A3B-FP8 ELO 1397. Gemma 4 31B Q4_0 17.7GB MMLU-Pro 85.2. HW: Pixel 17/RTX 4090 43/H100 1260 tok/s
