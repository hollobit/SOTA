...
## Current Status: Session 115 — Robotics / VLA / Humanoid frontier refresh (2026-06-14)
**2,662 models · 2,925 benchmarks · 13,345 scores · 🌍 +15 models / +13 benchmarks / +44 scores**

### 2026-06-14 Session 115 — Robotics / VLA / Humanoid frontier refresh
- 2/3 agents (humanoid+VLA OK, robotics-bench socket-crashed 2× — VLA agent already captured LIBERO/CALVIN/SimplerEnv SOTAs) 🌍 **+15/+13/+44**. **VLA models (7)**: **Xiaomi-Robotics-0 4.7B (Feb 2026) LIBERO avg 98.7 SOTA** (beats S96 LingBot-VA 98.5) + SimplerEnv VM 85.5 / VA 74.7 / WidowX 79.2. **FutureVLA-GT (Mar 2026) LIBERO Object 99.8 SOTA**. **xVLA-base 0.9B (ICLR 2026) LIBERO 93% with 1% trainable params**. **Flower-VLA 1B (CoRL 25) CALVIN ABC chain length 4.53 SOTA**. SmolVLA 450M LIBERO avg 87.3. **NVIDIA GR00T N2 GTC 2026 preview** (ships end-2026, qualitative #1 MolmoSpaces/RoboArena but no public scores). 1X World Model v1xwm 14B. **Humanoid hardware (8)**: **Atlas Electric 56 DoF SOTA / 50 kg payload / 90 kg mass**. **Unitree H1 3.3 m/s walk SOTA + 30 kg payload + 47 kg mass + 19 DoF**. **Unitree G1 23 DoF + $16K cheapest + 2h battery + 35 kg**. 1X NEO 25 kg payload + 22-DoF hands + $20K + 30 kg. Apptronik Apollo 25 kg payload + 4h + 72.6 kg. Figure 02 + 03 5h battery + 20 kg payload + Figure 03 61 kg. Tesla Optimus Gen 2 only 57 kg + 11 DoF/hand published 1st-party (widely-cited Optimus 8 km/h figures rejected per strict-attribution). **NEW benches (13)**: CALVIN ABC/ABCD chain length, SimplerEnv 3-split (VM/VA/WidowX), DexBench (RLWRLD+NVIDIA Jun 9 announce), MolmoSpaces, 6 humanoid hardware specs (walk_speed/payload/dof/battery/price/mass). **Strict-attribution NOT EXIST**: π1 (π0.7 current), Gemini Robotics 1.7/2.0/2.5 (ER 1.6 latest), Helix 03 (Helix 02 Jan 2026 + Figure 03 hw Oct 2025), Spirit v1.7/v2.0 (v1.6 current), GR00T N3, Cosmos 4, Optimus Gen 3, Sanctuary Phoenix VLA, HumanPlus VLA, AgiBot G1+

### 2026-06-14 Session 114 — Image & Video Generation frontier refresh (commercial + open-source + arenas)
- 3 agents 🌍 **+41/+14/+146**. **AA Image Arena T2I**: **GPT-Image-2 1339 SOTA** / Reve 2.0 1280 / GPT-Image-1.5 1267 / HiDream-O1-Image-1.5 1265. **AA T2V with-audio**: **Dreamina Seedance 2.0 720p 1216 SOTA** / Sora 2 Pro 1191 / HappyHorse 1.0 1122 / SkyReels v4 1106 / Kling 3.0-1080p 1103. **AA I2V with-audio**: Dreamina Seedance 2.0 1194 SOTA / Grok-Imagine-Video 1.5 1113 / Veo 3.1 1088. **AA Image Edit**: GPT-Image-1.5 1263 / GPT-Image-2 1259 / Nano-Banana Pro 1250 / MAI-Image 2.5 1248. **arena.ai T2V**: **gemini-omni-flash 1527 debuts #1** (Google flagship). **arena.ai I2V**: gemini-omni-flash 1475 + Dreamina 1475 tied / Grok-Imagine 1467. **arena.ai T2I**: GPT-Image-2 medium 1385 / Reve 2.0 1273 / Gemini 3.1 Flash Image Preview 1269. **Open-source SOTAs**: **FLUX.2-dev 32B LM Arena Image 1149** (highest open-weight, BFL Nov 2025, FLUX-NC). **FLUX.2-klein-4B Apache 2.0** May 2026 (BFL first Apache 4B-class sub-sec). **Wan 2.2 T2V-A14B** first open MoE video diffusion (27B/14B active). HiDream-I1 Full 17B GenEval 0.83/DPG 85.89 prior OSS SOTA. Sana 1.5 4.8B GenEval 0.72→0.96 w/VILA judge. CogView4 6B Apache 2.0. **NEW entrants**: Kling 3.0 (4K/60fps/15s Feb 2026), Ideogram 4.0 9.3B open Jun 2026, MJ V8.1 default Jun 2026, MAI-Image 2.5 May 2026, Reve 2.0 Jun 2026, Luma Ray 3.14 Jan 2026, Veo 3.1-Lite, Grok-Imagine-Video 1.5-preview, SkyReels v4, Agnes-Video v2.0 ($0.30/min cheap), HappyHorse 1.0, PixVerse V6, LTX-2.3 Pro, Runway Gen-4 Aleph, Adobe Firefly Image 5, FLUX.2-klein-9B. **Strict-attribution NOT EXIST**: GPT-Image-3, Sora 3 (Sora discontinuing 2026-09-24), Imagen 5, Veo 4 (teased), Runway Gen-5, Ray 4, Hailuo 2.5, MJ V9, Reve 2.5, Claude image-gen, SD 4, HiDream-O2/O3, HunyuanVideo 2/3, Wan 2.5-3.0 (API-only). 8 new bench IDs: 4 AA arena + 4 lmarena/arena.ai + LM Arena image + T2I-CompBench + ImageReward + FID@1024 + CLIP-Score
