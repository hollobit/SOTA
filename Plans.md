...
## Current Status: Session 133 — Coding Agent Harnesses comprehensive sweep (2026-06-16)
**3,237 models · 3,365 benchmarks · 15,583 scores · 🌍 +41 models / +20 benches / +57 scores**

### 2026-06-16 Session 133 — Coding Agent Harnesses comprehensive sweep
- 3 agents 🌍 **+41/+20/+57**. **Commercial**: **Cognition Devin 2.2 (Feb 24 2026, LATEST — Devin 2.5/3.0 NOT EXIST)**, SWE-1.5+SWE-1.6+Devin Desktop (Jun 2 2026, replaces Cascade). **Cursor Composer 2.5 AA Coding Agent Index 62** (Opus 4.7 66 #1, GPT-5.5 65 #2). Composer 2.5 SWE-Bench Multilingual 79.8 + Terminal-Bench v2 69.3 + SWE-Pro-Hard-AA ~47 + SWE-Atlas-QnA 72. JetBrains Junie + Amazon Q Developer Agent + GitHub Copilot Coding Agent. **Auggie CLI SWE-Pro public 51.80% SOTA** (Cursor 50.21/Claude Code 49.75/Codex CLI 46.47). **Open-source (29)**: **Live-SWE-Agent + Opus 4.5 SWE-V 79.2% open-source SOTA**. Vexp + Opus 4.5 SWE-V 73.0% at $0.67/task. **OpenHands SDK + Sonnet 4.5 SWE-V 72.8%** (arxiv 2511.03690). OpenHands + Sonnet 4 70.4. Mini-SWE-Agent + Claude 4.5 Sonnet 65.0. **DeepSWE-Preview (Qwen3-32B RL) + Hybrid TTS Best@16 SWE-V 59.0% open-weights SOTA**. **SWE-Bench Pro Public (Scale AI 731-task)**: **Mini-SWE-Agent + GPT-5.4 xHigh 59.10% SOTA** / + Opus 4.6 51.90 / SWE-Agent + Opus 4.5 45.89. MetaGPT + GPT-4 HumanEval 85.9 / MBPP 87.7 (ICLR'24). AgentCoder HumanEval 96.3. L2MAC HumanEval 90.2. Magentic-One GAIA 38.0 / WebArena 32.8 / AssistantBench 27.7. **Eval boards**: LMArena CodeArena **Fable 5 #1**. **LiveCodeBench (AA) Gemini 3 Pro 91.7 SOTA** / Flash 90.8 / DS-V3.2-Speciale 89.6. **LiveCodeBench Pro Elo: Gemini 3.1 Pro 2887 SOTA**. Vellum: Mythos 5 95.5 #1. **Vals.ai SWE-V independent**: Fable 5 95.0 / Opus 4.8 88.6 / GPT-5.5 82.6. **METR HCAST/RE-Bench Time Horizon 1.1**: Mythos Preview **960min (16h)** / Opus 4.6 870min / Opus 4.5 320min / GPT-5.1-Codex-Max 160min / o3 121min. Endor Agent Security League SusVibes extension: SWE-Agent×Gemini 2.5 Pro FuncPass 20.7 / SecPass 4.5. **Strict-attribution NOT EXIST**: **Devin 2.5/3.0** (Devin 2.2 latest, Cognition moved to Devin Desktop/Local), **Cognition Cascade standalone** (Windsurf feature retired Jul 1 2026), Cursor Tab v2/Background Agent/Composer 1, Replit Agent 3/4, v0, Lovable, Bolt.new, Cody, Tabnine Universal (products exist but no vendor-primary benchmark scores; 3rd-party reviews rejected per strict attribution). NEW benches: AA Coding Agent Index, SWE-Pro-Hard-AA, SWE-Atlas-QnA, CursorBench v3.1, SWE-Pro Public Pass@1, swe_bench_verified_cost_usd, LMArena CodeArena, LiveCodeBench AA + Pro Elo, Vals.ai SWE-V, METR Time Horizon 1.1 50/80%, Endor Agent Security League FuncPass/SecPass, GAIA/WebArena/AssistantBench

### 2026-06-16 Session 132 — Sovereign AI 31-session refresh (Asian + EU/ME + Global South)
