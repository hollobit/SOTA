...
## Current Status: Session 111 — Cybersecurity benchmark refresh (2026-06-14)
**2,572 models · 2,799 benchmarks · 12,529 scores · 🌍 +17 models / +61 benchmarks / +94 scores**

### 2026-06-14 Session 111 — Cybersecurity benchmark refresh (Frontier + Agents + New 2026 boards)
- 3 agents 🌍 **+17/+61/+94**. **Frontier model cyber (19 benches)**: **GPT-5.5 UK AISI narrow cyber pass@5 90.5%** (+19.1pp vs GPT-5.4 71.4). **Mythos 5 ExploitBench V8 78.0** + Firefox 147 88.4 (+17.6pp) + OSS-Fuzz ≥0.4 32.4 + AISI Last Ones 6/10 + Doing Life 21/23. **GPT-5.5 OpenAI Cyber Range 93.33** + Irregular CyScenarioBench 63.6%. **Opus 4.5 NYU CTF Bench 2026 59.0** (118/200) multi-vendor leader. **Cyber agents (17)**: AIxCC 2025 Final (DEF CON 33) — **Atlantis 1st ($4M) / Buttercup 2nd / Roboduck 3rd**. **MDASH CyberGym 96.55%** (Build 2026, beats Mythos Preview 83.1, GPT-5.5 81.8 — was 88.45 May; correction). **xBow HackerOne US #1** (first AI 1000+ reports). **D-CIPHER NYU CTF 22.0 / Cybench 22.5 / HackTheBox 44.0**. **XOffense AutoPenBench 79.17**. MDASH MSRC tcpip.sys 100%. Note: Crystalline (S92 leader) unconfirmed — MDASH actual CyberGym leader. **NEW 2026 boards (22)**: **Opus 4.6 CTI-REALM 0.637** (beats GPT-5 family 0.572) + Simbian Cyber Defense 63%. **GPT-5 SandboxEscapeBench 0.50** ICML 2026 (Opus 4.5 0.49, GPT-5.2 0.27 regression). **GPT-5.5 CrackMeBench 92%** (Opus 4.7 58%). **FuzzingBrain V2 AIxCC 36/40 + 41 real zero-days**. ClaudeCode+Codex SEC-bench Pro 37.9 V8 / 48.8 SpiderMonkey. ExploitBench (CMU/Bugcrowd, arXiv:2605.14153) + ExploitGym (898 vulns, arXiv:2605.11086) + Cyber Defense Bench (Simbian, arXiv:2604.19533) NEW
