...
## Current Status: Session 117 — Audio / Speech frontier refresh (2026-06-14)
**2,750 models · 2,974 benchmarks · 13,665 scores · 🌍 +72 models / +37 benchmarks / +214 scores**

### 2026-06-14 Session 117 — Audio / Speech frontier refresh (ASR + TTS + Voice/S2S)
- 3 agents 🌍 **+72/+37/+214**. **ASR (50 models)**: **Fun-Realtime-ASR-preview AA-WER v2 1.7% SOTA** / Scribe v2 2.2 / MAI-Transcribe-1.5 2.4. **Cohere Transcribe 03-2026 Open ASR Short-form 5.42 SOTA** (Zoom Scribe v1 5.47, IBM Granite Speech 4.0-1B 5.52). **ElevenLabs Scribe v2 sweeps**: Open ASR Multilingual 2.67 / Long-form 7.32 / AgentTalk 1.6. Gemini 3 Pro VoxPopuli 1.7. **TTS (24 models)**: **Fun-Realtime-TTS AA Quality Elo 1226.47** #1. Gemini 3.1 Flash TTS 1214.99. Inworld Realtime TTS-2 RP 1208.11. Cartesia Sonic 3.5 1197.19 (was Sonic 3 1083.42). Hume Octave 2 1059.9 (replaces EVI 3 on AA). **TTS Arena V2**: Vocu V3.0 1581 / Inworld TTS MAX 1579 / CastleFlow v1.0 1574 / Papla P1. **Voice/S2S (35 models)**: **Qwen3.5-Omni-Plus VoiceBench 93.1 SOTA** (beats Gemini 3.1 Pro 88.9) + MMAU 82.2 / MMSU 82.8 / LibriSpeech 1.11 / FLEURS-60 6.55. **NVIDIA Nemotron 3 Nano Omni 30B-A3B VoiceBench 89.39 open SOTA**. Step-Audio-R1 Big Bench Audio 98.7 / Spoken MQA 95.2. Step-Audio-R1.5 32B avg 77.97. **StepAudio 2.5 Realtime Paralinguistic 82.18** (Gemini Live 58.05). **GPT-Realtime-2 Big Bench Audio 96.6 + Audio MultiChallenge 48.5** (May 2026). NVIDIA PersonaPlex Jan 2026 Dialog MOS 3.90. Hibiki-Zero Europarl-ST ASR-BLEU 34.6 @ 2.8s. **Data-hygiene flag**: openai/realtime-tts-2 misattributed — actual vendor Inworld (added inworld/realtime-tts-2-rp instead of autopatch). **Strict-attribution NOT EXIST**: Whisper V3.5/V4 (V3-turbo Sep 2024 latest), Parakeet TDT v4, Cohere Transcribe v2 (transcribe-03-2026 only), Scribe v3, NVIDIA Acoustica (=PersonaPlex), Gemini Live 2 (Gemini 3.1 Flash Live actual), Anthropic Claude voice (ElevenLabs wrapper), Realtime mini (reasoning-effort variant), Kimi K2-Voice/Audio-2, Hume EVI 2 (Octave 2 supersedes), AudioPaLM (2023), MAI-Voice-2, Suno V5/Bark v2, Sesame CSM-1B, Seed-TTS-2, VALL-E v3, Coqui XTTS V3, PlayHT V3

### 2026-06-14 Sessions 114-116 — Image/Video Gen + Robotics/VLA + Medical (+72/+39/+296)
