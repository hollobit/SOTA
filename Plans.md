...
## Current Status: Session 100 — European sovereign AI sweep (2026-06-11) 🎉
**2,166 models · 2,482 benchmarks · 11,447 scores · 🌍 +48 models / +87 benchmarks / +144 scores (Session 100 milestone)**

### 2026-06-11 Session 100 — European sovereign AI sweep 🎉
- 3 agents 🌍 **+48/+87/+144**. **Mistral family** (10 variants): **Mistral Large 3 675B/41B MoE Apache-2.0** = largest open-weights MoE worldwide. **Mistral Medium 3.5 (128B dense, Modified MIT)** SWE-V **77.6** + τ²-Telecom **91.4** (strongest European agentic coder, close to Sonnet 4.6 79.6). **Mistral Small 4 (119B-A6.5B Apache MoE)** GPQA-D 71.2 + MMLU-Pro 78 at 6.5B active. **Voxtral Small 24B** LibriSpeech WER **1.59** + RTFx 54.09 (ASR SOTA). Voxtral TTS 4B + Ministral 3 edge + Devstral SWE-V 53.6 + Magistral reasoner. **Cohere/Aleph/Silo (18 variants)**: **Cohere Command A Plus 05-2026 (218B/25B MoE Apache, 48 langs)** EU sovereign frontier. **Cohere Transcribe** WER 5.42 + RTFx 524.88. North Mini Code 1.0 SWE-V 67.6. **Aleph Alpha T-Free HAT 7B** MMLU-DE 0.618 (tokenizer-free German SOTA). **LumiOpen Llama-Poro-2-70B** Finnish IFEval-FI **70.79** + MTBench-FI 7.77 (14x lift over Llama 3.1 8B 2.05 on Finnish AlpacaEval2). **EU specialty (27 variants, 8 labs)**: EuroLLM-22B FLORES-COMET 88.9. **ALIA-40B largest open Iberian sovereign** (35 EU langs, 163k ctx). Velvet-14B Italian flagship. Minerva-7B Italian. Bielik-11B-v3 Polish. SmolLM3-3B IFEval 76.7 + AIME-2025 36.7. CroissantLLM French-English. PleIAs OCR/legal. Idefics3-8B multimodal

### 2026-06-11 Session 99 — Korean + Japanese sovereign AI sweep (+60/+45/+200)
- Korean: **SKT A.X K1 (519B/33B MoE) KMMLU 80.2 + LCB-Korean 73.1 + HumanEval+ Korean 90.2**. K-EXAONE 236B/23B HRM8K 90.9 + KoBALT 61.8. EXAONE 4.5 33B AIME-26 92.6. Solar Open 100B AIME24 91.7. Japanese (47 models): **Stockmark-2-100B JMT-Bench 7.87** highest open JP. RakutenAI-3.0 671B/37B Japan's largest open MoE. LLM-JP-4-32B JMT-Bench 7.82 at 3.8B active. Cross-vendor surprise: DeepSeek-V3.2 CLIcK 86.3 beats A.X K1 84.9; GLM-4.6 KMO25 96.6; Qwen3-235B HRM8K 92.0

### 2026-06-11 Sessions 93-98 — Quant + Chinese + Robotics + Image/Video + Medical (+174/+220/+621)
- S98 Med: Fable 5 HealthBench Pro 0.660, Opus 4.6 AutoMedBench 66.5, GPT-4.1+memory MedAgentBench 98%, AMIE Co-Clinician RxQA 95.0. Lingshu-7B SLAKE 83.1. Specialty: MedSAM-3/PRISM2/OpenFold3/IsoDDE/Boltz-2. S97 Image+Video: Reve 2.0 T2I 1280 #2, MAI-Image-2.5 Edit 1401 #2, HiDream-O1-Image 8B GenEval 0.90, Wan 2.7 Video Pro Arena T2V **1762** open-Apache video. Kling 3.0 4K@60fps. Sora-2 retired
- S96 Robotics: π0.7, Helix 02 4-min dishwasher, GR00T N1.7 scaling 1k→20k, **Spirit v1.6 RoboArena 1924 #1**, **LingBot-VA LIBERO 98.5%**. S95 Chinese: DeepSeek V4 1.6T HMMT 95.2/LCB 93.5. GLM-5.1 754B Ascend **SWE-Pro 58.4 first non-NVIDIA**. Kimi K2.6 DeepSearchQA 92.5. S93-94 Quant: Qwen 3.6 24 quant (35B-A3B-FP8 ELO 1397), Gemma 4 11 QAT (31B Q4_0 17.7GB MMLU-Pro 85.2). HW: Pixel 17/RTX 4090 43/H100 1260 tok/s
...
- S82-85: SciVQR/GraphInstruct/CommonWhy 23. gwBench 8 (Sonnet 4.6/Opus 4.7/Kimi K2.6). AgentRx MedPatch 0.877. Creativity 13. GeoBuild GPT-5.1 78.9. ExploitBench V8 Mythos Preview T1 ACE 0.439/T3 0.854/T5 1.0. **GPT-5.5 Codex CLI 0.0244** sole public ACE. VectraYX Spanish cyber 0.880. RealICU GPT-5.4+ICU-Evo Acute 0.867
- S77-81: SMAC-Talk Qwen3.5 122B KDC 41→UDC 10. ERRORQUAKE Mistral-Small-24B b=1.250. DELEGATE-52 Gemini 3.1 Pro RS@20 80.9. Text2CAD DeepSeek-V3.2 L4 8.26. Sakana 0.62. Qwen-VLA LIBERO 97.9. R-Judge 97.3. DSPV2-671B MiniF2F 88.9. BenchCAD Qwen3-VL-2B V2C 0.768. o3 MedQA TTS 93.3. Qwen3.5-Omni-Plus KeSpeech 3.46 6.8x. GPT-5 Pro ECI 2.65
