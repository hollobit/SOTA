...
## Current Status: Session 114 — Image & Video Generation frontier refresh (2026-06-14)
**2,647 models · 2,912 benchmarks · 13,301 scores · 🌍 +41 models / +14 benchmarks / +146 scores**
...
### 2026-06-14 Session 112 — Function calling / tool-use frontier (+28/+18/+216)
- BFCL v4 (2025-12-16): **Opus 4.5 FC 77.47** + Gemini-3-Pro Live AST 83.12 + xLAM-2-70B multi-turn 77.38 (open). tau2: airline Opus 4.5 84.0, **retail Qwen3.5-397B 84.43**, telecom Opus 4.6+LongCat tied 99.3, banking GPT-5.5 37.37. **GAIA + WebArena + OSWorld-V**: Mythos/Fable 5 tied SOTA. **BrowseComp GPT-5.5 Pro 90.1** single / **Mythos 5 93.3 multi-agent**. DS-V4-Pro-High MCP-Atlas-Public 74.2 (beats GLM-5.1). HAL Princeton per-sub: SWE-V-Mini Sonnet 4.5 72.0 / CORE-Bench Hard Opus 4.5 77.8 / USACO GPT-5-M 69.1. Mythos 5 DRACO 86.4 first. Fable 5 Toolathlon Pass@3 68.5

### 2026-06-11~14 Sessions 101-111 (compressed) — Cyber refresh + Audio + Global South + MiMo + Coding agents + K2.7-Code + AI4S + Long-context + Math/Reasoning + Embedding + VLM (+406/+334/+1082)
