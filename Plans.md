...
## Current Status: Session 120 — 3D / Scene Generation frontier (2026-06-15)
**2,934 models · 3,123 benchmarks · 14,765 scores · 🌍 +59 models / +59 benchmarks / +234 scores**

### 2026-06-15 Session 120 — 3D / Scene Generation frontier (first broad sweep)
- 3 agents 🌍 **+59/+59/+234**. **Dashboard had ZERO 3D coverage** prior. **3D Arena Elo (snapshot 2025-05-30)**: **CSM Cube 1405 SOTA** / Hunyuan3D-2 1298 / Meshy-4 1243. **Hi3DEval Object-level SOTA**: **Hunyuan3D 2.5 16.561** / Hunyuan3D 2.0 16.20 / TRELLIS 15.20 / SPAR3D 15.00 / TripoSR 14.34. **Hunyuan3D 2.5 shape-gen SOTA**: ULIP-T 0.07853 / FID 165.8 / CLIP-I 0.9281. **Hunyuan3D 2.1**: ULIP-T 0.0774 / Uni3D-I 0.3213 / ShapeVAE V-IoU 93.6%. **Microsoft TRELLIS-Image-Large** dominates Toys4k img-to-3D: CLIP 85.77 / FD_DINOv2 67.21 / recon PSNR 32.74. **TRELLIS.2 (4B Dec 2025)** CLIP 0.894. **Stability SPAR3D (Jan 2025)** GSO CD 0.120 / F-Score@0.2 0.850 (beats SF3D / TripoSR). **TencentARC InstantMesh** GSO F-Score@0.2 0.882. **T3Bench**: ProlificDreamer single 49.4 SOTA / Magic3D 37.0 / LatentNeRF 33.1. **Models added**: Hunyuan3D-2.0/2.1/2.5 + ShapeVAE/Paint/DiT, TRELLIS/XL/.2, TripoSR/SF3D/SPAR3D/Stable-Zero123/Zero123++, InstantMesh, CRM (Tsinghua), LGM (PKU+Alibaba), Wonder3D, DreamGaussian, 3DTopia-XL, Meshy 3/4/5, Tripo v1/v2.5/v3.0 Ultra, CSM Cube, Luma Genie 1.5, NVIDIA Edify 3D, Adobe Firefly 3D, Deemos Rodin / Hyper3D, Sloyd, Kaedim, OpenAI Shap-E. **Comparators**: Michelangelo, Craftsman 1.5, Paint3D, TexGen, Text2Tex, SyncMVD, Paint-it, Direct3D, 3DShape2VecSet, LN3Diff, GaussianCube, DreamFusion, Magic3D, LatentNeRF, Fantasia3D, SJC, ProlificDreamer. **Strict-attribution NOT EXIST**: Luma Genie 2 (only 1.0-1.5), Stability StableMesh (shipped as TripoSR/SPAR3D), Wonder3D-XL, DreamGaussian-2, OpenLRM/PF-LRM/GS-LRM (no strict-attribution scores). Anonymized "Commercial Model 1/2" in Hunyuan3D 2.5 Table 1 NOT mapped to Rodin/Meshy/Tripo per attribution rules. Gap: most commercial vendors (Meshy 5, Tripo v3, Adobe, NVIDIA Edify) don't publish public benchmark scores. **NEW benches (59)**: 3D Arena Elo, Hi3DEval Object/Material Overall + per-dim (GP/GD/TQ/GTC/PA), Toys4k Text-to-3D + Image-to-3D (CLIP, FD-DINOv2), GSO CD/F-Score@0.1/0.2/0.5/PSNR/LPIPS, OmniObject3D CD/F-Score, ULIP-T/ULIP-I/Uni3D-T/Uni3D-I shape similarity, V-IoU/S-IoU shape recon, Texture CMMD/FID-CLIP/FID/CLIP-I/CLIP-score/LPIPS, T3Bench Single/Surroundings/Multi, recon PSNR/F-Score/CD
