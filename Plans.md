...
## Current Status: Session 107 — Long-context frontier deep dive (2026-06-13)
**2,426 models · 2,661 benchmarks · 11,912 scores · 🌍 +43 models / +31 benchmarks / +103 scores**

### 2026-06-13 Session 107 — Long-context frontier (Benchmarks + Frontier + Architecture)
- 3 agents 🌍 **+43/+31/+103**. **Benchmarks (14, 57 scores)**: RULER per ctx length, MRCR-v2 8N @ 256K/1M, NIAH-Hard, BABILong, LongBench v2, GraphWalks BFS/Parents, AA-LCR. **NEW SOTAs**: **Opus 4.6 MRCR-v2 8N @ 1M 76.0** (first >75% at full 1M). **GPT-5.5 74.0** (+37pp vs 5.4's 36.6). **DeepSeek V4-Pro 59% @ 1M / 82% @ 256K** (strongest open-weights). **Mythos 5 GraphWalks BFS @ 256K 91.1 / @ 1M 79.4 / Parents @ 1M 97.5**. **GPT-5.2-Codex AA-LCR 75.7** (Gemini 3.1 Pro 72.7). **Gemini 3 Pro LongBench v2 68.2**. **MiniCPM-SALA RULER 512K/1M 87.1/86.3**. **Frontier models (26)**: 256K-512K (Kimi K2.6/K2.7, Qwen3.6), 1M (16 models: GPT-5.5, Claude Opus 4.6/4.7/4.8, DeepSeek V4-Pro), 2M (Gemini 1.5 Pro), 10M (Llama 4 Scout — but collapses to 15.6% @ 120K Fiction.Live), 100M (Magic LTM-2-Mini unverified). GPT-5.5 surcharge >272K = 2× input/1.5× output. **Architecture (15)**: **Mamba-3 (ICLR 2026) complex-state + MIMO +1.8pp vs Gated DeltaNet, half state size**. **Jamba 1.6 Large 95.7 RULER avg across 4K-256K**. **DeepSeek MLA 2.7-4.7× KV cache reduction** (adopted by Kimi K2). **Falcon-H1 34B hybrid-head Mamba-2+attn parallel**. **Google Titans MAC 2M+ tokens beats GPT-4 on BABILong**. YaRN standard 128K-2M extension method

### 2026-06-13 Sessions 105-106 — Kimi K2.7-Code + AI4S deep dive (+52/+44/+109)
- S106 AI4S: **IsoDDE 50% Runs-N-Poses hardest bin** vs AF3 23.3%. **RFdiffusion3 41/41 enzyme sites** vs RFdiff2 16/41. **Chai-2 ~20% zero-shot antibody hit rate** (100x prior). **BioEmu <1 kcal/mol 100kx faster than MD**. Boltz-2 CASP16 #1/140. **EquiformerV3+DeNS-OAM MatBench Discovery F1 0.931+MAE 0.018**. UMA-S 1.2 50% faster. OrbMol-v2 3.7x. MatterGen Stability 74.4%. **GPT-5 USNCO 93.2 + MatSciBench multimodal 53.02**. **Biomni Lab BixBench 52.2**. **Gemini 3 Flash AstroBench 90.3**. **PhysicsMinions IPhO-2025 26.8/30 first open IPhO gold**. **Cosmos-Reason 2-8B PAI-Bench 80.18**. **Grok-4.1 Thinking VCT 61.0**. GPT-5.4 GPQA-D 97
- S105 Kimi K2.7-Code = K2.6 architecture (1T/32B MoE, 256K ctx, $0.95/$4.00). Thinking forced=True -30% token usage. Does NOT take SOTA on any of 6 reported benches. K2.6→K2.7 deltas all positive (+4-11pp). 2 NEW Moonshot benches
