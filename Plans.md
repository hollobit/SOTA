...
## Current Status: Session 110 — VLM frontier (multimodal understanding) (2026-06-14)
**2,555 models · 2,755 benchmarks · 12,435 scores · 🌍 +36 models / +13 benchmarks / +260 scores**

### 2026-06-14 Session 110 — VLM frontier (Open-Source + Commercial + Benchmarks)
- 3 agents 🌍 **+36/+13/+260**. **Open-source VLMs (25)**: Qwen3-VL family (235B-A22B Instruct+Thinking MoE, 32B Dense, 30B-A3B MoE, 8B/4B/2B Dense — Sep-Oct 2025), InternVL3.5 (241B-A28B MoE, 38B Dense, 30B-A3B MoE, 8B — Aug 2025), Pixtral Large 2411, Phi-4-multimodal, MiniCPM-V 4.5, DeepSeek-VL2, LLaVA-OneVision 1.5. **NEW SOTAs**: **Qwen3-VL-235B-A22B-Instruct MMMU-Pro Vision 69.3** (first open). **Qwen3-VL-32B-Thinking BLINK 80.3** (+16.5pp vs Qwen2.5-VL-72B). **InternVL3.5-241B OCRBench 907**. Qwen3-VL-32B-Thinking MathVista 85.9. Qwen3-VL-235B CharXiv RQ 66.2 (+17.9pp). ScreenSpot-Pro 4× lift over Qwen2.5-VL. **Commercial (14)**: **Mythos 5 MMMU-Pro 92.7** (Mythos AA 0.927, GPT-5.4-Pro 0.940 #1). **GPT-5.5 MMMU-Pro Vision 83.2**. Gemini 3.5 Flash CharXiv-R 88.7. **Opus 4.8 ScreenSpot-Pro 87.9**. **Gemini 3 Pro Video-MMMU 87.6** (above human 80.5). Gemini 3 Pro Deep Think BenchLM Multimodal 100.0. **Benchmark leaderboards (12)**: MMMU/MMMU-Pro/CharXiv-R/MathVista/Video-MMMU/ScreenSpot-Pro/OCRBench v1/v2/OmniDocBench/MMStar/MMBench/BLINK. ~251 scores rows. **Strict-attribution catches**: Qwen3.5-VL, Pixtral Large 2, Phi-5-vision, CogVLM3, Florence-3, Yi-VL 2, Idefics4 do NOT exist

### 2026-06-14 Session 109 — Embedding model frontier (+51/+53/+104)
- **Commercial (15)**: gemini-embedding-002 MTEB Multilingual v2 69.9 + MTEB Code 84.0. gemini-embedding-001 MTEB-en v2 73.3. Cohere embed-multilingual-v3 MIRACL 66.3. Mistral codestral-embed 85% code. Voyage 3.5 $0.06/M. Anthropic NO first-party. text-embedding-3.5 does NOT exist. **Open-source (25)**: **Qwen3-Embedding-8B sweeps**: MTEB-en v2 75.22/MMTEB 70.58 (displaces Gemini!)/CMTEB Chinese 73.84/MTEB Code 80.68. **EmbeddingGemma 300M on-device SOTA**. jina-v4 4B MMTEB 66.49 (+14%). NV-Embed-v2 MTEB v1 72.31. SFR-Code-2B_R CoIR 67.4. QZhou MTEB-en 75.97. Microsoft Harrier-OSS-v1 27B 74.30. **MILCO MIRACL 72.30** 14x smaller than E5-Mistral-7B

### 2026-06-13/14 Sessions 105-108 — K2.7-Code + AI4S + Long-context + Math/Reasoning (+137/+103/+371)
- S106-108: **GPT-5.4-xhigh USAMO 2026 95.24%** (first proof-based crack). **Gemini Deep Think IMO 2025 35/42 GOLD**. **DeepSeek-v3.2-Speciale Putnam 103/120**. **Goedel-V2-32B MiniF2F 90.4** (first >90%, 20× fewer params). **Opus 4.6 MRCR-v2 8N @ 1M 76.0** (first >75%). **Mythos 5 GraphWalks BFS@1M 79.4/Parents@1M 97.5**. **Mamba-3 ICLR 2026 half state size**. **IsoDDE 50% Runs-N-Poses vs AF3 23.3%**. **Chai-2 20% antibody (100×)**. **EquiformerV3+DeNS-OAM MatBench F1 0.931**. **GPT-5 USNCO 93.2**. **PhysicsMinions IPhO-2025 26.8/30 first open gold**. S105 K2.7-Code = K2.6 arch -30% thinking

### 2026-06-11/12 Sessions 101-104 — Audio + Global South + MiMo + Coding agents (+165/+104/+253)
- S101-104: Devin 2.0 SWE-V 45.8 (3.3x). **Auggie SWE-Pro 51.80** ahead of Cursor/Claude Code/Codex on Opus 4.7. **Mythos 5 sweeps coding** (Aider Polyglot 95.5/SWE-V 95.5/SWE-Pro 80.3). **SWE-Lancer GPT-5.1 Codex 66.3** NEW. Tau2 GLM-4.7-Flash 98.8. **Cohere Transcribe LibriSpeech 1.25**. Parakeet TDT v3 **RTFx 3332x**. **Fun-Realtime-TTS Elo 1226 #1**. **Qwen3.5-Omni-Plus sweeps 4 audio**. **Sarvam-105B JEE-Main 100/100**. Qalb-1.0 Urdu 90.34. Falcon-H1-34B MMLU 84.05. ALLaM-7B Arabic 67.78. S103 MiMoCode = CLI agent NOT a model
